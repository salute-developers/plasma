...
export const labelPlacement = ['inner', 'outer'];
...
export const chipView = ['default', 'secondary', 'accent'];
export const chipClickArea = ['full', 'close-icon'];
export const arrowPlacement = ['left', 'right'];
