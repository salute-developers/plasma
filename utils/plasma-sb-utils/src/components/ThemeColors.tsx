...
import { Headline3, Footnote1, Caption, applyEllipsis } from '@salutejs/plasma-core';

const NONE = 'NONE';
const comments = {
    accent: 'Акцентный цвет бренда',
    accentSber: 'Акцентный цвет Cбера',
    ...
    voicePhraseGradientSber: 'Голосовые фразы Cбера',
    ...
    gradientSber: 'Бэкграунд ассистента для Cбера',
    ...
    buttonAccentSber: 'Основная кнопка для Cбера',
