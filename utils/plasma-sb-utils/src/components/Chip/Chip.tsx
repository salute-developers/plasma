...
export const getChipStories = (config: CreateChipStoriesProps) => {
    const { component, componentConfig, ...rest } = config;

    const chipConfig = getConfigVariations(componentConfig);

    const meta = createMeta({
        component,
        componentConfig: chipConfig,
        ...rest,
    });
