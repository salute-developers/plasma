...
export enum ThemeColorsList {
    ...
    backgroundPrimary = 'Первичный цвет фона', // ToDo: https://github.com/salute-developers/plasma/issues/1107
    backgroundSecondary = 'Вторичный цвет фона', // ToDo: https://github.com/salute-developers/plasma/issues/1107
    backgroundTertiary = 'Третичный цвет фона', // ToDo: https://github.com/salute-developers/plasma/issues/1107
    ...
    surfaceLiquid01 = 'Полупрозрачные поверхности', // ToDo: https://github.com/salute-developers/plasma/issues/1107
    surfaceLiquid02 = 'Полупрозрачные поверхности', // ToDo: https://github.com/salute-developers/plasma/issues/1107
    surfaceLiquid03 = 'Полупрозрачные поверхности', // ToDo: https://github.com/salute-developers/plasma/issues/1107
