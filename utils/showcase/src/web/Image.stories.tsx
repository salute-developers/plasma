...
import { Image } from '@salutejs/plasma-web/components/Image';

import { CardShowcase, WebStoryDecorator, InSpacingDecorator } from '../helpers';

export default {
    title: 'Web/Content/Image',
    component: Image,
...
const sections = {
    ...
    Div: {
        '1 / 1': <Image base="div" key="Div square" src={src} ratio="1 / 1" />,
        '4 / 3': <Image base="div" key="Div 4 / 4" src="./images/240_320_9.jpg" ratio="4 / 3" />,
        '3 / 4': <Image base="div" key="Div 3 / 4" src="./images/240_320_9.jpg" ratio="3 / 4" />,
    },
};
