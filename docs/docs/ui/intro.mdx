...
# Введение в Plasma Devices
Plasma Web (`@salutejs/plasma-web`) – библиотека с открытым исходным кодом,
в которую входят _компоненты_ дизайн-системы Plasma
и вспомогательные _утилиты_ для создания [смартапов](https://bit.ly/3L8S6jf) на [React](https://reactjs.org/).
