...
import { Card, CardBody, CardMedia, CardContent, CardParagraph1 } from '@salutejs/plasma-ui/components/Card';
import { Badge } from '@salutejs/plasma-ui/components/Badge';
import { Ratio } from '@salutejs/plasma-ui/components/Image';
import { Button } from '@salutejs/plasma-ui/components/Button';
import { TextBox } from '@salutejs/plasma-ui/components/TextBox';
import { whiteSecondary, accent } from '@salutejs/plasma-tokens';
import { formatCurrency } from '@salutejs/plasma-core/utils';
import { Footnote1, Underline, Button1 } from '@salutejs/plasma-ui/components/Typography';
