...
const defaultUrl = PREFIX ? `/${PREFIX}/homeds/` : '/homeds/';
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/plasma-homeds-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/plasma-homeds'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    ...
                    return withCustomConfig('./tsconfig.json', {
                        ...
                        await fg([
                            '../../packages/plasma-homeds/src/**/*.{ts,tsx}',
                            '!../../packages/plasma-homeds/src/**/*.test.*',
                        ]),
                    );
                },
