...
import { Avatar, Cell } from '@salutejs/plasma-homeds';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/plasma-homeds';
import { IconChevronRight } from '@salutejs/plasma-icons';
