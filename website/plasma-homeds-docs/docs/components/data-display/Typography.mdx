...
import { BodyM } from '@salutejs/plasma-homeds';
...
```tsx live
import React from 'react';
import { DsplL } from '@salutejs/plasma-homeds';
...
```tsx live
import React from 'react';
import { DsplL, DsplM, DsplS } from '@salutejs/plasma-homeds';
...
```tsx live
import React from 'react';
import { H1, H2, H3, H4, H5 } from '@salutejs/plasma-homeds';
...
```tsx live
import React from 'react';
import { BodyL, BodyM, BodyS, BodyXS, BodyXXS } from '@salutejs/plasma-homeds';
...
```tsx live
import React from 'react';
import { TextL, TextM, TextS, TextXS } from '@salutejs/plasma-homeds';
