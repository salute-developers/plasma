...
import { ToastProvider } from '@salutejs/plasma-homeds';
...
import React from 'react'
import { useToast, Button } from '@salutejs/plasma-homeds'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/plasma-homeds'
...
import { useToast, ToastProvider, Button } from '@salutejs/plasma-homeds'
