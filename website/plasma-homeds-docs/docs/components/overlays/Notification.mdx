...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/plasma-homeds';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/plasma-homeds';
...
import { NotificationsProvider } from '@salutejs/plasma-homeds';
