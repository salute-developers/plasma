...
```tsx live
import React from 'react';
import { DatePicker, IconButton } from '@salutejs/plasma-homeds';
import { IconDone } from '@salutejs/plasma-icons';
...
<Tabs>
    <TabItem value="uncontrolled" label="Uncontrolled" default>
        ```tsx live
        import React, {useState} from 'react';
        import { DatePickerRange, IconButton } from '@salutejs/plasma-homeds';
        import { IconDone } from '@salutejs/plasma-icons';
    ...
    <TabItem value="controlled" label="Controlled">
        ```tsx live
        import React, {useState} from 'react';
        import { DatePickerRange } from '@salutejs/plasma-homeds';
        import { IconDone } from '@salutejs/plasma-icons';
