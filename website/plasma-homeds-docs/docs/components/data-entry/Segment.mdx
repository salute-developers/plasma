...
<Tabs>
    <TabItem value="uncontrolled" label="Uncontrolled" default>
        ...
        import { SegmentGroup, SegmentItem, SegmentProvider, useSegment } from '@salutejs/plasma-homeds';
...
<Tabs>
    ...
    <TabItem value="size" label="Size">
        ...
        ```tsx live
        import React from 'react';
        import { SegmentGroup, SegmentItem, SegmentProvider } from '@salutejs/plasma-homeds';
