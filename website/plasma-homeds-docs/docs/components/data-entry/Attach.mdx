...
import { Attach } from '@salutejs/plasma-homeds';
...
<Tabs>
    <TabItem value="native" label="Нативная форма" default>
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button } from '@salutejs/plasma-homeds';
    ...
    <TabItem value="complex" label="Сложный пример">
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button, InformationWrapper, outlineSolidPrimary } from '@salutejs/plasma-homeds';
