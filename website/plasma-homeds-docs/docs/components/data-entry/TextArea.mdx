...
<Tabs>
    <TabItem value="default" label="Uncontrolled" default>
        ...
        import { TextArea } from '@salutejs/plasma-homeds';
...
```tsx live
import React from 'react';
import { TextArea, TextS } from '@salutejs/plasma-homeds';
import { surfaceSolidTertiary } from '@salutejs/plasma-themes/tokens';

export function App() {
    const HeaderSlot = () => (
       <div style={{ margin: "0 0.75rem", padding: "0.5rem 0", borderBottom: `0.063rem solid ${surfaceSolidTertiary}` }}>
