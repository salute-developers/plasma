...
export function App() {
    return (
        <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            <Button text="Кнопка" size="m" view="default" />
            <Button text="Кнопка" size="m" view="accent" />
            <Button text="Кнопка" size="m" view="secondary" />
            <Button text="Кнопка" size="m" view="clear" />
            <Button text="Кнопка" size="m" view="warning" />
            <Button text="Кнопка" size="m" view="negative" />
            <Button text="Кнопка" size="m" view="dark" />
        </div>
    );
}
```
