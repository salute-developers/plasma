...
<Tabs>
    <TabItem value="single" label="Single" default>
        ...
        import { Combobox } from '@salutejs/plasma-homeds';
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { Combobox, Button } from '@salutejs/plasma-homeds';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { BodyXS, Combobox, Divider, LinkButton, TabItem, Tabs } from '@salutejs/plasma-homeds';
...
```tsx live
    import React, { useState } from 'react';
    import { Combobox, ComboboxItemOption } from '@salutejs/plasma-homeds';
