...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-sbcom/` : '/sdds-sbcom/';
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-sbcom-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-sbcom'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    return docgen
                        ...
                        .parse(
                            await fg([
                                '../../packages/sdds-sbcom/src/**/*.{ts,tsx}',
                                '!../../packages/sdds-sbcom/src/**/*.test.*',
                            ]),
                        );
                },
