...
export function App() {
    return (
        <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            <Button text="Кнопка" size="s" view="accentFiled" />
            <Button text="Кнопка" size="s" view="accentWhite" />
            <Button text="Кнопка" size="s" view="primaryWhite" />
            <Button text="Кнопка" size="s" view="accentGrey" />
            <Button text="Кнопка" size="s" view="accentClear" />
            <Button text="Кнопка" size="s" view="dangerTint" />
            <Button text="Кнопка" size="s" view="dangerClear" />
            <Button text="Кнопка" size="s" view="primaryGrey" />
        </div>
    );
}
```
