...
export function App() {
    return (
        <Toolbar>
            <Button square size="32" view="accentFiled" contentLeft={<IconEdit />} />
            <Button square size="32" view="accentFiled" contentLeft={<IconEdit />} />
            <Button square size="32" view="accentFiled" contentLeft={<IconEdit />} />
            <ToolbarDivider />
            <Button square size="32" view="accentFiled" contentLeft={<IconEdit />} />
...
export function App() {
    return (
        <div>
            <Toolbar size="l">
                <Button square size="40" view="accentFiled" contentLeft={<IconEdit />} />
                <Button square size="40" view="accentFiled" contentLeft={<IconEdit />} />
                <ToolbarDivider />
                <Button square size="40" view="accentFiled" contentLeft={<IconEdit />} />
                <Button square size="40" view="accentFiled" contentLeft={<IconEdit />} />
            ...
            <Toolbar size="m">
                ...
                <Button square size="32" view="accentFiled" contentLeft={<IconEdit />} />
                <ToolbarDivider />
                <Button square size="24" view="accentFiled" contentLeft={<IconEdit />} />
                <Button square size="24" view="accentFiled" contentLeft={<IconEdit />} />
            </Toolbar>
