...
import CleaningLogicExample from '../../_examples/_autocomplete/_cleaning-logic.mdx'
...
<Tabs>
    <TabItem value="default" label="Default" default>
        ...
        import { Autocomplete } from '@salutejs/sdds-sbcom';
    ...
    <TabItem value="infinite" label="Infinite Loading">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, Cell, Spinner } from '@salutejs/sdds-sbcom';
            ...
            return (
                <div style={{ display: 'block', height:"400px" }}>
                    <Autocomplete
                        ...
                        onScroll={onScroll}
                        threshold={0}
                        renderListEnd={isInfiniteLoading ? () => <Cell contentLeft={<Spinner view="accent" />} title="Загрузка" stretching="auto" /> : undefined}
                        label="Label"
    ...
    <TabItem value="emptyState" label="Empty State">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, EmptyState, Spinner } from '@salutejs/sdds-sbcom';
            ...
            return (
                <div style={{ display: 'block', height:"400px" }}>
                    <Autocomplete
                        ...
                        contentRight={isLoading ? <Spinner view="accent" /> : undefined}
                        label="Label"
                        placeholder="Placeholder"
                        leftHelper="Введите имя Алексей"
                    />
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        import { Autocomplete, BodyXS, Divider, TabItem, Tabs } from '@salutejs/sdds-sbcom';
