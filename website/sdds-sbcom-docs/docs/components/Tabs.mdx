...
import { Tabs, TabItem } from '@salutejs/sdds-sbcom';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, IconTabItem } from '@salutejs/sdds-sbcom';
import { IconClock } from '@salutejs/plasma-icons';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, IconTabItem } from '@salutejs/sdds-sbcom';
import { IconClock } from '@salutejs/plasma-icons';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, IconTabItem, Button } from '@salutejs/sdds-sbcom';
import { IconClock } from '@salutejs/plasma-icons';
...
По умолчанию выбранный Tab переключается без анимации. Чтобы анимировать его перемещение, задайте `transition`
для класса `.tabs-selection`.
...
export function App() {
    ...
    function Demo() {
        const [index, setIndex] = useState(0);
        const labels = ['Label', 'Long label', 'Third', 'One more'];

        return (
            <AnimatedTabs index={index} view="default" pilled size="s" hasDivider={false}>
