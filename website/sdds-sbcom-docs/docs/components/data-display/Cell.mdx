...
import { Avatar, Cell } from '@salutejs/sdds-sbcom';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/sdds-sbcom';
import { IconChevronRight } from '@salutejs/plasma-icons';
