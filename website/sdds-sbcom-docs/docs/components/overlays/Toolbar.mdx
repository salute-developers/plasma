...
title: Toolbar
description: "Панель инструментов с горизонтальной или вертикальной ориентацией."
---
...
import { Toolbar, Button, ToolbarDivider } from '@salutejs/sdds-sbcom';
import { IconEdit } from '@salutejs/plasma-icons';

export function App() {
    return (
        <Toolbar>
            <Button square size="m" view="accentFiled" contentLeft={<IconEdit />} />
            <Button square size="m" view="accentFiled" contentLeft={<IconEdit />} />
            <Button square size="m" view="accentFiled" contentLeft={<IconEdit />} />
            <ToolbarDivider />
            <Button square size="m" view="accentFiled" contentLeft={<IconEdit />} />
...
export function App() {
    return (
        <div>
            <Toolbar size="l">
                <Button square size="l" view="accentFiled" contentLeft={<IconEdit />} />
                <Button square size="l" view="accentFiled" contentLeft={<IconEdit />} />
                <ToolbarDivider />
                <Button square size="l" view="accentFiled" contentLeft={<IconEdit />} />
                <Button square size="l" view="accentFiled" contentLeft={<IconEdit />} />
            ...
            <Toolbar size="m">
                ...
                <Button square size="m" view="accentFiled" contentLeft={<IconEdit />} />
                <ToolbarDivider />
                <Button square size="s" view="accentFiled" contentLeft={<IconEdit />} />
                <Button square size="s" view="accentFiled" contentLeft={<IconEdit />} />
            </Toolbar>
