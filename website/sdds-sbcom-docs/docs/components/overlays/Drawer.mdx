...
import { PopupProvider } from '@salutejs/sdds-sbcom';
            ...
            <div style={{height: "500px"}}>
                ...
                >
                        <DrawerHeader
                            ...
                            actions={(
                                <Button size="s" view="accentFiled" style={{
                                    position: "relative",
                                    width: "1.5rem",
                                    height: "1.5rem"
                                }}>
...
<Tabs>
    <TabItem value="styled" label="styled-components" default>
        ...
        import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupProvider } from  '@salutejs/sdds-sbcom';
