...
import { ToastProvider } from '@salutejs/sdds-sbcom';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-sbcom'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-sbcom'
