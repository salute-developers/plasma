...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-sbcom';
    ...
    function NotificationExample() {
        ...
        return (
            <ButtonGroup isCommonButtonStyles={false}>
                <Button view="accentFiled" text="Показать оповещение" onClick={handleShow} />
                <Button view="accentFiled" text="Скрыть оповещение" onClick={handleHide} />
            </ButtonGroup>
        );
    }
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-sbcom';
...
import { NotificationsProvider } from '@salutejs/sdds-sbcom';
