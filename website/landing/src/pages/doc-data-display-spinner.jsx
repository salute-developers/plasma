                    ...
                    <div className={'doc-layout'}>
                                    ...
                                    <div className={'doc-tree-group'}>
                                        ...
                                        <nav className={'tree-list'}>
                                            ...
                                            <SiteLink
                                                ...
                                                href={'/docs/data-display-spinner'}
                                            >
                                                {'Spinner'}
                                            </SiteLink>
                                            {'\n              '}
                        ...
                        <article className={'article doc-body'}>
                            ...
                            <div className={'article-meta'}>
                                ...
                                <span>{'·'}</span>
                                <SiteLink
                                    href={'https://www.figma.com/design/0FxQGHmGUOCjtHM3N9j4Oq/?node-id=15228-1221242'}
                                >
                                    {'Открыть в Figma'}
                                </SiteLink>
                                {'\n        '}
                            ...
                            <p className={'article-lead'}>
                                {
                                    'Spinner — индикатор неопределённой загрузки. Используется, когда операция выполняется, но время её завершения неизвестно.'
                                }
                            </p>
                            {'\n\n        '}
