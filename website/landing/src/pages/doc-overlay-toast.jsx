                    ...
                    <div className={'doc-layout'}>
                                ...
                                <div className={'doc-tree-inner'}>
                                    ...
                                    <div className={'doc-tree-group'}>
                                        ...
                                        <nav className={'tree-list'}>
                                            ...
                                            {'\n              '}
                                            <SiteLink className={'is-child is-current'} href={'/docs/overlay-toast'}>
                                                {'Toast'}
                                            </SiteLink>
                                            {'\n              '}
                        ...
                        <article className={'article doc-body'}>
                            ...
                            <div className={'article-meta'}>
                                ...
                                <span>{'·'}</span>
                                <SiteLink
                                    href={'https://www.figma.com/design/0FxQGHmGUOCjtHM3N9j4Oq/?node-id=12026-494'}
                                >
                                    {'Открыть в Figma'}
                                </SiteLink>
                                {'\n        '}
                        ...
                        <aside className={'article-side'} data-lenis-prevent={''}>
                            ...
                            <div className={'side-card toc'}>
                                ...
                                <nav className={'toc-list'}>
                                    ...
                                    {'\n            '}
                                    <SiteLink href={'#figma-component-set-toast'} className={'is-sub'}>
                                        {'Figma Component Set: '}
                                        <code>{'Toast'}</code>
                                    </SiteLink>
                                    {'\n            '}
