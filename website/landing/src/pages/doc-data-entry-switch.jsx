                    ...
                    <div className={'doc-layout'}>
                        ...
                        <article className={'article doc-body'}>
                            ...
                            <div className={'article-meta'}>
                                ...
                                <span>{'·'}</span>
                                <SiteLink
                                    href={'https://www.figma.com/design/0FxQGHmGUOCjtHM3N9j4Oq/?node-id=9892-120083'}
                                >
                                    {'Открыть в Figma'}
                                </SiteLink>
                                {'\n        '}
                        ...
                        <aside className={'article-side'} data-lenis-prevent={''}>
                            ...
                            <div className={'side-card toc'}>
                                ...
                                <nav className={'toc-list'}>
                                    ...
                                    {'\n            '}
                                    <SiteLink href={'#togglesize'} className={'is-sub'}>
                                        {'ToggleSize'}
                                    </SiteLink>
                                    {'\n            '}
                                    ...
                                    {'\n            '}
                                    <SiteLink href={'#turn-on'} className={'is-sub'}>
                                        {'Turn On'}
                                    </SiteLink>
                                    {'\n            '}
