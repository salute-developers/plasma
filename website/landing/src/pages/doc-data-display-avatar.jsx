                    ...
                    <div className={'doc-layout'}>
                        ...
                        <article className={'article doc-body'}>
                            ...
                            <div className={'article-meta'}>
                                ...
                                <span>{'·'}</span>
                                <SiteLink
                                    href={'https://www.figma.com/design/0FxQGHmGUOCjtHM3N9j4Oq/?node-id=10404-127654'}
                                >
                                    {'Открыть в Figma'}
                                </SiteLink>
                                {'\n        '}
                        ...
                        <aside className={'article-side'} data-lenis-prevent={''}>
                            ...
                            <div className={'side-card toc'}>
                                ...
                                <nav className={'toc-list'}>
                                    ...
                                    {'\n            '}
                                    <SiteLink href={'#status'} className={'is-sub'}>
                                        {'Status'}
                                    </SiteLink>
                                    {'\n            '}
                                    <SiteLink href={'#iscirculed'} className={'is-sub'}>
                                        {'isCirculed'}
                                    </SiteLink>
                                    {'\n            '}
