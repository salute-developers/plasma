                    ...
                    <div className={'doc-layout'}>
                                    ...
                                    <div className={'doc-tree-group'}>
                                        ...
                                        <nav className={'tree-list'}>
                                            ...
                                            <SiteLink
                                                ...
                                                href={'/docs/data-entry-text-area'}
                                            >
                                                {'TextArea'}
                                            </SiteLink>
                                            {'\n              '}
                        ...
                        <article className={'article doc-body'}>
                            ...
                            <div className={'article-meta'}>
                                ...
                                <span>{'·'}</span>
                                <SiteLink
                                    href={'https://www.figma.com/design/0FxQGHmGUOCjtHM3N9j4Oq/?node-id=10639-112416'}
                                >
                                    {'Открыть в Figma'}
                                </SiteLink>
                                {'\n        '}
                            ...
                            <p className={'article-lead'}>
                                {'Связанный компонент: TextAreaClear ('}
                                <code>{'14493:1665102'}</code>
                                {')'}
                            </p>
                            {'\n\n        '}
