                    ...
                    <div className={'doc-layout'}>
                        ...
                        <article className={'article doc-body'}>
                            ...
                            <div className={'article-meta'}>
                                ...
                                <span>{'·'}</span>
                                <SiteLink
                                    href={'https://www.figma.com/design/0FxQGHmGUOCjtHM3N9j4Oq/?node-id=14329-69'}
                                >
                                    {'Открыть в Figma'}
                                </SiteLink>
                                {'\n        '}
                            ...
                            <p className={'article-lead'}>
                                {
                                    'Accordion — сворачиваемые секции контента. Позволяет скрыть вторичный контент и раскрыть его по запросу пользователя.'
                                }
                            </p>
                            {'\n\n        '}
