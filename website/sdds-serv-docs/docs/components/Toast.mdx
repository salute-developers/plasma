...
import { ToastProvider } from '@salutejs/sdds-serv';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-serv'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-serv'
