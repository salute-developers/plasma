...
import { Combobox, ComboboxItem } from '@salutejs/sdds-serv';
...
```tsx live
import React from 'react';
import { Combobox, ComboboxItem, Checkbox } from '@salutejs/sdds-serv';
...
```tsx live
import React from 'react';
import { Combobox, Checkbox, ComboboxItem } from '@salutejs/sdds-serv';
