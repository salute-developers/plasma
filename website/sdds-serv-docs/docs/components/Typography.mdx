...
import { BodyM } from '@salutejs/sdds-serv';
...
```tsx live
import React from 'react';
import { DsplL } from '@salutejs/sdds-serv';
...
```tsx live
import React from 'react';
import { DsplL, DsplM, DsplS } from '@salutejs/sdds-serv';
...
```tsx live
import React from 'react';
import { BodyL, BodyM, BodyS, BodyXS, BodyXXS } from '@salutejs/sdds-serv';
...
```tsx live
import React from 'react';
import { TextL, TextM, TextS, TextXS } from '@salutejs/sdds-serv';
