...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-serv';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-serv';
