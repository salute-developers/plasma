...
import { Steps } from '@salutejs/sdds-serv';
...
```tsx live
import React, { useState } from 'react';
import { Steps, StepItemProps } from '@salutejs/sdds-serv';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Button } from '@salutejs/sdds-serv';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Accordion, AccordionItem } from '@salutejs/sdds-serv';
