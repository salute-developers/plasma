...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-crm/` : '/sdds-crm/';
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-crm-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-crm'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    ...
                    return withCustomConfig('./tsconfig.json', {
                        ...
                        await fg([
                            '../../packages/sdds-crm/src/**/*.{ts,tsx}',
                            '!../../packages/sdds-crm/src/**/*.test.*',
                        ]),
                    );
                },
