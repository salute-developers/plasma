...
<Tabs>
    <TabItem value="textfield" label="Textfield" default>
        ...
        import { Select } from '@salutejs/sdds-crm';
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Button } from '@salutejs/sdds-crm';
    ...
    <TabItem value="renderItem" label="Render item">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Cell } from '@salutejs/sdds-crm';
...
```tsx live
import React, { useState } from 'react';
import { Select, TextField } from '@salutejs/sdds-crm';
