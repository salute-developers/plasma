...
import { DatePicker } from '@salutejs/sdds-crm';
...
```tsx live
import React from 'react';
import { DatePicker, IconButton } from '@salutejs/sdds-crm';
import { IconDone } from '@salutejs/plasma-icons';
...
```tsx live
import React from 'react';
import { DatePickerRange, IconButton } from '@salutejs/sdds-crm';
import { IconDone } from '@salutejs/plasma-icons';
...
<Tabs>
    ...
    <TabItem value="range" label="DatePickerRange">
        ...
        ```tsx live
        import React, {useState} from 'react';
        import { DatePickerRange } from '@salutejs/sdds-crm';
        import { IconDone } from '@salutejs/plasma-icons';
