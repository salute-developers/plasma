...
import { Button, ButtonGroup, addNotification, closeNotification, NotificationsProvider } from '@salutejs/sdds-crm';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-crm';
...
import { NotificationsProvider } from '@salutejs/sdds-crm';
