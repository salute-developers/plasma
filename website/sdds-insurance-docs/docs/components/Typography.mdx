...
import { DsplL, DsplM, DsplS } from '@salutejs/sdds-insurance';
...
```tsx live
import React from 'react';
import { H1, H2, H3, H4, H5 } from '@salutejs/sdds-insurance';
...
```tsx live
import React from 'react';
import { BodyL, BodyM, BodyS, BodyXS, BodyXXS } from '@salutejs/sdds-insurance';
...
```tsx live
import React from 'react';
import { TextL, TextM, TextS, TextXS } from '@salutejs/sdds-insurance';
