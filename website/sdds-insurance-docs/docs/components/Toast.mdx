...
import { ToastProvider } from '@salutejs/sdds-insurance';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-insurance'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button } from '@salutejs/sdds-insurance'
