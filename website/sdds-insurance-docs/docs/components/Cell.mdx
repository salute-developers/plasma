...
import { Avatar, Cell } from '@salutejs/sdds-insurance';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/sdds-insurance';
import { IconChevronRight } from '@salutejs/plasma-icons';
