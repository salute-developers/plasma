...
<Tabs>
    <TabItem value="default" label="Default" default>
        ...
        import { Autocomplete } from '@salutejs/sdds-insurance';
    ...
    <TabItem value="infinite" label="Infinite Loading">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, Cell, Spinner } from '@salutejs/sdds-insurance';
    ...
    <TabItem value="emptyState" label="Empty State">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, EmptyState, Spinner } from '@salutejs/sdds-insurance';
