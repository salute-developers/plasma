...
const baseUrl = VERSION_NAME ? `/versions/${VERSION_NAME}/` : `${prefix}/sdds-insurance/`;

/** @type {import('@docusaurus/types').DocusaurusConfig} */
module.exports = {
    title: 'SDDS INSURANCE',
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-insurance-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-insurance'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    return docgen
                        ...
                        .parse(
                            await fg([
                                '../../packages/sdds-insurance/src/**/*.{ts,tsx}',
                                '!../../packages/sdds-insurance/src/**/*.test.*',
                            ]),
                        );
                },
