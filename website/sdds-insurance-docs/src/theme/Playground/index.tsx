...
import { sdds_insurance__dark, sdds_insurance__light } from '@salutejs/sdds-themes';
...
const LightTheme = createGlobalStyle(sdds_insurance__light);
const DarkTheme = createGlobalStyle(sdds_insurance__dark);
