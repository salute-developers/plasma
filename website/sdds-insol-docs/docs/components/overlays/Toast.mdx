...
import { ToastProvider } from '@salutejs/sdds-insol';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-insol'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-insol'
