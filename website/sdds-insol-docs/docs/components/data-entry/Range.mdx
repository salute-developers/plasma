...
<Tabs>
    <TabItem value="uncontrolled" label="Uncontrolled" default>
        ...
        import { Range } from '@salutejs/sdds-netology';
...
<Tabs>
    <TabItem value="appearance" label="Appearance" default>
        ...
        ```tsx live
        import React from 'react';
        import { Range } from '@salutejs/sdds-dfa';
...
```tsx live
import React from 'react';
import { Range, IconButton } from '@salutejs/sdds-netology';
...
<PropsTable name="Range" exclude={['css', 'appearance', 'view']} />
