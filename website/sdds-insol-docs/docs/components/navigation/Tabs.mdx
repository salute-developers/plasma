...
import { Tabs, TabItem } from '@salutejs/sdds-insol';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, IconTabItem } from '@salutejs/sdds-insol';
import { IconClock } from '@salutejs/plasma-icons';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, IconTabItem, Button } from '@salutejs/sdds-insol';
import { IconClock } from '@salutejs/plasma-icons';
