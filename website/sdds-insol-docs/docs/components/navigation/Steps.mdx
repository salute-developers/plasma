...
import { Steps } from '@salutejs/sdds-insol';
...
```tsx live
import React, { useState } from 'react';
import { Steps, StepItemProps } from '@salutejs/sdds-insol';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Button } from '@salutejs/sdds-insol';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Accordion, AccordionItem } from '@salutejs/sdds-insol';
