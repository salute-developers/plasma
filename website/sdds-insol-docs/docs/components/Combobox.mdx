...
<Tabs>
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { Combobox, Button } from '@salutejs/sdds-insol';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { BodyXS, Combobox, Divider, LinkButton, TabItem, Tabs } from '@salutejs/sdds-insol';
...
```tsx live
    import React, { useState } from 'react';
    import { Combobox, ComboboxItemOption } from '@salutejs/sdds-insol';
