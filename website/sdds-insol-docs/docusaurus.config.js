        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-insol-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-insol'],
                            path: '',
                        },
                    },
                },
    ...
    plugins: [
            ...
            return {
                ...
                async loadContent() {
                    return docgen
                        ...
                        .parse(
                            await fg([
                                '../../packages/sdds-insol/src/**/*.{ts,tsx}',
                                '!../../packages/sdds-insol/src/**/*.test.*',
                            ]),
                        );
                },
        ...
        [
            'docusaurus-plugin-llms',
            {
                ...
                title: 'Библиотека компонентов SDDS INSOL',
                description:
                    'React-компоненты дизайн-системы SDDS INSOL для веб-приложений. Два варианта поставки: предсобранный CSS (по умолчанию) и styled-components.',
                version: pckgJson.dependencies['@salutejs/sdds-insol'],
