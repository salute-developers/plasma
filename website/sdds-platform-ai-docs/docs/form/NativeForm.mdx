...
description: "Подход к работе с нативной html-формой (тег form) и компонентами библиотеки."
sidebar_position: 3
---
...
import { Button, TextField, TextArea, Checkbox, Switch, Radiobox, RadioGroup, Slider } from "@salutejs/sdds-platform-ai";
...
export function App() {
    ...
    return (
        <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <Combobox items={items} label="Combobox" name="combobox" />
