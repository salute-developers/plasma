...
<Tabs>
    <TabItem value="uncontrolled" label="Uncontrolled" default>
        ...
        import { SegmentGroup, SegmentItem, SegmentProvider, useSegment } from '@salutejs/sdds-platform-ai';
...
<Tabs>
    ...
    <TabItem value="size" label="Size">
        ...
        Доступные размеры: `xs`, `s`, `m`, `l`.

        ```tsx live
        import React from 'react';
        import { SegmentGroup, SegmentItem, SegmentProvider } from '@salutejs/sdds-platform-ai';
