---
id: number-format
slug: /components/number-format
title: NumberFormat
description: "Форматирование числа: разделители разрядов, префикс и суффикс."
---
...
Он реализован на компоненте [TextField](https://plasma.sberdevices.ru/sdds-platform-ai/components/textfield/)
...
import { NumberFormat } from '@salutejs/sdds-platform-ai';
