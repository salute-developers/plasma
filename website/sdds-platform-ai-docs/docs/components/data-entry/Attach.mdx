---
id: attach
slug: /components/attach
title: Attach
description: "Открытие выбора файла по нажатию кнопки — прикрепление локального файла."
---
...
import { Attach } from '@salutejs/sdds-platform-ai';
...
<Tabs>
    <TabItem value="native" label="Нативная форма" default>
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button } from '@salutejs/sdds-platform-ai';
    ...
    <TabItem value="complex" label="Сложный пример">
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button, InformationWrapper, outlineSolidPrimary } from '@salutejs/sdds-platform-ai';
