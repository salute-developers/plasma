...
export function App() {
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: "32px", height: '500px'}}>
            <TimePicker size="m" columnsQuantity={2} placeholder="ЧЧ:мм" />
            <TimePicker size="m" columnsQuantity={3} placeholder="ЧЧ:мм:сс" />
        </div>
    );
}
```
...
export function App() {
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: "32px", width: "300px", height: '500px'}}>
            <TimePicker size="m" dropdownAlign="left" placeholder="Выравнивание слева" />
            <TimePicker size="m" dropdownAlign="right" placeholder="Выравнивание справа" />
        </div>
    );
}
```
