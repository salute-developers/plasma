---
id: CodeInput
slug: /components/CodeInput
title: CodeInput
description: "Ввод пин-кода или одноразового пароля крупными символами с индикаторами."
---
...
import { CodeInput } from '@salutejs/sdds-platform-ai';
