...
title: Dropzone
description: "Область загрузки файлов перетаскиванием (drag-and-drop)."
---
...
import { Dropzone } from '@salutejs/sdds-platform-ai';
...
import { Dropzone, Chip } from '@salutejs/sdds-platform-ai';
