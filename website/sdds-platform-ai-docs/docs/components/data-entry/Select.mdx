...
<Tabs>
    <TabItem value="textfield" label="Textfield" default>
        ...
        import { Select } from '@salutejs/sdds-platform-ai';
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Button } from '@salutejs/sdds-platform-ai';
    ...
    <TabItem value="renderItem" label="Render item">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Cell } from '@salutejs/sdds-platform-ai';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { BodyXS, Divider, LinkButton, Select, TabItem, Tabs } from '@salutejs/sdds-platform-ai';
            ...
            return (
                <div style={{ display: 'flex', flexDirection: 'column', maxWidth: '350px', height: '420px' }}>
                    <Select
                        ...
                        listMaxHeight="200px"
                        beforeList={
                            <Tabs view="filled" size="s" stretch>
                                {regions.map((item) => (
                                    <TabItem
                                        key={item.value}
                                        view="divider"
...
```tsx live
import React, { useState } from 'react';
import { Select, TextField } from '@salutejs/sdds-platform-ai';
