...
<Tabs>
    <TabItem value="shimmer" label="shimmer" default>
        ...
        import { LineSkeleton } from '@salutejs/sdds-platform-ai';
...
```tsx live
import React from 'react';
import { RectSkeleton } from '@salutejs/sdds-platform-ai';
...
```tsx live
import React from 'react';
import { TextSkeleton } from '@salutejs/sdds-platform-ai';
