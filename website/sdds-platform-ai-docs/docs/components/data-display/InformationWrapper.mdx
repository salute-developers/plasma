...
slug: /components/informationWrapper
title: InformationWrapper
description: "Обёртка для элементов формы с подписью и вспомогательным текстом."
---
...
import { InformationWrapper, TextField, TextArea } from '@salutejs/sdds-platform-ai';
...
```tsx live
import React from 'react';
import { InformationWrapper } from '@salutejs/sdds-platform-ai';
