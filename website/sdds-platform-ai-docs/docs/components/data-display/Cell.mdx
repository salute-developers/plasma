...
import { Avatar, Cell } from '@salutejs/sdds-platform-ai';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/sdds-platform-ai';
import { IconChevronRight } from '@salutejs/plasma-icons';
