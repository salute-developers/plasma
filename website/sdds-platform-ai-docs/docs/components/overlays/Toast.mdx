...
title: Toast
description: "Всплывающее уведомление (toast) поверх контента."
---
...
import { ToastProvider } from '@salutejs/sdds-platform-ai';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-platform-ai'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-platform-ai'
...
import { useToast, ToastProvider, Button } from '@salutejs/sdds-platform-ai'
