...
title: Notification
description: "Динамические уведомления и алерты; часть системы уведомлений."
---
...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-platform-ai';
