...
import { PopupProvider } from '@salutejs/sdds-platform-ai';
...
<Tabs>
    <TabItem value="styled" label="styled-components" default>
        ...
        import { SSRProvider, H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupProvider } from  '@salutejs/sdds-platform-ai';
