...
import { Tabs, TabItem } from '@salutejs/sdds-platform-ai';
...
export function App() {
    ...
    return (
        <div>
            <Tabs view="filled" stretch size="m">
                {items.map((_, i) => (
                    <TabItem
                        view="secondary"
                        key={`item:${i}`}
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, IconTabItem } from '@salutejs/sdds-platform-ai';
import { IconClock } from '@salutejs/plasma-icons';
...
export function App() {
    ...
    return (
        <div style={{ gap: '2rem' }}>
            <Tabs view="divider" orientation="vertical" size="m" style={{ width: '15rem' }}>
                {items.map((_, i) => (
                    <TabItem
                        view="divider"
...
### Расположение divider у вертикальных Tabs
Для вертикальных Tabs можно расположить разделитель (`divider`) слева (по умолчанию) или справа с помощью свойства `dividerAlign`.

```tsx live
import React, { useState } from 'react';
import { Tabs, IconTabItem } from '@salutejs/sdds-platform-ai';
import { IconClock } from '@salutejs/plasma-icons';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, Button } from '@salutejs/sdds-platform-ai';
import { IconClock } from '@salutejs/plasma-icons';
...
export function App() {
    ...
    return (
        <div style={{ display:'flex', flexDirection: 'column', gap: '1rem' }}>
            <Tabs view="divider" size="m" style={{ width: '15rem' }}>
                {items.map((_, i) => (
                    <TabItem
                        view="divider"
                        key={`item:${i}`}
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, IconTabItem, Dropdown } from '@salutejs/sdds-platform-ai';
import { IconClock, IconDotsHorizontalOutline } from '@salutejs/plasma-icons';
                ...
                <Tabs clip="showAll" view="divider" size="m">
                    ...
                    {dropdownItems.length > 0 && (
                        <div style={{ marginLeft: '1.75rem' }}>
                            <Dropdown size="m" items={dropdownItems} onItemSelect={(item) => setIndex(item.value)}>
...
export function App() {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: "50px"}}>
            <div>
                <Tabs view="divider" stretch size="m" index={horizontalIndex}>
                    {items.map((_, i) => (
                        <TabItem
                            view="divider"
                            key={`item:${i}`}
            ...
            <div>
                <Tabs orientation="vertical" view="divider" size="m" index={verticalIndex}>
                    {items.map((_, i) => (
                        <TabItem
                            orientation="vertical"
                            view="divider"
