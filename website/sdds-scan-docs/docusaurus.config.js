...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-scan/` : '/sdds-scan/';
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-scan-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-scan'],
                            path: '',
                        },
                    },
                },
    ...
    plugins: [
            ...
            return {
                ...
                async loadContent() {
                    ...
                    return withCustomConfig(path.resolve(__dirname, 'tsconfig.json'), {
                        ...
                        await fg([
                            '../../packages/sdds-scan/src/**/*.{ts,tsx}',
                            '!../../packages/sdds-scan/src/**/*.test.*',
                        ]),
                    );
                },
        ...
        [
            'docusaurus-plugin-llms',
            {
                ...
                title: 'Библиотека компонентов SDDS SCAN',
                description:
                    'React-компоненты дизайн-системы SDDS SCAN для веб-приложений. Два варианта поставки: предсобранный CSS (по умолчанию) и styled-components.',
                version: pckgJson.dependencies['@salutejs/sdds-scan'],
                ...
                rootContent: [
                    'Установка: `npm install @salutejs/sdds-scan @salutejs/sdds-themes` (peer-зависимости: react и react-dom версии 16.13.1 или выше).',
                    'Точки входа: `@salutejs/sdds-scan` — предсобранный CSS (поставка по умолчанию), `@salutejs/sdds-scan/styled-components` — нужен styled-components@5.3.1.',
                    'Темы: `sdds_scan__light`, `sdds_scan__dark` из `@salutejs/sdds-themes`; дизайн-токены — из `@salutejs/sdds-themes/tokens`.',
                    'MCP-сервер с актуальной документацией: `npx -y @salutejs/sdds-mcp@latest --lib sdds-scan`.',
                ].join('\n\n'),
            },
        ],
    ],
