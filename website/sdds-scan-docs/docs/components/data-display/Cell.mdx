...
import { Avatar, Cell } from '@salutejs/sdds-scan';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/sdds-scan';
import { IconChevronRight } from '@salutejs/plasma-icons';
