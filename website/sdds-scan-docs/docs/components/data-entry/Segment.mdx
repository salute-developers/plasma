...
<Tabs>
    <TabItem value="uncontrolled" label="Uncontrolled" default>
        ...
        import { SegmentGroup, SegmentItem, SegmentProvider, useSegment } from '@salutejs/sdds-scan';
...
<Tabs>
    ...
    <TabItem value="size" label="Size">
        ...
        Доступные размеры: `s`, `m`.

        ```tsx live
        import React from 'react';
        import { SegmentGroup, SegmentItem, SegmentProvider } from '@salutejs/sdds-scan';
