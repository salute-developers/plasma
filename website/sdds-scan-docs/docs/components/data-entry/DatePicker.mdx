...
Внешний вид компонента зависит от свойств `size`:
...
```tsx live
import React from 'react';
import { DatePicker, IconButton } from '@salutejs/sdds-scan';
import { IconDone } from '@salutejs/plasma-icons';
...
<Tabs>
    <TabItem value="uncontrolled" label="Uncontrolled" default>
        ```tsx live
        import React, {useState} from 'react';
        import { DatePickerRange, IconButton } from '@salutejs/sdds-scan';
        import { IconDone } from '@salutejs/plasma-icons';
    ...
    <TabItem value="controlled" label="Controlled">
        ```tsx live
        import React, {useState} from 'react';
        import { DatePickerRange } from '@salutejs/sdds-scan';
        import { IconDone } from '@salutejs/plasma-icons';
...
Внешний вид компонента зависит от свойств `size`, `isDoubleCalendar`:

<Tabs>
    <TabItem value="size" label="Size">
        Размер `DatePickerRange` задаётся с помощью свойства `size`.
        Возможные значения свойства: `"m"`, `"s"`.
