...
<Tabs>
    <TabItem value="default" label="Uncontrolled" default>
        ...
        import { TextArea } from '@salutejs/sdds-scan';
...
```tsx live
import React from 'react';
import { TextArea, TextS } from '@salutejs/sdds-scan';
import { surfaceSolidSecondary } from '@salutejs/sdds-themes/tokens';

export function App() {
    const HeaderSlot = () => (
       <div style={{ margin: "0 0.75rem", padding: "0.5rem 0", borderBottom: `0.063rem solid ${surfaceSolidSecondary}` }}>
