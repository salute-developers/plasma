...
import { TextFieldGroup, TextField } from '@salutejs/sdds-scan';
...
export function App() {
    return (
        <div>
            <TextFieldGroup size="s" shape="segmented">
                {Array(3)
                    .fill(true)
                    .map((_, i) => (
                        <TextField placeholder={`input #${i}`} />
            ...
            <TextFieldGroup size="s" shape="default">
                {Array(3)
                    .fill(true)
                    .map((_, i) => (
                        <TextField placeholder={`input #${i}`} />
...
export function App() {
    return (
        <div>
            <TextFieldGroup size="s" orientation="vertical" shape="segmented" gap="none">
                {Array(5)
                    .fill(true)
                    .map((_, i) => (
                        <TextField placeholder={`input #${i}`} />
            ...
            <TextFieldGroup size="s" orientation="horizontal" gap="wide">
                {Array(4)
                    .fill(true)
                    .map((_, i) => (
                        <TextField placeholder={`input #${i}`} />
