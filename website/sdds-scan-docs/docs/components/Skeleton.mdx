...
<Tabs>
    <TabItem value="shimmer" label="shimmer" default>
        ...
        import { LineSkeleton } from '@salutejs/sdds-scan';
...
```tsx live
import React from 'react';
import { RectSkeleton } from '@salutejs/sdds-scan';
...
```tsx live
import React from 'react';
import { TextSkeleton } from '@salutejs/sdds-scan';
...
```tsx live
import React from 'react';
import { Button, withSkeleton } from '@salutejs/sdds-scan';
