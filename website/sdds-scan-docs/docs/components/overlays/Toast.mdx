...
import { ToastProvider } from '@salutejs/sdds-scan';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-scan'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-scan'
...
import { useToast, ToastProvider, Button } from '@salutejs/sdds-scan'
