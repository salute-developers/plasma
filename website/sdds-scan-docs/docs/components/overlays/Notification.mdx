...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-scan';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-scan';
...
import { NotificationsProvider } from '@salutejs/sdds-scan';
