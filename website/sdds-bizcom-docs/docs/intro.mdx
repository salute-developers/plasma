...
id: intro
title: Введение
description: "Библиотека компонентов SDDS BIZCOM: установка, варианты поставки, подключение шрифтов и темы, использование компонентов и токенов."
sidebar_position: 1
slug: /
---
...
:::tip
Путь `@salutejs/sdds-themes/tokens/sdds_bizcom` следует использовать, когда нужны токены, которые есть только в этой теме.
:::
