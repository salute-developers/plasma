...
import { Avatar, Cell } from '@salutejs/sdds-bizcom';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/sdds-bizcom';
import { IconChevronRight } from '@salutejs/plasma-icons';
