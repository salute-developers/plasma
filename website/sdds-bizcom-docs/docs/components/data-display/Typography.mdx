...
import { BodyM } from '@salutejs/sdds-bizcom';
...
```tsx live
import React from 'react';
import { DsplL } from '@salutejs/sdds-bizcom';
...
```tsx live
import React from 'react';
import { DsplL, DsplM, DsplS } from '@salutejs/sdds-bizcom';
...
```tsx live
import React from 'react';
import { H1, H2, H3, H4, H5, H6 } from '@salutejs/sdds-bizcom';
...
```tsx live
import React from 'react';
import { BodyL, BodyM, BodyS, BodyXS, BodyXXS } from '@salutejs/sdds-bizcom';
...
```tsx live
import React from 'react';
import { TextL, TextM, TextS, TextXS } from '@salutejs/sdds-bizcom';
