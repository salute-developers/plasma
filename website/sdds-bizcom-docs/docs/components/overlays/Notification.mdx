...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-bizcom';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-bizcom';
...
import { NotificationsProvider } from '@salutejs/sdds-bizcom';
