...
import { ToastProvider } from '@salutejs/sdds-bizcom';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-bizcom'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-bizcom'
...
import { useToast, ToastProvider, Button } from '@salutejs/sdds-bizcom'
