...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-bizcom/` : '/sdds-bizcom/';
...
module.exports = {
    ...
    themeConfig: {
        ...
        typesense: {
            ...
            typesenseCollectionName: 'bizcom',
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-bizcom-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-bizcom'],
                            path: '',
                        },
                    },
                },
    ...
    plugins: [
            ...
            return {
                ...
                async loadContent() {
                    return docgen
                        ...
                        .parse(
                            await fg([
                                '../../packages/sdds-bizcom/src/**/*.{ts,tsx}',
                                '!../../packages/sdds-bizcom/src/**/*.test.*',
                            ]),
                        );
                },
        ...
        [
            'docusaurus-plugin-llms',
            {
                ...
                title: 'Библиотека компонентов SDDS BIZCOM',
                description:
                    'React-компоненты дизайн-системы SDDS BIZCOM для веб-приложений. Два варианта поставки: предсобранный CSS (по умолчанию) и styled-components.',
                version: pckgJson.dependencies['@salutejs/sdds-bizcom'],
