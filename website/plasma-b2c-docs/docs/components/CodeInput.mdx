...
### Размер экрана и длина кода
Размер экрана задается через параметр `screen`. Длина кода с помощью `codeLength`:
    ...
    return (
        <div style={{ flexDirection: 'column', gap: '2rem' }}>
            <div style={{ display: 'flex', gap: '2rem' }}>
                <CodeInput screen="small" codeLength={4} />
                <CodeInput screen="medium"  codeLength={4} />
                <CodeInput screen="large"  codeLength={4} />
            </div>
            <div style={{ display: 'flex', gap: '2rem' }}>
                <CodeInput screen="small" codeLength={5} />
                <CodeInput screen="medium"  codeLength={5} />
                <CodeInput screen="large"  codeLength={5} />
            </div>
            <div style={{ display: 'flex', gap: '2rem' }}>
                <CodeInput screen="small" codeLength={6} />
                <CodeInput screen="medium"  codeLength={6} />
                <CodeInput screen="large"  codeLength={6} />
            </div>
        </div>
    );
}
...
export function App() {
    return (
        <div>
            <CodeInput value="123" itemErrorBehavior="remove-symbol" />
            <CodeInput value="123" itemErrorBehavior="keep" />
            <CodeInput value="123" itemErrorBehavior="forbid-enter" />
        </div>
    );
}
```
