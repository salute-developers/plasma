...
export function App() {
    return (
        <div>
            <IconButton pin="square-square"><IconClose  color="inherit" /></IconButton>
            <IconButton pin="square-clear"><IconClose  color="inherit" /></IconButton>
            ...
            <IconButton pin="circle-clear"><IconClose  color="inherit" /></IconButton>
            <IconButton pin="circle-circle"><IconClose  color="inherit" /></IconButton>
        </div>
    );
}
```
