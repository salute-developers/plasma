...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/plasma-b2c';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/plasma-b2c';
