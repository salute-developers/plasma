...
<Description name="SelectNew" />
<PropsTable name="SelectNew" />

## Использование
Обязательным параметром являются: `items`, `value` и `onChange`.
...
Тип выбора Select - одиночный или множественный зависит от типа `value` и `onChange`. В одиночном value - `string`, в множественном - `Array<string>`.
...
<Tabs>
    <TabItem value="textfield" label="Textfield" default>
        ...
        import { SelectNew } from '@salutejs/plasma-b2c';
            ...
            return (
                <div style={{ display: 'flex', gap: '30px', height: '300px' }}>
                    <div style={{width: '300px'}}>
                        <SelectNew items={items} label="Single" value={singleValue} onChange={setSingleValue} label="Label" placeholder="Placeholder" helperText="Helper text" />
                    </div>

                    <div style={{width: '300px'}}>
                        <SelectNew multiselect items={items} label="Multiple" value={multipleValue} onChange={setMultipleValue} label="Label" placeholder="Placeholder" helperText="Helper text" />
                    </div>
                </div>
            );
        }
    ...
    <TabItem value="button" label="Button">
        ...
        export function App() {
            ...
            return (
                <div style={{ display: 'flex', gap: '30px', height: '300px' }}>
                    <div style={{width: '300px'}}>
                        <SelectNew items={items} label="Single" target="button-like" value={singleValue} onChange={setSingleValue} />
                    </div>

                    <div style={{width: '300px'}}>
                        <SelectNew multiselect items={items} label="Multiple" target="button-like" value={multipleValue} onChange={setMultipleValue} />
                    </div>
                </div>
            );
        }
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React from 'react';
        import { SelectNew, Button } from '@salutejs/plasma-b2c';
        ...
        export function App() {
            ...
            return (
                <div style={{ display: 'flex', gap: '30px', height: '300px' }}>
                    <div style={{width: '300px'}}>
                        <SelectNew items={items} label="Label" placeholder="Placeholder" value={multipleValue} onChange={setMultipleValue} />
                    </div>
        ...
        export function App() {
            ...
            return (
                <div style={{ height: '300px' }}>
                    <div style={{width: '300px'}}>
                        <SelectNew items={items} label="Label" placeholder="Placeholder" value={multipleValue} onChange={setMultipleValue} renderValue={renderValue} />
                    </div>
                </div>
            );
        }
    ...
    <TabItem value="renderItem" label="Render item">
        Пропс `renderItem` для custom настройки item в выпадающем списке. Принимает callback с двумя параметрами: `value` и `label`.
        В примере использован другой наш компонент - Cell.

        ```tsx live
        import React from 'react';
        import { SelectNew, Cell } from '@salutejs/plasma-b2c';
        ...
        export function App() {
            ...
            return (
                <div style={{ height: '300px' }}>
                    <div style={{width: '300px'}}>
                        <SelectNew items={items} label="Label" placeholder="Placeholder" value={multipleValue} onChange={setMultipleValue} renderItem={renderItem} />
                    </div>
                </div>
            );
        }
        ...
        export function App() {
            ...
            return (
                <div style={{ height: '300px' }} ref={ref}>
                    <div style={{width: '300px'}}>
                        <SelectNew items={items} label="Label" placeholder="Placeholder" value={value} onChange={setValue} portal={ref} listWidth="300px" />
                    </div>
                </div>
            );
        }
       ...
       ```tsx live
        ...
        export function App() {
            ...
            return (
                <div style={{ height: '300px' }}>
                    <div style={{width: '300px'}}>
                        <SelectNew items={items} label="Label" placeholder="Placeholder" />
                    </div>
                </div>
            );
        }
...
- `Enter` - открывает/закрывает DropDown. Если на элементе - выбирает его. Если у элемента есть дочерний DropDown - открывает его, выбор элемента не происходит;
- `Space` - открывает/закрывает DropDown. Если на элементе - выбирает его и все дочерние элементы.
...
- `ArrowRight` - если фокус на элементе вложенного списка - открывает его и перемещает фокус на первый элемент; Если фокус на target - переходит в режим выбора чипа.
- `ArrowLeft` - закрывает текущий список и перемещает фокус на предыдущий; Если фокус на target - переходит в режим выбора чипа.
- `Backspace` - только если фокус на Chip - снимает выбор с текущего значения;
