...
import { Combobox, ComboboxItem } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { Combobox, ComboboxItem, Checkbox } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { Combobox, Checkbox, ComboboxItem } from '@salutejs/plasma-b2c';
