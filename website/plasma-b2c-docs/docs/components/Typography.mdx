...
```tsx live
import React from 'react';
import { DsplL } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { DsplL, DsplM, DsplS } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { BodyL, BodyM, BodyS, BodyXS, BodyXXS } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { TextL, TextM, TextS, TextXS } from '@salutejs/plasma-b2c';
