...
import React from 'react'
import { useToast, Button } from '@salutejs/plasma-b2c'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button } from '@salutejs/plasma-b2c'
...
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/plasma-b2c'
