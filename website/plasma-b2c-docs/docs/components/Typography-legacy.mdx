...
import { Headline1, Headline2, Headline3, Headline4 } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { Body1, Body2, ParagraphText1, ParagraphText2 } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { Footnote1, Footnote2 } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { Button1, Button2 } from '@salutejs/plasma-b2c';
...
```tsx live
import React from 'react';
import { Caption, Underline } from '@salutejs/plasma-b2c';
