...
import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupBaseProvider } from  '@salutejs/plasma-b2c';
...
<Tabs>
    <TabItem value="styled" label="styled-components" default>
        ...
        import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupProvider } from  '@salutejs/plasma-b2c';
    ...
    <TabItem value="linaria" label="linaria / css-modules / css">
        ...
        import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupProvider } from  '@salutejs/b2c';
