...
title: TextArea
description: "Многострочное поле ввода, обычное или с автоувеличением высоты."
---
...
<Tabs>
    <TabItem value="default" label="Uncontrolled" default>
        ...
        import { TextArea } from '@salutejs/sdds-dfa';
...
Значение `positive` для свойства `view` устарело и будет удалено в ближайшее время!
:::
...
```tsx live
import React from 'react';
import { TextArea, TextS } from '@salutejs/sdds-dfa';
