...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-dfa';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-dfa';
...
import { NotificationsProvider } from '@salutejs/sdds-dfa';
