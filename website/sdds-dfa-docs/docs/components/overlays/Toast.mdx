...
import { ToastProvider } from '@salutejs/sdds-dfa';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-dfa'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-dfa'
