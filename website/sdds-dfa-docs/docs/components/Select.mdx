    ...
    <TabItem value="predefined" label="Predefined">
        ...
        export function App() {
            ...
            return (
                <div style={{ display: 'flex', gap: '30px', height: '300px' }}>
                    <div style={{width: '300px'}}>
                        <Select items={items} label="Label" placeholder="Placeholder" value={multipleValue} onChange={setMultipleValue} />
                    </div>
            ...
            return (
                <div style={{ height: '300px' }}>
                    <div style={{width: '400px'}}>
                        <Select items={items} value={singleValue} onChange={setSingleValue} renderTarget={renderTarget} renderItem={renderItem} />
                    </div>
                </div>
            );
        }
