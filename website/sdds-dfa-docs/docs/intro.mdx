...
id: intro
title: Введение
description: "Библиотека компонентов SDDS DFA: установка, вариант поставки, подключение шрифтов и темы, использование компонентов и токенов."
sidebar_position: 1
slug: /
---
...
# Библиотека компонентов для вертикали SDDS DFA
...
Единственный вариант поставки — [styled-components](https://styled-components.com/).
...
:::tip
Путь `@salutejs/sdds-themes/tokens/sdds_dfa` следует использовать, когда нужны токены, которые есть только в этой теме.
:::
