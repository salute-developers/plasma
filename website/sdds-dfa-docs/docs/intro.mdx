...
const lightThemeStyle = css(sdds_dfa__light);
const darkThemeStyle = css(sdds_dfa__dark);
...
import { Switch } from '@salutejs/sdds-dfa';
import webThemes from '@salutejs/sdds-themes/css/sdds_dfa.module.css';
...
// @import '@salutejs/sdds-themes/css/sdds_dfa.module.css';
import './style.css';
