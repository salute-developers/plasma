...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-clfd-auto/` : '/sdds-clfd-auto/';
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-clfd-auto-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-clfd-auto'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    return docgen
                        ...
                        .parse(
                            await fg([
                                '../../packages/sdds-clfd-auto/src/**/*.{ts,tsx}',
                                '!../../packages/sdds-clfd-auto/src/**/*.test.*',
                            ]),
                        );
                },
