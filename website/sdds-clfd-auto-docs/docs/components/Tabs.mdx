...
import { Tabs, TabItem } from '@salutejs/sdds-clfd-auto';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, Button } from '@salutejs/sdds-clfd-auto';
import { IconClock } from '@salutejs/plasma-icons';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, Dropdown } from '@salutejs/sdds-clfd-auto';
