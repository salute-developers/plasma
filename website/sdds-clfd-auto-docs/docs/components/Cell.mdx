...
import { Avatar, Cell } from '@salutejs/sdds-clfd-auto';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/sdds-clfd-auto';
import { IconChevronRight } from '@salutejs/plasma-icons';
