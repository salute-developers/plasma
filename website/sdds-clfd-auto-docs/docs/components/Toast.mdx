...
import { ToastProvider } from '@salutejs/sdds-clfd-auto';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-clfd-auto'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-clfd-auto'
