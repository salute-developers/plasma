...
import { LineSkeleton } from '@salutejs/sdds-clfd-auto';
...
```tsx live
import React from 'react';
import { RectSkeleton } from '@salutejs/sdds-clfd-auto';
...
```tsx live
import React from 'react';
import { TextSkeleton } from '@salutejs/sdds-clfd-auto';
...
```tsx live
import React from 'react';
import { Button, withSkeleton } from '@salutejs/sdds-clfd-auto';
