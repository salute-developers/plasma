...
import { NotificationsProvider } from '@salutejs/sdds-clfd-auto';
...
import { Button, ButtonGroup, addNotification, closeNotification, NotificationsProvider } from '@salutejs/sdds-clfd-auto';
