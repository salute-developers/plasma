...
import { Button, BodyL } from '@salutejs/sdds-clfd-auto';
...
import '@salutejs/plasma-themes/css/sdds_serv__dark.css';
...
import styles from '@salutejs/plasma-themes/css/sdds_serv.module.css';
...
import { Switch } from '@salutejs/sdds-clfd-auto';
import { sdds_serv__light, sdds_serv__dark } from '@salutejs/plasma-themes';
...
import { Switch } from '@salutejs/sdds-clfd-auto';
import webThemes from '@salutejs/plasma-themes/css/sdds_serv.module.css';
...
// @import '@salutejs/plasma-themes/css/sdds_serv.module.css';
import './style.css';
...
* Непосредственно из темы `@salutejs/plasma-themes/tokens/sdds_serv` - следует использовать, когда необходимо импортировать уникальные токены, которые лежат только в этой теме.
