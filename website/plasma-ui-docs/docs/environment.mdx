...
Кроме этого к устройствам можно подключиться с помощью приложения Сбер Салют и использовать его в качестве пульта.
Управление устройствами с помощью Сбер Салют возможно как голосовыми командами, так и жестами.
