...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-netology/` : '/sdds-netology/';
...
const config = {
    ...
    themeConfig: {
        ...
        typesense: {
            ...
            typesenseCollectionName: 'netology',
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-netology-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-netology'],
                            path: '',
                        },
                    },
                },
    ...
    plugins: [
            ...
            return {
                ...
                async loadContent() {
                    ...
                    return withCustomConfig(path.resolve(__dirname, 'tsconfig.json'), {
                        ...
                        await fg([
                            '../../packages/sdds-netology/src/**/*.{ts,tsx}',
                            '!../../packages/sdds-netology/src/**/*.test.*',
                        ]),
                    );
                },
        ...
        [
            'docusaurus-plugin-llms',
            {
                ...
                title: 'Библиотека компонентов SDDS NETOLOGY',
                description:
                    'React-компоненты дизайн-системы SDDS NETOLOGY для веб-приложений. Два варианта поставки: предсобранный CSS (по умолчанию) и styled-components.',
                version: pckgJson.dependencies['@salutejs/sdds-netology'],
