...
<Tabs>
    <TabItem value="default" label="Default" default>
        ...
        import { Autocomplete } from '@salutejs/sdds-netology';
    ...
    <TabItem value="infinite" label="Infinite Loading">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, Cell, Spinner } from '@salutejs/sdds-netology';
    ...
    <TabItem value="emptyState" label="Empty State">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, EmptyState, Spinner } from '@salutejs/sdds-netology';
    ...
    <TabItem value="renderItem" label="Render item">
        ...
        export function App() {
            ...
            return (
                <div style={{ display: 'block', height: "350px" }}>
                    <Autocomplete suggestions={items} threshold={0} label="Label" placeholder="Placeholder" />
                </div>
            );
        }
        ```
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        import { Autocomplete, BodyXS, Divider, TabItem, Tabs } from '@salutejs/sdds-netology';
