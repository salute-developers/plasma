...
import { Attach } from '@salutejs/sdds-netology';
...
<Tabs>
    <TabItem value="native" label="Нативная форма" default>
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button } from '@salutejs/sdds-netology';
    ...
    <TabItem value="complex" label="Сложный пример">
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button, InformationWrapper, outlineSolidPrimary } from '@salutejs/sdds-netology';
