...
title: Drawer
description: "Панель поверх контента, выезжающая с любой стороны экрана."
---
...
import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupProvider } from  '@salutejs/sdds-netology';
