...
import { ToastProvider } from '@salutejs/sdds-netology';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-netology'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-netology'
...
import { useToast, ToastProvider, Button } from '@salutejs/sdds-netology'
