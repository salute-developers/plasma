...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-netology';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-netology';
...
import { NotificationsProvider } from '@salutejs/sdds-netology';
