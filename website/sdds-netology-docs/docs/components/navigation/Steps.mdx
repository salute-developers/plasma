...
import { Steps } from '@salutejs/sdds-netology';
...
```tsx live
import React, { useState } from 'react';
import { Steps, StepItemProps } from '@salutejs/sdds-netology';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Button } from '@salutejs/sdds-netology';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Accordion, AccordionItem } from '@salutejs/sdds-netology';
