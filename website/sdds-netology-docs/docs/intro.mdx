...
id: intro
title: Введение
description: "Библиотека компонентов SDDS NETOLOGY: установка, варианты поставки, подключение шрифтов и темы, использование компонентов и токенов."
sidebar_position: 1
slug: /
---
...
:::tip
Путь `@salutejs/plasma-themes/tokens/plasma_b2c` следует использовать, когда нужны токены, которые есть только в этой теме.
:::
