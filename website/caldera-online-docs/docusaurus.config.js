...
const defaultUrl = PREFIX ? `/${PREFIX}/caldera-online/` : '/caldera-online/';
const baseUrl = VERSION_NAME ? `/versions/${VERSION_NAME}/` : defaultUrl;

/** @type {import('@docusaurus/types').DocusaurusConfig} */
const config = {
    title: 'caldera-online',
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/caldera-online-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/caldera-online'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    return withCustomConfig('./tsconfig.json', {
                        ...
                        await fg([
                            '../../packages/caldera-online/src/**/*.{ts,tsx}',
                            '!../../packages/caldera-online/src/**/*.test.*',
                        ]),
                    );
                },
