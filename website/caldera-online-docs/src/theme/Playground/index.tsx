...
import { caldera_online__dark, caldera_online__light } from '@salutejs/caldera-online-themes';
...
const LightTheme = createGlobalStyle(caldera_online__light);
const DarkTheme = createGlobalStyle(caldera_online__dark);
