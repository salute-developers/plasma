...
import { surfaceSolidSecondary } from '@salutejs/caldera-online-themes/tokens';
import { SSRProvider, Button, Modal, PopupProvider } from '@salutejs/caldera-online';
...
import { Modal } from '@salutejs/caldera-online';
