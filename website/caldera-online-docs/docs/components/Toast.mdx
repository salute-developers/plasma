...
import { ToastProvider } from '@salutejs/caldera-online';
...
import React from 'react'
import { useToast, Button } from '@salutejs/caldera-online'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button } from '@salutejs/caldera-online'
