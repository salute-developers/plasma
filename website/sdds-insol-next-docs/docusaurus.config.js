...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-insol-next/` : '/sdds-insol-next/';
...
module.exports = {
    ...
    themeConfig: {
        ...
        typesense: {
            ...
            typesenseCollectionName: 'insol-next',
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-insol-next-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-insol-next'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    return docgen
                        ...
                        .parse(
                            await fg([
                                '../../packages/sdds-insol-next/src/**/*.{ts,tsx}',
                                '!../../packages/sdds-insol-next/src/**/*.test.*',
                            ]),
                        );
                },
