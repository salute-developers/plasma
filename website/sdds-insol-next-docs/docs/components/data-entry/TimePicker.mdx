...
title: TimePicker
description: "Выбор значения времени."
---
...
import { TimePicker } from '@salutejs/sdds-insol-next';
        ...
        export function App() {
            return (
                <div style={{ display: "flex", flexDirection: "column", gap: "32px"}}>
                    <TimePicker view="default" size="xl" placeholder="Очень большой размер" />
...
`hasTimeFormat` влияет только на отображение. Свойства `value`, `min`, `max`,
`disabledValues` и значение в `onChange` по-прежнему используют 24-часовую нотацию.
