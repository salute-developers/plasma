...
Он реализован на компоненте [TextField](https://plasma.sberdevices.ru/sdds-insol-next/components/textfield/)
...
import { NumberFormat } from '@salutejs/sdds-insol-next';
