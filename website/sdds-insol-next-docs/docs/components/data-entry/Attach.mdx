...
import { Attach } from '@salutejs/sdds-insol-next';
...
<Tabs>
    <TabItem value="native" label="Нативная форма" default>
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button } from '@salutejs/sdds-insol-next';
    ...
    <TabItem value="complex" label="Сложный пример">
        ```tsx live
        import React, { useState } from 'react';
        import { Attach, Button, InformationWrapper, outlineSolidPrimary } from '@salutejs/sdds-insol-next';
