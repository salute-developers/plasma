...
<Tabs>
    <TabItem value="default" label="Default" default>
        ...
        import { Button, Dropdown } from '@salutejs/sdds-insol-next';
    ...
    <TabItem value="size" label="Size">
        ...
        Возможные значения свойства: `"xl"`, `"l"`, `"m"`, `"s"` или `"xs"`.
    ...
    <TabItem value="portal" label="Portal">
        ...
        import { Dropdown } from '@salutejs/sdds-insol-next';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        import { BodyXS, Button, Divider, Dropdown, TabItem, Tabs } from '@salutejs/sdds-insol-next';
