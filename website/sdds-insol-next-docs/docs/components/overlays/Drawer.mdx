...
import { PopupProvider } from '@salutejs/sdds-insol-next';
...
<Tabs>
    <TabItem value="styled" label="styled-components" default>
        ...
        import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupProvider } from  '@salutejs/sdds-insol-next';
