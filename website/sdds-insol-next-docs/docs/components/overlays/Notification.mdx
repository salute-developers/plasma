...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-insol-next';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-insol-next';
...
import { NotificationsProvider } from '@salutejs/sdds-insol-next';
