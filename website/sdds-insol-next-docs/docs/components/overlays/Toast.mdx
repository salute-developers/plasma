...
import { ToastProvider } from '@salutejs/sdds-insol-next';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-insol-next'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-insol-next'
