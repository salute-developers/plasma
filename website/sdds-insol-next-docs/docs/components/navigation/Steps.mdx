...
title: Steps
description: "Отображение последовательности шагов процесса."
---
...
import { Steps } from '@salutejs/sdds-insol-next';
...
```tsx live
import React, { useState } from 'react';
import { Steps, StepItemProps } from '@salutejs/sdds-insol-next';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Button } from '@salutejs/sdds-insol-next';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Accordion, AccordionItem } from '@salutejs/sdds-insol-next';
