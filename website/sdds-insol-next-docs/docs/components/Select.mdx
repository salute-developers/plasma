...
<Tabs>
    <TabItem value="textfield" label="Textfield" default>
        ...
        import { Select } from '@salutejs/sdds-insol-next';
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Button } from '@salutejs/sdds-insol-next';
    ...
    <TabItem value="renderItem" label="Render item">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Cell } from '@salutejs/sdds-insol-next';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { BodyXS, Divider, LinkButton, Select, TabItem, Tabs } from '@salutejs/sdds-insol-next';
...
```tsx live
import React, { useState } from 'react';
import { Select, TextField } from '@salutejs/sdds-insol-next';
