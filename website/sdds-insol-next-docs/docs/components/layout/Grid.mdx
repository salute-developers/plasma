...
title: Grid
description: "Адаптивная колоночная сетка."
---
...
Каждый breakpoint разрешения содержит собственное максимальное количество колонок:
...
import { Grid, Row, Col } from '@salutejs/sdds-insol-next';
