...
id: intro
title: Введение
description: "Библиотека компонентов SDDS INSOL NEXT: установка, варианты поставки, подключение шрифтов и темы, использование компонентов и токенов."
sidebar_position: 1
slug: /
---
...
Beta-компоненты доступны из точки входа `@salutejs/sdds-insol-next/beta`. Подробнее — в разделе [Beta](./beta/EmbeddedButton.mdx).
...
:::tip
Путь `@salutejs/sdds-themes/tokens/sdds_insol_next` следует использовать, когда нужны токены, которые есть только в этой теме.
:::
