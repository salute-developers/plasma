...
# Библиотека компонентов SDDS Insol (Редизайн)
...
Для использования типографической системы необходимо загрузить три `css` файла в зависимости от [используемых шрифтов](##Конфигурация-пакета) в теме.
...
import '@salutejs/sdds-themes/css/sdds_insol_next__dark.css';
...
```sass
@use '@salutejs/sdds-themes/css/sdds_insol_next__dark.css'
```
...
```sass
@use '@salutejs/sdds-themes/css/sdds_insol_next.module.css'
```
...
import { Switch } from '@salutejs/sdds-insol-next';
...
import { Switch } from '@salutejs/sdds-insol-next';
import webThemes from '@salutejs/sdds-themes/css/sdds_insol_next.module.css';
...
// @import '@salutejs/sdds-themes/css/sdds_insol_next.module.css';
import './style.css';
