...
import { Button, TextField, TextArea, Checkbox, Switch, Radiobox, RadioGroup, Slider, DatePicker, DatePickerRange, Autocomplete } from "@salutejs/sdds-insol-next";
...
import React from "react";
import { Button, DatePicker } from "@salutejs/sdds-insol-next";
