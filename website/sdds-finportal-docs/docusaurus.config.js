...
const defaultUrl = PREFIX ? `/${PREFIX}/sdds-finportal/` : '/sdds-finportal/';
        ...
        [
            '@docusaurus/preset-classic',
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/salute-developers/plasma/blob/master/website/sdds-finportal-docs/',
                    versions: {
                        current: {
                            label: pckgJson.dependencies['@salutejs/sdds-finportal'],
                            path: '',
                        },
                    },
                },
            ...
            return {
                ...
                async loadContent() {
                    ...
                    return withCustomConfig('./tsconfig.json', {
                        ...
                        await fg([
                            '../../packages/sdds-finportal/src/**/*.{ts,tsx}',
                            '!../../packages/sdds-finportal/src/**/*.test.*',
                        ]),
                    );
                },
