...
import { Tabs, TabItem } from '@salutejs/sdds-finportal';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, Button } from '@salutejs/sdds-finportal';
import { IconClock } from '@salutejs/plasma-icons';
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, Dropdown } from '@salutejs/sdds-finportal';
