...
import { DatePicker } from '@salutejs/sdds-finportal';
...
```tsx live
import React from 'react';
import { DatePickerRange, IconButton } from '@salutejs/sdds-finportal';
import { IconDone } from '@salutejs/plasma-icons';
...
```tsx live
import React from 'react';
import { DatePicker, IconButton } from '@salutejs/sdds-finportal';
import { IconDone } from '@salutejs/plasma-icons';
