...
import { ToastProvider } from '@salutejs/sdds-finportal';
...
import React from 'react'
import { useToast, Button } from '@salutejs/sdds-finportal'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/sdds-finportal'
...
import { useToast, ToastProvider, Button } from '@salutejs/sdds-finportal'
