...
import { Avatar, Cell } from '@salutejs/sdds-finportal';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/sdds-finportal';
import { IconChevronRight } from '@salutejs/plasma-icons';
