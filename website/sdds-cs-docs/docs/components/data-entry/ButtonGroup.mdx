...
import { ButtonGroup, Button } from '@salutejs/sdds-cs';
    ...
    return (
        <div>
            ...
            <ButtonGroup isCommonButtonStyles={false}>
                <Button size="s" text="Clear" view="clear" />
                <Button size="s" text="Accent" view="accent" />
            </ButtonGroup>
        </div>
    );
}
...
export function App() {
    return (
        <div>
            <ButtonGroup size="s" orientation="vertical" gap="none">
                {Array(5)
                    .fill(true)
                    .map((_, i) => (
                        <Button text={`Button ${i}`} />
            ...
            <ButtonGroup size="s" orientation="horizontal" gap="wide">
                {Array(4)
                    .fill(true)
                    .map((_, i) => (
                        <Button text={`Button ${i}`} />
...
export function App() {
    return (
        <div>
            <ButtonGroup size="s" shape="segmented">
                {Array(3)
                    .fill(true)
                    .map((_, i) => (
                        <Button text={`Button ${i}`} />
            ...
            <ButtonGroup size="s" shape="default">
                {Array(3)
                    .fill(true)
                    .map((_, i) => (
                        <Button text={`Button ${i}`} />
