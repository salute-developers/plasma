...
```tsx live
import React from 'react';
import { DatePicker, IconButton } from '@salutejs/sdds-cs';
import { IconDone } from '@salutejs/plasma-icons';
...
<Tabs>
    ...
    <TabItem value="controlled" label="Controlled">
        ```tsx live
        import React, {useState} from 'react';
        import { DatePickerRange } from '@salutejs/sdds-cs';
        import { IconDone } from '@salutejs/plasma-icons';
...
#### Позиционирование одиночного календаря
