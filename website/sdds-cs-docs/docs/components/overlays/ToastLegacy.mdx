---
id: toast-legacy
slug: /components/toast-legacy
title: Toast (Legacy)
description: "Устаревшая версия всплывающего уведомления (toast), сохранена для обратной совместимости."
---
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button } from '@salutejs/sdds-cs'
