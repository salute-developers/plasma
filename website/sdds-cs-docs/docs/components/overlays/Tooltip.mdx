...
title: Tooltip
description: "Подсказка у целевого элемента при наведении или другом событии."
---
...
Для изменение режима отображения компонента необходимо использовать компонент-обёртку [ViewContainer](../data-display/ViewContainer.mdx) с указанием нужного `view`.
