...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/sdds-cs';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/sdds-cs';
...
import { NotificationsProvider } from '@salutejs/sdds-cs';
