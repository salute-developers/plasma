...
export function App() {
    ...
    return (
        <div>
            <Tabs view="divider" orientation="vertical" size="s" style={{ width: '15rem' }}>
                {items.map((_, i) => (
                    <TabItem
                        view="divider"
...
```tsx live
import React, { useState } from 'react';
import { Tabs, TabItem, Button } from '@salutejs/sdds-cs';
import { IconClock } from '@salutejs/plasma-icons';
...
export function App() {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: "50px"}}>
            <div>
                <Tabs view="divider" stretch size="s" index={horizontalIndex}>
                    {items.map((_, i) => (
                        <TabItem
                            view="divider"
                            key={`item:${i}`}
            ...
            <div>
                <Tabs orientation="vertical" view="divider" size="s" index={verticalIndex}>
                    {items.map((_, i) => (
                        <TabItem
                            orientation="vertical"
                            view="divider"
