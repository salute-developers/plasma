...
export function App() {
    return (
        <div>
            <NumberInput value={5} width={140} view="default" />
        </div>
    );
}
```
...
export function App() {
    return (
        <div>
            <NumberInput value={5} width={140} view="default" shape="cornered" />
            <NumberInput value={5} width={140} view="default" shape="pilled" />
        </div>
    );
}
```
...
export function App() {
    return (
        <div>
            <NumberInput value={5} width={140} size="s" />
        </div>
    );
}
```
...
export function App() {
    return (
        <div>
            <NumberInput value={5} width={140} isLoading />
        </div>
    );
}
```
...
export function App() {
    return (
        <div>
            <NumberInput value={5} width={140} isManualInput />
        </div>
    );
}
```
