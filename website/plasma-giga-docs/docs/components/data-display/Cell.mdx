...
import { Avatar, Cell } from '@salutejs/plasma-giga';
...
```tsx live
import React from 'react';
import { Avatar, Cell , CellTextboxLabel , CellTextboxTitle , CellTextboxSubtitle, CellTextbox } from '@salutejs/plasma-giga';
import { IconChevronRight } from '@salutejs/plasma-icons';
