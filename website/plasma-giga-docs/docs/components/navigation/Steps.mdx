...
import { Steps } from '@salutejs/plasma-giga';
...
```tsx live
import React, { useState } from 'react';
import { Steps, StepItemProps } from '@salutejs/plasma-giga';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Button } from '@salutejs/plasma-giga';
...
```tsx live
import React, { useState } from 'react';
import { Steps, Accordion, AccordionItem } from '@salutejs/plasma-giga';
