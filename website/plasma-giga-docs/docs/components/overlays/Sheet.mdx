...
title: Sheet
description: "Шторка — панель, выезжающая снизу экрана поверх контента."
---
...
:::caution Устаревший компонент

Компонент `Sheet` устарел (deprecated). Для новых сценариев используйте `BottomSheet`.
:::
...
import { Sheet } from '@salutejs/plasma-giga';
