...
import { Button, ButtonGroup, NotificationsProvider, useNotifications } from '@salutejs/plasma-giga';
...
```tsx
import { addNotification, closeNotification } from '@salutejs/plasma-giga';
