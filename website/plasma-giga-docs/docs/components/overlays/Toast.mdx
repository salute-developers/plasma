...
import { ToastProvider } from '@salutejs/plasma-giga';
...
import React from 'react'
import { useToast, Button } from '@salutejs/plasma-giga'
...
```jsx live
import React from 'react'
import { useToast, ToastProvider, Button, ViewContainer } from '@salutejs/plasma-giga'
...
import { useToast, ToastProvider, Button } from '@salutejs/plasma-giga'
