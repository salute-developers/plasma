...
<Tabs>
    ...
    <TabItem value="infinite" label="Infinite Loading">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, Cell, Spinner } from '@salutejs/plasma-giga';
    ...
    <TabItem value="emptyState" label="Empty State">
        ...
        ```tsx live
        import React from 'react';
        import { Autocomplete, EmptyState, Spinner } from '@salutejs/plasma-giga';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        import { Autocomplete, BodyXS, Divider, TabItem, Tabs } from '@salutejs/plasma-giga';
