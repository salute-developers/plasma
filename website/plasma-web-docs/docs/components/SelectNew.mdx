...
<Tabs>
    <TabItem value="textfield" label="Textfield" default>
        ...
        import { SelectNew as Select } from '@salutejs/plasma-web';
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React from 'react';
        import { SelectNew as Select, Button } from '@salutejs/plasma-web';
    ...
    <TabItem value="renderItem" label="Render item">
        ...
        ```tsx live
        import React from 'react';
        import { SelectNew as Select, Cell } from '@salutejs/plasma-web';
