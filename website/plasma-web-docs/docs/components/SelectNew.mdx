...
<Tabs>
    <TabItem value="textfield" label="Textfield" default>
        ...
        import { SelectNew } from '@salutejs/plasma-web';
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React from 'react';
        import { SelectNew, Button } from '@salutejs/plasma-web';
    ...
    <TabItem value="renderItem" label="Render item">
        ...
        ```tsx live
        import React from 'react';
        import { SelectNew, Cell } from '@salutejs/plasma-web';

        export function App() {
            const [singleValue, setSingleValue] = useState('north_america');
            ...
            const renderTarget = (value) => {
                ...
                return (
                    <div style={{padding: '0.5rem 0'}}>
                        <Cell title={item && item.label} subtitle="Subtitle" label="Label" />
                    </div>
                )
            };

            const renderItem = (value, label) => <Cell title={label} label="Top left" contentRight={<Cell title="Bottom right" label="Top right" />} />;

            return (
                <div style={{ height: '300px' }}>
                    <div style={{width: '400px'}}>
                        <SelectNew items={items} value={singleValue} onChange={setSingleValue} renderTarget={renderTarget} renderItem={renderItem} />
                    </div>
                </div>
            );
        }
