---
id: indicator
slug: /components/indicator
title: Indicator
description: "Точечный индикатор состояния или новых событий."
---
...
import { Indicator } from '@salutejs/plasma-web';
