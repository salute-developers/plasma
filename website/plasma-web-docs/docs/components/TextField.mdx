...
Внешний вид компонента зависит от свойств `appearance`, `status`, `size`:
...
### Подсказки
Для вывода подсказки снизу от поля используйте свойство `helperText` - для подсказки слева, и `rightHelper` - для подсказки справа,
