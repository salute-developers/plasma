...
import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupBaseProvider } from  '@salutejs/plasma-web';
...
<Tabs>
    <TabItem value="styled" label="styled-components" default>
        ...
        import { H3, Button, Drawer, DrawerHeader, DrawerContent, DrawerFooter, PopupProvider } from  '@salutejs/plasma-web';
