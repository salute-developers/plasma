---
id: popupBase
slug: /components/popupBase
title: PopupBase
description: "Базовый компонент для позиционирования всплывающих элементов относительно якоря."
---
...
Поместите `PopupBaseProvider` в [корень приложения](../../#подключение-темы) или там, где будете применять PopupBase:
...
import { Button, PopupBase, PopupBaseProvider } from  '@salutejs/plasma-web';
