...
<Tabs>
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { Combobox, Button } from '@salutejs/plasma-web';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { BodyXS, Combobox, Divider, LinkButton, TabItem, Tabs } from '@salutejs/plasma-web';
