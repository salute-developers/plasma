...
description: "Устаревшая типографическая система Plasma Tokens, сохранённая для обратной совместимости."
sidebar_position: 6
---
...
Типографическая система представляет собой набор констант токенов и [компонентов](../../components/typography).
