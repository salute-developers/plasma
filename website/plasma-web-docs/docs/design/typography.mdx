...
id: typography
title: Типографика
description: "Типографическая система Plasma: токены, компоненты и подключение шрифтов."
sidebar_position: 2
---
...
Типографическая система представляет собой набор токенов и [компонентов](../../components/typography).
