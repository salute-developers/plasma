...
import { Tabs, TabItem, Button } from '@salutejs/plasma-web/css';
import { IconTrash, IconSaluteOutline } from '@salutejs/plasma-icons/css';
...
function SearchPageContent(): JSX.Element {
            ...
            ({
                ...
                const titles = [0, 1, 2, 3, 4, 5, 6]
                    .map((lvl) => {
                        ...
                        return highlightResult ? sanitizeValue(highlightResult.value) : '';
                    })
                    .filter((v) => v);
    ...
    const items = [
        { label: 'Стандартный поиск' },
        { label: <b>AI-поиск</b>, contentRight: <IconSaluteOutline size="s" color="inherit" /> },
    ];

    const [tabIndex, setTabIndex] = useState(0);

    const isDefaultSearch = tabIndex === 0;
    ...
    return (
        <Layout>
            ...
            <div className="container margin-vert--lg">
                ...
                >
                    <Tabs view="filled" size="l">
                        {items.map(({ label, contentRight }, i) => (
                            <TabItem
                                view="secondary"
                                key={`item:${i}`}
                                size="l"
