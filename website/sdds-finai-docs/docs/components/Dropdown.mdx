...
Чтобы окрасить отдельный элемент в негативный цвет, передайте ему CSS-класс `dropdown-item-negative` или же js-перемнную `dropdownClasses.dropdownItemNegative`:
