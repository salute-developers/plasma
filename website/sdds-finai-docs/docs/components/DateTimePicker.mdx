...
Свойство `use12Hours` включает 12-часовой формат: колонка часов показывает значения `12`, `01`–`11`,
...
`use12Hours` влияет только на отображение. `timeFormat` по-прежнему задаётся с `HH`, а `value`, `defaultDate`,
