...
title: Tree
description: "Отображение древовидной структуры с выбором элементов."
---
...
Для настройки асинхронной загрузки узлов дерева предусмотрены свойства: `loadData`, `onLoadData` и `isLeaf`.
Один из вариантов реализации этого механизма представлен ниже.
