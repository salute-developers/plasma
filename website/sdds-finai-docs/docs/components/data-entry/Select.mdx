...
`appearance="viewMode"` — режим просмотра.
...
<Tabs>
    ...
    <TabItem value="predefined" label="Predefined">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Button } from '@salutejs/sdds-finai';
    ...
    <TabItem value="renderItem" label="Render item">
        ...
        ```tsx live
        import React from 'react';
        import { Select, Cell } from '@salutejs/sdds-finai';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        ```tsx live
        import React, { useState } from 'react';
        import { BodyXS, Divider, LinkButton, Select, TabItem, Tabs } from '@salutejs/sdds-finai';
