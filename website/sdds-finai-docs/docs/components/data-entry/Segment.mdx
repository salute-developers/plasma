---
id: segment
slug: /components/segment
title: Segment
description: "Линейный набор из двух и более сегментов-переключателей."
---
...
<Tabs>
    <TabItem value="uncontrolled" label="Uncontrolled" default>
        ...
        import { SegmentGroup, SegmentItem, SegmentProvider, useSegment } from '@salutejs/sdds-finai';
...
<Tabs>
    ...
    <TabItem value="size" label="Size">
        ...
        Доступные размеры: `xs`, `s`.

        ```tsx live
        import React from 'react';
        import { SegmentGroup, SegmentItem, SegmentProvider } from '@salutejs/sdds-finai';
...
### Сегменты только с иконкой

Для отображения сегментов с только иконкой, необходимо использовать `SegmentIconItem`

```tsx live
import React from 'react';
import { IconPlasma } from '@salutejs/plasma-icons'
import { SegmentGroup, SegmentIconItem, SegmentProvider, useSegment } from '@salutejs/sdds-finai';
