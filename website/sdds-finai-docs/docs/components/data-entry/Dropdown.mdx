...
title: Dropdown
description: "Выпадающее многоуровневое меню со списком действий."
---
...
<Tabs>
    <TabItem value="default" label="Default" default>
        ...
        import { Button, Dropdown } from '@salutejs/sdds-finai';
    ...
    <TabItem value="item-color" label="Цвет элемента">
        Чтобы изменить цвет отдельного элемента, передайте ему `className` в массиве `items`.
        ...
        export function App() {
            ...
            return (
                <>
                    <style>{`
                        .dropdown-item-negative .cell-textbox-title {
    ...
    <TabItem value="size" label="Size">
        ...
        Возможные значения свойства:  `"m"`, `"s"` или `"xs"`.
    ...
    <TabItem value="portal" label="Portal">
        ...
        import { Dropdown } from '@salutejs/sdds-finai';
    ...
    <TabItem value="slots" label="beforeList / afterList">
        ...
        import { BodyXS, Button, Divider, Dropdown, TabItem, Tabs } from '@salutejs/sdds-finai';
                        ...
                        afterList={
                            <>
                                ...
                                <BodyXS style={{ padding: '0.5rem 0.75rem', color: 'var(--text-secondary)' }}>
                                    {`Направлений в разделе: ${region.items.length}`}
                                </BodyXS>
                            </>
                        }
                    >
                        <Button text={selected ? selected.label : 'Куда летим?'} />
                    </Dropdown>
                </div>
            );
        }
