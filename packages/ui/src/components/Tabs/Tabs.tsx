...
import { addFocus, applyDisabled } from '@salutejs/plasma-core/mixins';
import type { FocusProps, OutlinedProps, DisabledProps } from '@salutejs/plasma-core/mixins';
import { ShiftProps } from '@salutejs/plasma-core/types';
