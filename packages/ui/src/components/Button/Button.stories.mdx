...
<ArgsTable of={ActionButton} exclude={["blur", "view", "forwardedAs", "focused", "square", "outlined", "disabled", "shiftLeft", "shiftRight", "as", "square-square", "scaleOnInteraction", "scaleOnHover", "scaleOnPress"]} />
...
import { Button, ActionButton } from '@salutejs/ui';
