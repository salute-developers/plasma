...
import { Button as BaseButton } from '@salutejs/plasma-core/components/Button';
import type { ButtonProps as BaseProps, SizeProps, ViewProps } from '@salutejs/plasma-core/components/Button/Button';
