...
import { applyBlur, BlurProps } from '@salutejs/plasma-core/mixins';
...
```tsx
import styled from 'styled-components';
import { FocusProps, OutlinedProps, addFocus } from '@salutejs/plasma-core/mixins';
...
```tsx
import styled from 'styled-components';
import { BlurProps, applyBlur } from '@salutejs/plasma-core/mixins';
...
```tsx
import styled from 'styled-components';
import { DisabledProps, applyDisabled } from '@salutejs/plasma-core/mixins';
...
```tsx
import styled from 'styled-components';
import { InteractionProps, applyInteraction } from '@salutejs/ui/mixins';
...
```tsx
import styled from 'styled-components';
import { RoundnessProps, applyRoundness } from '@salutejs/plasma-core/mixins';
...
```tsx
import styled from 'styled-components';
import { ViewProps, applyView } from '@salutejs/plasma-core/mixins';
