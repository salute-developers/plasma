...
_NB_ — Все примеры будут приведены с использованием [styled-components](https://styled-components.com/). Но использовать `plasma-tokens-b2c` можно и без этого инструмента.

```sh
npm i --save @salutejs/plasma-tokens-b2c
```
...
import { text, background, gradient } from '@salutejs/plasma-tokens-b2c';
