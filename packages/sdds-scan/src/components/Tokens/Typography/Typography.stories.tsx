...
import { sdds_scan__dark, sdds_scan__light } from '@salutejs/sdds-themes';
import {
    InSpacingDecorator,
...
const themes: Record<string, TypographyStructure> = {
    'sdds-scan:light': getGroupedTypographyTokens(sdds_scan__light[0]),
    'sdds-scan:dark': getGroupedTypographyTokens(sdds_scan__dark[0]),
};
