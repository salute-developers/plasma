...
import { sdds_scan__dark, sdds_scan__light } from '@salutejs/sdds-themes/es/themes';
...
const themes: Record<string, GroupedNumberTokens> = {
    'sdds-scan:light': getGroupedCornerRadiusTokens(sdds_scan__light[0]),
    'sdds-scan:dark': getGroupedCornerRadiusTokens(sdds_scan__dark[0]),
};
