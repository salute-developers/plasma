    ...
    variations: {
        view: {
            default: css`
                ...
                ${buttonTokens.buttonValueColorHover}: var(--inverse-text-secondary-hover);
                ...
                ${buttonTokens.buttonValueColorActive}: var(--inverse-text-secondary-active);
            ...
            accent: css`
                ...
                ${buttonTokens.buttonValueColorHover}: var(--on-dark-text-secondary-hover);
                ...
                ${buttonTokens.buttonValueColorActive}: var(--on-dark-text-secondary-active);
            ...
            secondary: css`
                ...
                ${buttonTokens.buttonValueColorHover}: var(--text-secondary-hover);
                ...
                ${buttonTokens.buttonValueColorActive}: var(--text-secondary-active);
            ...
            white: css`
                ...
                ${buttonTokens.buttonValueColorHover}: var(--on-light-text-secondary-hover);
                ...
                ${buttonTokens.buttonValueColorActive}: var(--on-light-text-secondary-active);
