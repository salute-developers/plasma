    ...
    variations: {
        ...
        size: {
            l: css`
                ...
                ${badgeTokens.paddingTop}: 0.25rem;
                ${badgeTokens.paddingBottom}: 0.25rem;

                ${badgeTokens.paddingRight}: 0.75rem;
                ${badgeTokens.paddingLeft}: 0.75rem;
                ...
                ${badgeTokens.leftContentMarginLeft}: -0.25rem;
                ${badgeTokens.leftContentMarginRight}: 0.25rem;

                ${badgeTokens.rightContentMarginLeft}: 0.25rem;
                ${badgeTokens.rightContentMarginRight}: -0.25rem;
            `,
            m: css`
            ...
            s: css`
                ...
                ${badgeTokens.paddingTop}: 0.188rem;
                ${badgeTokens.paddingBottom}: 0.188rem;
