...
import { sdds_finportal__dark, sdds_finportal__light } from '@salutejs/sdds-themes/es/themes';
...
const themes: Record<string, GroupedNumberTokens> = {
    'sdds-finportal:light': getGroupedCornerRadiusTokens(sdds_finportal__light[0]),
    'sdds-finportal:dark': getGroupedCornerRadiusTokens(sdds_finportal__dark[0]),
};
