...
export const config = {
    ...
    variations: {
        ...
        hintView: {
            default: css`
                ${textAreaTokens.tooltipBackgroundColor}: var(--surface-solid-card);
                ${textAreaTokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${textAreaTokens.tooltipColor}: var(--text-primary);
            `,
            onDark: css`
                ${textAreaTokens.tooltipBackgroundColor}: var(--on-dark-surface-solid-card);
                ${textAreaTokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${textAreaTokens.tooltipColor}: var(--on-dark-text-primary);
            `,
            onLight: css`
                ${textAreaTokens.tooltipBackgroundColor}: var(--on-light-surface-solid-card);
                ${textAreaTokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${textAreaTokens.tooltipColor}: var(--on-light-text-primary);
            `,
            inverse: css`
                ${textAreaTokens.tooltipBackgroundColor}: var(--inverse-surface-solid-card);
                ${textAreaTokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${textAreaTokens.tooltipColor}: var(--inverse-text-primary);
            `,
        },
        hintSize: {
            m: css`
                ...
                /* stylelint-disable-next-line function-url-scheme-whitelist */
