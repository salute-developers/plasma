...
import { IconClose, IconMinus, IconPlus } from '@salutejs/plasma-icons';
import { secondary, white } from '@salutejs/plasma-tokens';
import { StepperButton, StepperRoot, StepperValue } from '@salutejs/plasma-ui';
