...
import { IconClose, IconMinus, IconPlus, IconProps } from '@salutejs/plasma-icons';
import { secondary, success, white } from '@salutejs/plasma-tokens';
import { StepperButton, StepperRoot, StepperValue, Price as PlasmaPrice } from '@salutejs/plasma-ui';
