...
import { accent as colorBrandSber } from  '@salutejs/plasma-tokens/themesValues/darkSber';
...
export const colorTextPrimary = primary;
...
export const colorLiquid01 = surfaceLiquid01;
export const colorLiquid02 = surfaceLiquid02;
