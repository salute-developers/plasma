...
import { withTheme, CALDERA_ONLINE_LIGHT_THEME, CALDERA_ONLINE_DARK_THEME } from './decoratorThemes';
...
const preview: Preview = {
    ...
    globalTypes: {
        theme: {
            ...
            defaultValue: CALDERA_ONLINE_LIGHT_THEME,
            toolbar: {
                title: 'Theme',
                items: [CALDERA_ONLINE_LIGHT_THEME, CALDERA_ONLINE_DARK_THEME],
            },
        },
        typoVersion: {
