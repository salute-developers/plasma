...
import { sdds_dfa__dark, sdds_dfa__light } from '@salutejs/plasma-themes/es/themes';
import {
    InSpacingDecorator,
...
const themes: Record<string, TypographyStructure> = {
    'sdds-dfa:light': getGroupedTypographyTokens(sdds_dfa__light[0]),
    'sdds-dfa:dark': getGroupedTypographyTokens(sdds_dfa__dark[0]),
};
