...
type HeaderProps = ComponentProps<typeof HeaderRoot> & CustomAssemblyProps & ContentComponentProps;
...
const StoryCustomAssembly = ({ variant, title, subtitle, label, gradientColor, ...rest }: HeaderProps) => {
...
export const CustomAssembly: StoryObj<HeaderProps> = {
    argTypes: {
        variant: {
