...
import { withTheme, SDDS_DFA_LIGHT_THEME, SDDS_DFA_DARK_THEME } from './decoratorThemes';
...
const preview: Preview = {
    ...
    globalTypes: {
        theme: {
            ...
            defaultValue: SDDS_DFA_LIGHT_THEME,
            toolbar: {
                title: 'Theme',
                items: [SDDS_DFA_LIGHT_THEME, SDDS_DFA_DARK_THEME],
            },
        },
        typoVersion: {
