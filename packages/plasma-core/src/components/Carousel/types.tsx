...
export interface CarouselLightProps extends AsProps, HTMLAttributes<HTMLDivElement> {
    /**
     * Индекс текущего элемента
     */
    index: number;
...
export type UseCarouselLightOptions = Pick<CarouselLightProps, 'index' | 'axis' | 'scrollAlign'>;
