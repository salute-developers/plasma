...
export const SDDS_SERV_LIGHT_THEME = 'light';
export const SDDS_SERV_DARK_THEME = 'dark';
export const DEFAULT_MODE = 'default';
export const ON_DARK_MODE = 'onDark';
export const ON_LIGHT_MODE = 'onLight';

const themes = {
    [SDDS_SERV_LIGHT_THEME]: createGlobalStyle(plasma_b2c__dark),
    [SDDS_SERV_DARK_THEME]: createGlobalStyle(plasma_b2c__light),
};
