...
export const config = {
    ...
    variations: {
        ...
        size: {
            ...
            `,
            s: css`
                ${listTokens.listItemPaddingTop}: 0.6875rem;
                ${listTokens.listItemPaddingLeft}: 0.75rem;
                ${listTokens.listItemPaddingRight}: 0.75rem;
                ${listTokens.listItemPaddingBottom}: 0.6875rem;
            ...
            `,
            m: css`
                ${listTokens.listItemPaddingTop}: 0.875rem;
                ${listTokens.listItemPaddingLeft}: 0.875rem;
                ${listTokens.listItemPaddingRight}: 0.875rem;
                ${listTokens.listItemPaddingBottom}: 0.875rem;
            ...
            `,
            l: css`
                ${listTokens.listItemPaddingTop}: 1.0625rem;
                ${listTokens.listItemPaddingLeft}: 1rem;
                ${listTokens.listItemPaddingRight}: 1rem;
                ${listTokens.listItemPaddingBottom}: 1.0625rem;
