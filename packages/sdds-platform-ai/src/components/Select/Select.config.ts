    ...
    variations: {
        view: {
            default: css`
                ...
                ${tokens.textFieldChipBackgroundHover}: ${surfaceTransparentCardHover};
                ...
                ${tokens.checkboxIconColor}: ${inverseTextPrimary};
        ...
        chipView: {
            ...
            accent: css`
                ...
                ${tokens.textFieldChipCloseIconColor}: ${textPrimary};
                ${tokens.textFieldChipCloseIconColorReadonly}: ${textPrimary};
                ${tokens.textFieldChipCloseIconColorHover}: ${textPrimaryHover};
