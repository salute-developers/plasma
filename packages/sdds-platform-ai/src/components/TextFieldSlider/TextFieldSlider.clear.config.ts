    ...
    variations: {
        view: {
            ...
            positive: css`
                ...
                ${tokens.textFieldContentSlotColor}: var(--text-positive);
                ${tokens.textFieldContentSlotColorHover}: var(--text-positive-hover);
                ${tokens.textFieldContentSlotColorActive}: var(--text-positive-active);
                ...
                ${tokens.scaleValueColor}: var(--text-positive);
            `,
            warning: css`
                ${tokens.textFieldColor}: var(--text-primary);
                ${tokens.textFieldPlaceholderColor}: var(--text-secondary);
            ...
            negative: css`
                ...
                ${tokens.scaleValueColor}: var(--text-negative);
            `,
        },
        sliderView: {
            default: css`
