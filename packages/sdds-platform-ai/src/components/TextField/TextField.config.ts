    ...
    variations: {
        ...
        chipView: {
            ...
            accent: css`
                ...
                ${tokens.chipCloseIconColor}: ${textPrimary};
                ${tokens.chipCloseIconColorReadonly}: ${textPrimary};
                ${tokens.chipCloseIconColorHover}: ${textPrimaryHover};
                ${tokens.chipOpacityReadonly}: 1;
            `,
            positive: css`
        ...
        readOnly: {
            true: css`
                ...
                ${tokens.borderColorReadOnly}: ${outlineTransparentPrimary};
            `,
        },
    },
};
