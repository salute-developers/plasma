...
const themes: Record<string, GroupedNumberTokens> = {
    'sdds-platform-ai:light': getGroupedCornerRadiusTokens(sdds_platform_ai__light[0]),
    'sdds-platform-ai:dark': getGroupedCornerRadiusTokens(sdds_platform_ai__dark[0]),
};
