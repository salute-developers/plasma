        ...
        mount(
            <CypressTestDecorator>
                <Note
                    ...
                    width={400}
                    stretch
                    contentBefore={<IconSaluteOutline size={getIconSize('m')} color="inherit" />}
                />
            </CypressTestDecorator>,
        );
        cy.matchImageSnapshot();
        ...
        mount(
            <CypressTestDecorator>
                <Note
                    ...
                    stretch={false}
                    hasClose={false}
                    contentBefore={<IconSaluteOutline size={getIconSize('xs')} color="inherit" />}
                />
            </CypressTestDecorator>,
        );
        cy.matchImageSnapshot();
        ...
        mount(
            <CypressTestDecorator>
                <Note
                    ...
                    contentBefore={<IconSaluteOutline size={getIconSize('l', true)} color="inherit" />}
                />
            </CypressTestDecorator>,
        );
        cy.matchImageSnapshot();
