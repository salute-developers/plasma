...
import { InformationWrapper as InformationWrapperGIGA } from '.';
...
describe('plasma-giga: InformationWrapper', () => {
    const InformationWrapper = getComponent('InformationWrapper') as FC<ComponentProps<typeof InformationWrapperGIGA>>;
