...
import { Button as ButtonGIGA } from '../Button';

import { DateTimePicker as DateTimePickerGIGA } from '.';

type DateTimePickerProps = ComponentProps<typeof DateTimePickerGIGA> & {
    enableContentLeft?: boolean;
    enableContentRight?: boolean;
};

describe('plasma-giga: DateTimePicker', () => {
    const DateTimePicker = getComponent('DateTimePicker') as typeof DateTimePickerGIGA;
    const Button = getComponent('Button') as typeof ButtonGIGA;
