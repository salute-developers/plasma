...
import { withTheme, CLASSROOMS_LIGHT_THEME, CLASSROOMS_DARK_THEME } from './decoratorThemes';
...
const preview: Preview = {
    ...
    globalTypes: {
        theme: {
            ...
            defaultValue: CLASSROOMS_LIGHT_THEME,
            toolbar: {
                title: 'Theme',
                items: [CLASSROOMS_LIGHT_THEME, CLASSROOMS_DARK_THEME],
            },
        },
        typoVersion: {
