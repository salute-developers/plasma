    ...
    variations: {
        ...
        view: {
            default: css`
                ...
                ${checkboxTokens.triggerBorderColor}: var(--plasma-colors-secondary);
            `,
            /**
             * @deprecated
            ...
            `,
            accent: css`
                ${checkboxTokens.fillColor}: var(--plasma-colors-accent);
                ${checkboxTokens.iconColor}: var(--plasma-colors-white);
                ${checkboxTokens.descriptionColor}: var(--text-secondary);
                ${checkboxTokens.triggerBackgroundColor}: transparent;
                ${checkboxTokens.triggerBorderColor}: var(--plasma-colors-secondary);
            `,
