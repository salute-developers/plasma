...
import { addFocus, applyRoundness, radiuses, syntheticFocus } from '@salutejs/plasma-core/mixins';
import type { FocusProps, OutlinedProps, RoundnessProps } from '@salutejs/plasma-core/mixins';
