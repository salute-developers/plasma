...
export default {
    title: 'Controls/CarouselVirtualDeprecated',
} as Meta;

export const Basic: Story<CarouselVirtualProps & CarouselVirtualProps & { displayGrid: boolean }> = ({
    scrollSnapType,
    scrollSnapAlign,
}) => {
    const axis = 'x';
...
export const Vertical: Story<CarouselVirtualProps & CarouselVirtualProps & { displayGrid: boolean }> = ({
    scrollAlign,
    scrollSnapType,
    scrollSnapAlign,
    detectActive,
