...
export interface TimePickerProps
    ...
    min?: Date;
    /**
     * Допустимая разница между максимальной и минимальной датами,
     * при которой не вызывается предупреждение о генерации массивов часов, минут и секунд
     */
    maxDateDayDiff?: number;
    /**
