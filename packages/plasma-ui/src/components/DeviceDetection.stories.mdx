import { Meta, Description, ArgsTable } from '@storybook/addon-docs';

import { DeviceThemeProvider } from './Device/DeviceDetection';
...
import { detectDevice } from '@salutejs/plasma-ui/utils'; // Стандартная функция определения поверхности на основе `userAgent`
