declare const ButtonComponent: import('react').FunctionComponent<
 ...
 * Кнопка.
 */
export declare const Button: import('@salutejs/plasma-new-hope/styled-components').MakePolymorphic<
