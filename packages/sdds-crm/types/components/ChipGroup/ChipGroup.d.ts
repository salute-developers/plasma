export declare const ChipGroup: import('react').FunctionComponent<
    import('@salutejs/plasma-new-hope/types/engines/types.js').PropsType<{
        ...
        import('@salutejs/plasma-new-hope/types/components/ChipGroup/ChipGroup.types.js').ChipGroupProps &
