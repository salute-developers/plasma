    ...
    variations: {
        view: {
            ...
            edited: css`
                ...
                ${tokens.textFieldDividerColor}: ${outlineTransparentInfo};
                ${tokens.textFieldDividerColorHover}: ${outlineTransparentInfo};
                ${tokens.textFieldDividerColorFocus}: ${outlineTransparentInfoActive};
