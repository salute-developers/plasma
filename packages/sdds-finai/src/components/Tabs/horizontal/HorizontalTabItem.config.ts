    ...
    variations: {
        ...
        size: {
            ...
            h6: css`
                ...
                ${tabsTokens.fontWeight}: ${h6Bold.fontWeight};
            ...
            h5: css`
                ...
                ${tabsTokens.fontWeight}: ${h5Bold.fontWeight};
            ...
            h4: css`
                ...
                ${tabsTokens.fontWeight}: ${h4Bold.fontWeight};
            ...
            h3: css`
                ...
                ${tabsTokens.fontWeight}: ${h3Bold.fontWeight};
            ...
            h2: css`
                ...
                ${tabsTokens.fontWeight}: ${h2Bold.fontWeight};
            ...
            h1: css`
                ...
                ${tabsTokens.fontWeight}: ${h1Bold.fontWeight};
