...
import { bodyS, bodyXS } from '@salutejs/sdds-themes/tokens/sdds_finai';
    ...
    variations: {
        size: {
            s: css`
                ...
                ${tokens.leftContentMargin}: -0.1875rem 0.25rem -0.1875rem -0.25rem;
                ${tokens.rightContentMargin}: -0.1875rem -0.25rem -0.1875rem 0.75rem;
