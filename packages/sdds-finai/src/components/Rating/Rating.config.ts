...
export const config = {
    ...
    variations: {
        view: {
            default: css`
                ${tokens.color}: var(--text-primary, #f2f5f8f5);
                ${tokens.helperTextColor}: var(--text-secondary, #d5dfe69e);
                ${tokens.iconColor}: var(--text-primary, #f2f5f8f5);
                ${tokens.outlineIconColor}: var(--text-primary, #f2f5f8f5);
            `,
            accent: css`
                ${tokens.color}: var(--text-primary, #f2f5f8f5);
                ${tokens.helperTextColor}: var(--text-secondary, #d5dfe69e);
                ...
                ${tokens.outlineIconColor}: var(--text-tertiary, #d5dfe64d);
            `,
        },
        size: {
            l: css`
