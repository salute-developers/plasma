    ...
    variations: {
        ...
        view: {
            ...
            positive: css`
                ...
                ${textAreaTokens.backgroundColorFocus}: var(--surface-transparent-positive);
                ...
                ${textAreaTokens.borderColorFocus}: var(--outline-transparent-positive-active);
                ${textAreaTokens.inputColor}: var(--text-primary);
            ...
            primary: css`
                ...
                ${textAreaTokens.backgroundColorFocus}: var(--surface-transparent-secondary);
                ${textAreaTokens.borderColor}: var(--outline-solid-primary);
                ${textAreaTokens.borderColorHover}: var(--outline-solid-primary-hover);
                ${textAreaTokens.borderColorFocus}: var(--outline-accent);
                ${textAreaTokens.inputColor}: var(--text-primary);
            ...
            warning: css`
                ...
                ${textAreaTokens.backgroundColorFocus}: var(--surface-transparent-warning);
                ...
                ${textAreaTokens.borderColorFocus}: var(--outline-transparent-warning-active);
                ${textAreaTokens.inputColor}: var(--text-primary);
            ...
            negative: css`
                ...
                ${textAreaTokens.backgroundColorFocus}: var(--surface-transparent-negative);
                ...
                ${textAreaTokens.borderColorFocus}: var(--outline-transparent-negative-active);
                ${textAreaTokens.inputColor}: var(--text-primary);
