...
import { EmbeddedButton as CoreEmbeddedButton } from '@salutejs/plasma-new-hope/beta';
import type { EmbeddedButtonProps as CoreEmbeddedButtonProps } from '@salutejs/plasma-new-hope/beta';
...
export type EmbeddedButtonProps = CoreEmbeddedButtonProps & {
