...
- Update package-lock.json files ([@Salute-Eva](https://github.com/Salute-Eva))
- Update versions ([@Salute-Eva](https://github.com/Salute-Eva))
- chore: delete unnecessary caldera themes [no ci] ([@Yakutoc](https://github.com/Yakutoc))
...
- chore(caldera-online-themes): delete unnecessary package "Caldera" ([@Yakutoc](https://github.com/Yakutoc))
...
- feat(caldera-online-themes): Add theme package for `Caldera Online` design vertical ([@neretin-trike](https://github.com/neretin-trike))
