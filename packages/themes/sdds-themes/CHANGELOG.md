...
- fix(sdds-themes): Update `sdds_insol` theme ([@neretin-trike](https://github.com/neretin-trike))
...
- ci: Setup infrastructure for `sdds-insol` ([@neretin-trike](https://github.com/neretin-trike))
- Update package-lock.json files ([@Salute-Eva](https://github.com/Salute-Eva))
- Update versions ([@Salute-Eva](https://github.com/Salute-Eva))
- chore(sdds-themes): Rename theme sdds_insurance to sdds_insol \[skip ci\] ([@Yakutoc](https://github.com/Yakutoc))
