...
:root {
  ...
  --surface-transparent-card-hover: #FFFFFF85;
  --surface-transparent-card-active: #FFFFFFA3;
  ...
  --on-light-surface-transparent-card-hover: #FFFFFF85;
  --on-light-surface-transparent-card-active: #FFFFFFA3;
...
:root {
  ...
  --surface-accent-gradient-hover: linear-gradient(45deg, #18CD18FF 0%, #04D9DCFF 100%);
  --surface-accent-gradient-active: linear-gradient(45deg, #139F13FF 0%, #04B1B4FF 100%);
  ...
  --on-dark-surface-accent-gradient-hover: linear-gradient(45deg, #17C417FF 0%, #04D9DCFF 100%);
  --on-dark-surface-accent-gradient-active: linear-gradient(45deg, #14A914FF 0%, #04BBBEFF 100%);
  ...
  --on-light-surface-accent-gradient-hover: linear-gradient(45deg, #18CD18FF 0%, #04D9DCFF 100%);
  --on-light-surface-accent-gradient-active: linear-gradient(45deg, #139F13FF 0%, #04B1B4FF 100%);
