...
:root {
  ...
  --surface-transparent-primary: #060A0C08;
  ...
  --on-light-surface-transparent-primary: #060A0C08;
...
:root {
  ...
  --surface-accent-gradient: linear-gradient(45deg, #15B015FF 0%, #04C6C9FF 100%);
  ...
  --on-dark-surface-accent-gradient: linear-gradient(45deg, #15B015FF 0%, #04C6C9FF 100%);
  ...
  --on-light-surface-accent-gradient: linear-gradient(45deg, #15B015FF 0%, #04C6C9FF 100%);
  ...
  --inverse-surface-accent-gradient: linear-gradient(45deg, #15B015FF 0%, #04C6C9FF 100%);
...
@media (max-width: 767px) {
  :root {
    ...
    --plasma-typo-dspl-m-font-size: 3rem;
    --plasma-typo-dspl-m-font-weight: 300;
    --plasma-typo-dspl-m-line-height: 3.375rem;
    --plasma-typo-dspl-m-bold-font-size: 3rem;
    --plasma-typo-dspl-m-bold-font-weight: 600;
    --plasma-typo-dspl-m-bold-line-height: 3.375rem;
...
@media (min-width: 768px) and (max-width: 1023px) {
  :root {
    ...
    --plasma-typo-h2-font-weight: 400;
    --plasma-typo-h2-line-height: 2.5rem;
    --plasma-typo-h2-bold-font-size: 2rem;
    --plasma-typo-h2-bold-font-weight: 600;
    --plasma-typo-h2-bold-line-height: 2.5rem;
    --plasma-typo-h3-font-size: 1.125rem;
    --plasma-typo-h3-font-weight: 400;
    --plasma-typo-h3-line-height: 1.625rem;
    --plasma-typo-h3-bold-font-size: 1.125rem;
