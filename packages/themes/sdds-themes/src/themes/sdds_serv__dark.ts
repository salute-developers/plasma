...
:root {
  ...
  --syntax-yellow-hover: #F7C45FFF;
  --syntax-yellow-active: #DA950BFF;
  --syntax-orange: #FFB38A;
  --syntax-orange-hover: #FFE8DBFF;
  --syntax-orange-active: #FF9F6BFF;
  --syntax-pink: #FF4791;
  --syntax-pink-hover: #FF99C2FF;
  --syntax-pink-active: #FF297EFF;
  --syntax-spring: #C5FC5F;
  --syntax-spring-hover: #E2FDAFFF;
  --syntax-spring-active: #BAFB41FF;
  --syntax-sky-blue: #8AE6FF;
  --syntax-sky-blue-hover: #DBF7FFFF;
  --syntax-sky-blue-active: #6BDFFFFF;
  --syntax-red: #FF8F9A;
  --syntax-red-hover: #FFE0E3FF;
  --syntax-red-active: #FF707EFF;
  ...
  --inverse-syntax-yellow-hover: #F8CB72FF;
  --inverse-syntax-yellow-active: #DA950BFF;
  --inverse-syntax-orange: #85380C;
  --inverse-syntax-orange-hover: #B14B10FF;
  --inverse-syntax-orange-active: #5D2809FF;
  --inverse-syntax-pink: #9B0D46;
  --inverse-syntax-pink-hover: #CB105BFF;
  --inverse-syntax-pink-active: #760A35FF;
  --inverse-syntax-spring: #629405;
  --inverse-syntax-spring-hover: #82C507FF;
  --inverse-syntax-spring-active: #486C04FF;
  --inverse-syntax-sky-blue: #0492B9;
  --inverse-syntax-sky-blue-hover: #05B9EBFF;
  --inverse-syntax-sky-blue-active: #037291FF;
  --inverse-syntax-red: #FF3D51;
  --inverse-syntax-red-hover: #FF8F9AFF;
  --inverse-syntax-red-active: #FF142CFF;
