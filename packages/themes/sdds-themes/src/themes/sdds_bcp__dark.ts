...
:root {
  ...
  --text-accent: #7B5CF5FF;
  --text-accent-minor: #2F1E77FF;
  ...
  --inverse-text-accent: #4B32B8FF;
  --inverse-text-accent-minor: #967AFFFF;
  ...
  --inverse-surface-accent-minor: #DAD0FFFF;
  ...
  --outline-accent: #7B5CF5FF;
  --outline-accent-minor: #2F1E77FF;
  ...
  --inverse-outline-accent: #4B32B8FF;
  --inverse-outline-accent-minor: #967AFFFF;
