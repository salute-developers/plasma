...
:root {
  ...
  --on-dark-outline-info-hover: #2AA0EFFF;
  --on-dark-outline-info-active: #0E75B9FF;
  ...
  --on-light-outline-info-hover: #0E8ADDFF;
  ...
  --inverse-outline-info-hover: #2AA0EFFF;
  --inverse-outline-info-active: #0E75B9FF;
