...
:root {
  ...
  --inverse-surface-transparent-card-hover: #FFFFFF85;
  --inverse-surface-transparent-card-active: #FFFFFFA3;
  ...
  --outline-solid-secondary-active: #828E97FF;
  --outline-solid-tertiary: #7B868E;
  --outline-solid-tertiary-hover: #FFFFFFFF;
  --outline-solid-tertiary-active: #596269FF;
  --outline-solid-default: #F7F9FB;
  --outline-solid-default-hover: #D0DBE7FF;
  --outline-solid-default-active: #E4EBF1FF;
  --outline-transparent-primary-hover: #F2F5F8FF;
  --outline-transparent-primary-active: #F2F5F825;
  --outline-transparent-secondary-hover: #F2F5F8FF;
  --outline-transparent-secondary-active: #F2F5F856;
  --outline-transparent-tertiary-hover: #F2F5F8FF;
  --outline-transparent-tertiary-active: #F2F5F8AB;
  ...
  --on-dark-outline-solid-secondary-active: #828E97FF;
  --on-dark-outline-solid-tertiary: #7B868E;
  --on-dark-outline-solid-tertiary-hover: #FFFFFFFF;
  --on-dark-outline-solid-tertiary-active: #596269FF;
...
:root {
  ...
  --surface-accent-gradient-hover: linear-gradient(45deg, #17C417FF 0%, #04D9DCFF 100%);
  --surface-accent-gradient-active: linear-gradient(45deg, #14A914FF 0%, #04BBBEFF 100%);
  ...
  --inverse-surface-accent-gradient-hover: linear-gradient(45deg, #18CD18FF 0%, #04D9DCFF 100%);
  --inverse-surface-accent-gradient-active: linear-gradient(45deg, #139F13FF 0%, #04B1B4FF 100%);
