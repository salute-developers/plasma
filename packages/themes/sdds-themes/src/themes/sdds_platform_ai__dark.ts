...
:root {
  ...
  --inverse-surface-positive-minor: #E0F5E4FF;
  ...
  --data-transparent-purple-extra-hover: #B558F352;
  --data-transparent-purple-extra-active: #B558F324;
  --data-transparent-purple-extra: #B559F333;
  --data-purple-extra-hover: #BA5FF7FF;
  --data-purple-extra-active: #A938F5FF;
  --data-purple-extra: #AD42F5;
  ...
  --inverse-data-transparent-purple-extra-hover: #B558F32E;
  --inverse-data-transparent-purple-extra-active: #B558F333;
  --inverse-data-transparent-purple-extra: #B559F31F;
  --inverse-data-purple-extra-hover: #7D2FB1FF;
  --inverse-data-purple-extra-active: #662791FF;
  --inverse-data-purple-extra: #722BA1;
...
:root {
  ...
  --text-accent-gradient: linear-gradient(45deg, #52F2C5FF 0%, #C5FC5FFF 100%);
  ...
  --inverse-text-accent-gradient: linear-gradient(45.00deg, #0D8523FF 0%, #0DA8ABFF 100%);
  --surface-accent-gradient-hover: #FFFFFFFF;
  --surface-accent-gradient-active: #FFFFFFFF;
  --surface-accent-gradient: linear-gradient(45deg, #52F2C5FF 0%, #C5FC5FFF 100%);
  ...
  --inverse-surface-accent-gradient: linear-gradient(45.00deg, #0D8523FF 0%, #0DA8ABFF 100%);
  ...
  --outline-accent-gradient: linear-gradient(45deg, #C5FC5FFF 0%, #04C6C9FF 100%);
