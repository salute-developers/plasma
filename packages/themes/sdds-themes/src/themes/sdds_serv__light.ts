...
:root {
  ...
  --syntax-yellow-hover: #F8CB72FF;
  --syntax-yellow-active: #DA950BFF;
  --syntax-orange-hover: #B14B10FF;
  --syntax-orange-active: #5D2809FF;
  --syntax-pink-hover: #CB105BFF;
  --syntax-pink-active: #760A35FF;
  --syntax-spring-hover: #82C507FF;
  --syntax-spring-active: #486C04FF;
  --syntax-sky-blue-hover: #05B9EBFF;
  --syntax-sky-blue-active: #037291FF;
  --syntax-red-hover: #FF8F9AFF;
  --syntax-red-active: #FF142CFF;
  ...
  --on-dark-syntax-yellow-hover: #F7C45FFF;
  --on-dark-syntax-yellow-active: #DA950BFF;
  --on-dark-syntax-orange: #FFB38A;
  --on-dark-syntax-orange-hover: #FFE8DBFF;
  --on-dark-syntax-orange-active: #FF9F6BFF;
  --on-dark-syntax-pink: #FF4791;
  --on-dark-syntax-pink-hover: #FF99C2FF;
  --on-dark-syntax-pink-active: #FF297EFF;
  --on-dark-syntax-spring: #C5FC5F;
  --on-dark-syntax-spring-hover: #E2FDAFFF;
  --on-dark-syntax-spring-active: #BAFB41FF;
  --on-dark-syntax-sky-blue: #8AE6FF;
  --on-dark-syntax-sky-blue-hover: #DBF7FFFF;
  --on-dark-syntax-sky-blue-active: #6BDFFFFF;
  --on-dark-syntax-red: #FF8F9A;
  --on-dark-syntax-red-hover: #FFE0E3FF;
  --on-dark-syntax-red-active: #FF707EFF;
  --on-light-syntax-yellow: #F3A912;
  --on-light-syntax-yellow-hover: #F8CB72FF;
  --on-light-syntax-yellow-active: #DA950BFF;
  --on-light-syntax-orange: #85380C;
  --on-light-syntax-orange-hover: #B14B10FF;
  --on-light-syntax-orange-active: #5D2809FF;
  --on-light-syntax-pink: #9B0D46;
  --on-light-syntax-pink-hover: #CB105BFF;
  --on-light-syntax-pink-active: #760A35FF;
  --on-light-syntax-spring: #629405;
  --on-light-syntax-spring-hover: #82C507FF;
  --on-light-syntax-spring-active: #486C04FF;
  --on-light-syntax-sky-blue: #0492B9;
  --on-light-syntax-sky-blue-hover: #05B9EBFF;
  --on-light-syntax-sky-blue-active: #037291FF;
  --on-light-syntax-red: #FF3D51;
  --on-light-syntax-red-hover: #FF8F9AFF;
  --on-light-syntax-red-active: #FF142CFF;
  --inverse-syntax-yellow: #F3A912;
  --inverse-syntax-yellow-hover: #F7C45FFF;
  --inverse-syntax-yellow-active: #DA950BFF;
  --inverse-syntax-orange-hover: #FFE8DBFF;
  --inverse-syntax-orange-active: #FF9F6BFF;
  --inverse-syntax-pink-hover: #FF99C2FF;
  --inverse-syntax-pink-active: #FF297EFF;
  --inverse-syntax-spring-hover: #E2FDAFFF;
  --inverse-syntax-spring-active: #BAFB41FF;
  --inverse-syntax-sky-blue-hover: #DBF7FFFF;
  --inverse-syntax-sky-blue-active: #6BDFFFFF;
  --inverse-syntax-red-hover: #FFE0E3FF;
  --inverse-syntax-red-active: #FF707EFF;
