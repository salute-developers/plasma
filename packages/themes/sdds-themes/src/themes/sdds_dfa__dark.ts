...
:root {
  ...
  --inverse-text-primary-brightness: #252525FF;
  ...
  --surface-transparent-positive: #24B23E33;
  --surface-transparent-warning: #FF702433;
  --surface-transparent-negative: #FF3D5133;
  --surface-transparent-accent: #00AC7B33;
  --surface-positive-minor: #0A2B10;
  --surface-warning-minor: #3D1D0A;
  --surface-negative-minor: #4A0D13;
  --surface-info-minor: #0C283B;
  --surface-transparent-info: #199AF033;
  ...
  --outline-transparent-accent: #14CC9847;
  ...
  --inverse-outline-transparent-accent: #05996F33;
...
:root {
  ...
  --outline-accent-gradient: linear-gradient(45.00deg, #21CA9AFF 0%, #4AD6FCFF 100%);
  ...
  --inverse-outline-accent-gradient: linear-gradient(45.00deg, #05996FFF 0%, #1BA0E3FF 100%);
