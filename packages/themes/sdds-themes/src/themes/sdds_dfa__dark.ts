...
:root {
  ...
  --outline-solid-secondary-active: #A1A1A1FF;
  ...
  --outline-transparent-primary-hover: #FAFAFAFF;
  --outline-transparent-primary-active: #FAFAFA25;
  --outline-transparent-secondary-hover: #FAFAFAFF;
  --outline-transparent-secondary-active: #FAFAFA3D;
  --outline-transparent-tertiary-hover: #FAFAFAFF;
  --outline-transparent-tertiary-active: #FAFAFA56;
  ...
  --outline-solid-secondary: #363636;
  ...
  --on-dark-outline-solid-secondary-active: #A1A1A1FF;
