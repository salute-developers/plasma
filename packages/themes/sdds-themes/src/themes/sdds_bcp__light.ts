...
:root {
  ...
  --text-accent: #4B32B8FF;
  --text-accent-minor: #967AFFFF;
  ...
  --on-dark-text-accent: #7B5CF5FF;
  --on-dark-text-accent-minor: #2F1E77FF;
  ...
  --on-light-text-accent: #4B32B8FF;
  --on-light-text-accent-minor: #967AFFFF;
  ...
  --inverse-text-accent: #7B5CF5FF;
  --inverse-text-accent-minor: #2F1E77FF;
  ...
  --surface-accent: #5F41D9FF;
  --surface-transparent-accent: #5F41D91F;
  --surface-accent-minor: #DAD0FFFF;
  ...
  --on-dark-surface-accent: #5F41D9FF;
  --on-dark-surface-transparent-accent: #5F41D933;
  --on-dark-surface-accent-minor: #1B1147FF;
  ...
  --on-light-surface-accent: #5F41D9FF;
  --on-light-surface-transparent-accent: #5F41D91F;
  --on-light-surface-accent-minor: #DAD0FFFF;
  ...
  --inverse-surface-accent: #5F41D9FF;
  --inverse-surface-transparent-accent: #5F41D933;
  --inverse-surface-accent-minor: #1B1147FF;
  ...
  --outline-accent: #4B32B8FF;
  --outline-transparent-accent: #4B32B833;
  --outline-accent-minor: #967AFFFF;
  ...
  --on-dark-outline-accent: #7B5CF5FF;
  --on-dark-outline-transparent-accent: #7B5CF547;
  --on-dark-outline-accent-minor: #2F1E77FF;
  ...
  --on-light-outline-accent: #4B32B8FF;
  --on-light-outline-transparent-accent: #4B32B833;
  --on-light-outline-accent-minor: #967AFFFF;
  ...
  --inverse-outline-accent: #7B5CF5FF;
  --inverse-outline-transparent-accent: #7B5CF547;
  --inverse-outline-accent-minor: #2F1E77FF;
  --data-yellow: #F3A912;
...
:root {
  ...
  --text-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  --on-dark-text-accent-gradient-hover: #858585FF;
  --on-dark-text-accent-gradient-active: #666666FF;
  --on-dark-text-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  --on-light-text-accent-gradient-hover: #CCCCCCFF;
  --on-light-text-accent-gradient-active: #E6E6E6FF;
  --on-light-text-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  --inverse-text-accent-gradient-hover: #858585FF;
  --inverse-text-accent-gradient-active: #666666FF;
  --inverse-text-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  --surface-accent-gradient-hover: #FFFFFFFF;
  --surface-accent-gradient-active: #FFFFFFFF;
  --surface-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  ...
  --on-dark-surface-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  ...
  --on-light-surface-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  ...
  --inverse-surface-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  ...
  --outline-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  --on-dark-outline-accent-gradient-hover: #858585FF;
  --on-dark-outline-accent-gradient-active: #666666FF;
  --on-dark-outline-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  --on-light-outline-accent-gradient-hover: #CCCCCCFF;
  --on-light-outline-accent-gradient-active: #E6E6E6FF;
  --on-light-outline-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
  --inverse-outline-accent-gradient-hover: #858585FF;
  --inverse-outline-accent-gradient-active: #666666FF;
  --inverse-outline-accent-gradient: linear-gradient(45.00deg, #5F41D9FF 0%, rgb(167,77,231)100% undefined);
}
