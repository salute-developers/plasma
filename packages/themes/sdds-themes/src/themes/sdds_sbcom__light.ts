...
:root {
  ...
  --outline-transparent-surface: linear-gradient(135.00deg, #FFFFFFFF 0%, #FFFFFF29 66.734%, #FFFFFFCC 100%);
  --on-dark-outline-transparent-surface: linear-gradient(135.00deg, #FFFFFFCC 0%, #FFFFFF29 36.746%, #FFFFFF29 66.734%, #FFFFFF99 100%);
  --on-light-outline-transparent-surface: linear-gradient(135.00deg, #FFFFFFFF 0%, #FFFFFF29 66.734%, #FFFFFFCC 100%);
