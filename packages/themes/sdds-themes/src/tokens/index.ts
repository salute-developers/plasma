...
export const textAccentGradient = 'var(--text-accent-gradient, linear-gradient(135deg, white 0%, #FFFFFF 100%))';

/** Цвет ошибки */
export const textNegative = 'var(--text-negative, #F31B30)';

/** Сплошной наборный текст */
export const textParagraph = 'var(--text-paragraph, #262626)';

/** Цвет успеха */
export const textPositive = 'var(--text-positive, #108E25)';

/** Основной цвет текста */
export const textPrimary = 'var(--text-primary, #171717)';

/** Вторичный цвет текста */
export const textSecondary = 'var(--text-secondary, #4E4E4E)';

/** Третичный цвет текста */
export const textTertiary = 'var(--text-tertiary, #858585)';

/** Цвет предупреждения */
export const textWarning = 'var(--text-warning, #E85702)';

/** Прозрачный акцентный цвет */
export const textTransparentAccent = 'var(--text-transparent-accent, rgba(255, 255, 255, 0.12))';

/** Прозрачный акцентный цвет с градиентом */
export const textTransparentAccentGradient =
    'var(--text-transparent-accent-gradient, linear-gradient(135deg, white 0%, rgba(255, 255, 255, 0.12) 100%))';

/** Прозрачный цвет ошибки */
export const textTransparentNegative = 'var(--text-transparent-negative, rgba(243, 27, 48, 0.12))';

/** Цвет успеха */
export const textTransparentPositive = 'var(--text-transparent-positive, rgba(16, 142, 37, 0.12))';

/** Прозрачный цвет предупреждения */
export const textTransparentWarning = 'var(--text-transparent-warning, rgba(232, 87, 2, 0.12))';
...
export const onDarkTextTransparentAccent = 'var(--on-dark-text-transparent-accent, rgba(255, 255, 255, 0.12))';

/** Прозрачный акцентный цвет с градиентом на темном фоне */
export const onDarkTextTransparentAccentGradient =
    'var(--on-dark-text-transparent-accent-gradient, linear-gradient(135deg, black 0%, rgba(255, 255, 255, 0.12) 100%))';

/** Прозрачный цвет ошибки на темном фоне */
export const onDarkTextTransparentNegative = 'var(--on-dark-text-transparent-negative, rgba(255, 41, 62, 0.12))';

/** Цвет успеха на темном фоне */
export const onDarkTextTransparentPositive = 'var(--on-dark-text-transparent-positive, rgba(26, 158, 50, 0.12))';

/** Прозрачный цвет предупреждения на темном фоне */
export const onDarkTextTransparentWarning = 'var(--on-dark-text-transparent-warning, rgba(250, 95, 5, 0.12))';
...
export const onLightTextTransparentAccent = 'var(--on-light-text-transparent-accent, rgba(255, 255, 255, 0.12))';

/** Прозрачный акцентный цвет с градиентом на светлом фоне */
export const onLightTextTransparentAccentGradient =
    'var(--on-light-text-transparent-accent-gradient, linear-gradient(135deg, white 0%, rgba(255, 255, 255, 0.12) 100%))';

/** Прозрачный цвет ошибки на светлом фоне */
export const onLightTextTransparentNegative = 'var(--on-light-text-transparent-negative, rgba(243, 27, 48, 0.12))';

/** Цвет успеха на светлом фоне */
export const onLightTextTransparentPositive = 'var(--on-light-text-transparent-positive, rgba(16, 142, 37, 0.12))';

/** Прозрачный цвет предупреждения на светлом фоне */
export const onLightTextTransparentWarning = 'var(--on-light-text-transparent-warning, rgba(232, 87, 2, 0.12))';
...
export const inverseTextAccentGradient =
    'var(--inverse-text-accent-gradient, linear-gradient(135deg, black 0%, #FFFFFF 100%))';
...
export const inverseTextParagraph = 'var(--inverse-text-paragraph, #ECECEC)';
...
export const inverseTextPrimary = 'var(--inverse-text-primary, #F5F5F5)';

/** Инвертированный вторичный цвет текста */
export const inverseTextSecondary = 'var(--inverse-text-secondary, #B3B3B3)';

/** Инвертированный третичный цвет текста */
export const inverseTextTertiary = 'var(--inverse-text-tertiary, #7A7A7A)';
...
export const inverseTextTransparentAccent = 'var(--inverse-text-transparent-accent, rgba(255, 255, 255, 0.12))';

/** Прозрачный инвертированный акцентный цвет с градиентом */
export const inverseTextTransparentAccentGradient =
    'var(--inverse-text-transparent-accent-gradient, linear-gradient(135deg, black 0%, rgba(255, 255, 255, 0.12) 100%))';

/** Прозрачный инвертированный цвет ошибки */
export const inverseTextTransparentNegative = 'var(--inverse-text-transparent-negative, rgba(255, 41, 62, 0.12))';

/** Инвертированный цвет успеха */
export const inverseTextTransparentPositive = 'var(--inverse-text-transparent-positive, rgba(26, 158, 50, 0.12))';

/** Прозрачный инвертированный цвет предупреждения */
export const inverseTextTransparentWarning = 'var(--inverse-text-transparent-warning, rgba(250, 95, 5, 0.12))';
...
export const surfaceAccentGradient = 'var(--surface-accent-gradient, linear-gradient(135deg, white 0%, #FFFFFF 100%))';
...
export const surfaceNegative = 'var(--surface-negative, #F31B30)';

/** Цвет успеха */
export const surfacePositive = 'var(--surface-positive, #108E25)';

/** Цвет фона поверхности/контрола предупреждение */
export const surfaceWarning = 'var(--surface-warning, #E85702)';
...
export const surfaceSolidCard = 'var(--surface-solid-card, #F7F7F7)';

/** Прозрачный акцентный фон поверхности/контрола */
export const surfaceTransparentAccent = 'var(--surface-transparent-accent, rgba(255, 255, 255, 0.12))';

/** Прозрачный акцентный фон поверхности/контрола с градиентом */
export const surfaceTransparentAccentGradient =
    'var(--surface-transparent-accent-gradient, linear-gradient(135deg, white 0%, rgba(255, 255, 255, 0.12) 100%))';

/** Прозрачный фон для карточек */
export const surfaceTransparentCard = 'var(--surface-transparent-card, rgba(8, 8, 8, 0.06))';

/** Непрозрачный фон поверхности/контрола */
export const surfaceTransparentDeep = 'var(--surface-transparent-deep, rgba(0, 0, 0, 0.64))';

/** Прозрачный цвет фона поверхности/контрола ошибка */
export const surfaceTransparentNegative = 'var(--surface-transparent-negative, rgba(243, 27, 48, 0.12))';

/** Цвет успеха */
export const surfaceTransparentPositive = 'var(--surface-transparent-positive, rgba(16, 142, 37, 0.12))';

/** Основной прозрачный фон поверхности/контрола */
export const surfaceTransparentPrimary = 'var(--surface-transparent-primary, rgba(8, 8, 8, 0.02))';

/** Вторичный прозрачный фон поверхности/контрола */
export const surfaceTransparentSecondary = 'var(--surface-transparent-secondary, rgba(8, 8, 8, 0.06))';

/** Третичный прозрачный фон поверхности/контрола */
export const surfaceTransparentTertiary = 'var(--surface-transparent-tertiary, rgba(8, 8, 8, 0.12))';

/** Прозрачный цвет фона поверхности/контрола предупреждение */
export const surfaceTransparentWarning = 'var(--surface-transparent-warning, rgba(232, 87, 2, 0.12))';
...
export const onDarkSurfaceTransparentAccent = 'var(--on-dark-surface-transparent-accent, rgba(255, 255, 255, 0.12))';
...
export const onDarkSurfaceTransparentAccentGradient =
    'var(--on-dark-surface-transparent-accent-gradient, linear-gradient(135deg, black 0%, rgba(255, 255, 255, 0.12) 100%))';
...
export const onDarkSurfaceTransparentNegative = 'var(--on-dark-surface-transparent-negative, rgba(255, 41, 62, 0.12))';

/** Цвет успеха на темном фоне */
export const onDarkSurfaceTransparentPositive = 'var(--on-dark-surface-transparent-positive, rgba(26, 158, 50, 0.12))';
...
export const onDarkSurfaceTransparentWarning = 'var(--on-dark-surface-transparent-warning, rgba(250, 95, 5, 0.12))';
...
export const onLightSurfaceTransparentAccent = 'var(--on-light-surface-transparent-accent, rgba(255, 255, 255, 0.12))';
...
export const onLightSurfaceTransparentAccentGradient =
    'var(--on-light-surface-transparent-accent-gradient, linear-gradient(135deg, white 0%, rgba(255, 255, 255, 0.12) 100%))';
...
export const onLightSurfaceTransparentNegative =
    'var(--on-light-surface-transparent-negative, rgba(243, 27, 48, 0.12))';

/** Цвет успеха на светлом фоне */
export const onLightSurfaceTransparentPositive =
    'var(--on-light-surface-transparent-positive, rgba(16, 142, 37, 0.12))';
...
export const inverseSurfaceAccentGradient =
    'var(--inverse-surface-accent-gradient, linear-gradient(135deg, black 0%, #FFFFFF 100%))';
...
export const inverseSurfaceTransparentAccent = 'var(--inverse-surface-transparent-accent, rgba(255, 255, 255, 0.12))';
...
export const inverseSurfaceTransparentAccentGradient =
    'var(--inverse-surface-transparent-accent-gradient, linear-gradient(135deg, black 0%, rgba(255, 255, 255, 0.12) 100%))';

/** Инвертированный прозрачный фон для карточек */
export const inverseSurfaceTransparentCard = 'var(--inverse-surface-transparent-card, rgba(255, 255, 255, 0.12))';

/** Инвертированный непрозрачный фон поверхности/контрола */
export const inverseSurfaceTransparentDeep = 'var(--inverse-surface-transparent-deep, rgba(255, 255, 255, 0.64))';
...
export const inverseSurfaceTransparentPrimary = 'var(--inverse-surface-transparent-primary, rgba(255, 255, 255, 0.06))';

/** Инвертированный вторичный прозрачный фон поверхности/контрола */
export const inverseSurfaceTransparentSecondary =
    'var(--inverse-surface-transparent-secondary, rgba(255, 255, 255, 0.12))';

/** Инвертированный третичный прозрачный фон поверхности/контрола */
export const inverseSurfaceTransparentTertiary =
    'var(--inverse-surface-transparent-tertiary, rgba(255, 255, 255, 0.2))';
...
/** Основной фон */
export const backgroundPrimary = 'var(--background-primary, #FFFFFF)';

/** Вторичный фон */
export const backgroundSecondary = 'var(--background-secondary, #FFFFFF)';

/** Третичный фон */
export const backgroundTertiary = 'var(--background-tertiary, #FFFFFF)';
...
export const inverseBackgroundPrimary = 'var(--inverse-background-primary, #000000)';

/** Инвертированный вторичный фон */
export const inverseBackgroundSecondary = 'var(--inverse-background-secondary, #080808)';

/** Инвертированный третичный фон */
export const inverseBackgroundTertiary = 'var(--inverse-background-tertiary, #171717)';
