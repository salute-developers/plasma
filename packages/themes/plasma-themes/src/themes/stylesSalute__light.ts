...
:root {
  ...
  --surface-surface-transparent-accent-main-hover: #1A9E321F;
  --surface-surface-transparent-accent-main-active: #1A9E323D;
  ...
  --surface-transparent-accent-athena: #118CDF1F;
  --surface-transparent-accent-joy: #B559F31F;
  --surface-transparent-accent-b2-e: #1A9E321F;
  --surface-transparent-accent-brand: #3F81FD1F;
  --surface-transparent-accent-main: #1A9E321F;
  ...
  --inverse-surface-surface-accent-joy: #B559F3;
  --inverse-surface-surface-accent-joy-hover: #C275F5FF;
  --inverse-surface-surface-accent-joy-active: #AD45F2FF;
  ...
  --inverse-surface-transparent-accent-main: #1A9E3233;
  --inverse-surface-transparent-accent-athena: #118CDF33;
  --inverse-surface-transparent-accent-joy: #B559F333;
  --inverse-surface-transparent-accent-b2-e: #1A9E3233;
  --inverse-surface-transparent-accent-brand: #3F81FD33;
  ...
  --outline-transparent-accent-main: #1A9E3233;
  --outline-transparent-accent-athena: #118CDF33;
  --outline-transparent-accent-joy: #B559F333;
  --outline-transparent-accent-b2-e: #1A9E3233;
  --outline-transparent-accent-brand: #3F81FD33;
  ...
  --inverse-outline-transparent-accent-main: #24B23E47;
  --inverse-outline-transparent-accent-athena: #199AF047;
  --inverse-outline-transparent-accent-joy: #C46BFF47;
  --inverse-outline-transparent-accent-b2-e: #24B23E47;
  --inverse-outline-transparent-accent-brand: #528EFF47;
  --data-yellow: #F3A912;
...
:root {
  ...
  --inverse-text-gradient-main: linear-gradient(90deg, #24B23EFF 0%, #05C1F5FF 100%);
  --inverse-text-gradient-athena: linear-gradient(94deg, #52BAFFFF 6.49%, #ADADFFFF 93.51%);
  --inverse-text-gradient-joy: linear-gradient(94deg, #FD9C68FF 6.49%, #F391E2FF 93.51%);
  --inverse-text-gradient-b2-e: linear-gradient(90deg, #24B23EFF 0%, #05C1F5FF 100%);
  --inverse-text-gradient-brand: linear-gradient(90deg, #528EFFFF 0%, #04C6C9FF 100%);
  ...
  --inverse-surface-gradient-main: linear-gradient(88deg, #24B23EFF 0%, #00A4D1FF 100%);
