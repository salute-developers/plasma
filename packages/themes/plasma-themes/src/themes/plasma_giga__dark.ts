...
:root {
  ...
  --inverse-text-accent-minor: #333F65FF;
  ...
  --outline-accent: #FFFFFFFF;
  --outline-accent-minor: #D8D8D8FF;
  ...
  --inverse-outline-accent: #122654FF;
  --inverse-outline-accent-minor: #333F65FF;
...
:root {
  ...
  --text-accent-gradient: linear-gradient(90deg, #7D98CFFF 0%, #A9C6FFFF 100%);
  ...
  --inverse-text-accent-gradient: linear-gradient(90deg, #122654FF 0%, #2D5FD2FF 100%);
  --surface-accent-gradient-hover: #FFFFFFFF;
  --surface-accent-gradient-active: #FFFFFFFF;
  --surface-accent-gradient: linear-gradient(90deg, #7D98CFFF 0%, #A9C6FFFF 100%);
  ...
  --inverse-surface-accent-gradient: linear-gradient(90deg, #122654FF 0%, #2D5FD2FF 100%);
