...
:root {
  ...
  --text-info: #3F81FD;
  --text-accent: #24F2BFFF;
  --text-accent-minor: #3AA68BFF;
  ...
  --inverse-text-accent: #1FCCA0FF;
  --inverse-text-accent-minor: #73E5CAFF;
  ...
  --surface-transparent-secondary: #FFFFFF1A;
  --surface-transparent-tertiary: #FFFFFF26;
  ...
  --surface-read-only: #FFFFFF05;
  --surface-read-only-hover: #FFFFFF0F;
  --surface-read-only-active: #FFFFFF00;
  ...
  --inverse-surface-solid-primary: #F2F2F2FF;
  --inverse-surface-solid-secondary: #E7E7E7FF;
  --inverse-surface-solid-tertiary: #DADADAFF;
  --inverse-surface-transparent-card: #FFFFFFFF;
  --inverse-surface-transparent-primary: #0808080D;
  --inverse-surface-transparent-secondary: #0808081A;
  --inverse-surface-transparent-tertiary: #08080826;
  ...
  --inverse-surface-solid-default: #332640FF;
  --inverse-surface-accent: #00AC7B;
  --inverse-surface-accent-minor: #DBFFF5;
  --inverse-surface-transparent-accent: #00AC7B1F;
  --inverse-surface-read-only: #08080803;
  --inverse-surface-read-only-hover: #08080805;
  --inverse-surface-read-only-active: #08080808;
  --background-primary: #242326FF;
  --dark-background-primary: #242326FF;
  --light-background-primary: #EFF0F2FF;
  --inverse-background-primary: #EFF0F2FF;
  ...
  --outline-solid-primary: #1B1B1BFF;
  --outline-solid-secondary: #393939FF;
  --outline-solid-tertiary: #707070;
  --outline-solid-default: #F9F9F9;
  --outline-transparent-primary: #FFFFFF0D;
  ...
  --outline-accent: #24F2BFFF;
  --outline-accent-minor: #3AA68BFF;
  --outline-transparent-accent: #24F2BF47;
  ...
  --on-dark-outline-accent-minor: #24F2BFFF;
  ...
  --inverse-outline-solid-primary: #E0E0E0FF;
  --inverse-outline-solid-secondary: #C7C7C7;
  --inverse-outline-solid-tertiary: #707070;
  --inverse-outline-solid-default: #080808;
  --inverse-outline-transparent-primary: #0808080D;
  --inverse-outline-transparent-secondary: #08080833;
  ...
  --inverse-outline-accent: #1FCCA0FF;
  --inverse-outline-accent-minor: #73E5CAFF;
  --inverse-outline-transparent-accent: #1FCCA047;
  --data-yellow: #F3A912;
...
:root {
  ...
  --text-accent-gradient: linear-gradient(90deg, #5E94FFFF 0%, #43DBFAFF 100%);
