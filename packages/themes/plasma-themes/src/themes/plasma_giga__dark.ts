...
:root {
  ...
  --surface-accent: #24F2BFFF;
  --surface-accent-minor: #0D5442FF;
  --surface-transparent-accent: #24F2BF47;
  ...
  --inverse-surface-accent-minor: #DEFFF7FF;
  --inverse-surface-transparent-accent: #1FCCA047;
