...
:root {
  ...
  --inverse-surface-solid-default: #000000FF;
  ...
  --inverse-outline-transparent-info: #118CDF33;
...
:root {
  ...
  --text-gradient-athena: linear-gradient(93.97deg, #52BAFFFF 6.49%, #ADADFFFF 93.51%);
  --text-gradient-joy-hover: #CCCCCCFF;
  --text-gradient-joy-active: #E6E6E6FF;
  --text-gradient-joy: linear-gradient(93.97deg, #FD9C68FF 6.49%, #F391E2FF 93.51%);
  --text-gradient-b2-e-hover: #CCCCCCFF;
  --text-gradient-b2-e-active: #E6E6E6FF;
  --text-gradient-b2-e: linear-gradient(89.83deg, #24B23EFF 0%, #1CC9C9FF 100%);
  --text-gradient-brand-hover: #CCCCCCFF;
  --text-gradient-brand-active: #E6E6E6FF;
  --text-gradient-brand: linear-gradient(89.83deg, #528EFFFF 0%, #04C6C9FF 100%);
  --text-gradient-main-hover: #CCCCCCFF;
  --text-gradient-main-active: #E6E6E6FF;
  --text-gradient-main: linear-gradient(89.83deg, #24B23EFF 0%, #1CC9C9FF 100%);
  ...
  --on-light-text-gradient-b2-e: linear-gradient(89.83deg, #24B23EFF 0%, #00A4D1FF 100%);
  ...
  --on-light-text-gradient-main: linear-gradient(89.83deg, #24B23EFF 0%, #00A4D1FF 100%);
  ...
  --inverse-text-gradient-main: linear-gradient(88deg, #24B23EFF 0%, #00A4D1FF 100%);
  --inverse-text-gradient-athena: linear-gradient(90deg, #118CDFFF 0%, #7A7AFFFF 100%);
  --inverse-text-gradient-joy: linear-gradient(90deg, #FCA349FF 0%, #FF52C5FF 100%);
  --inverse-text-gradient-b2-e: linear-gradient(90deg, #24B23EFF 0%, #00A4D1FF 100%);
  --inverse-text-gradient-brand: linear-gradient(94deg, #3E79F0FF 6.49%, #27C6E5FF 93.51%);
  --surface-skeleton: linear-gradient(90deg, #FFFFFF00 0%, #FFFFFF03 17.19%, #FFFFFF0D 40.24%, #FFFFFF0F 51.17%, #FFFFFF0D 62.12%, #FFFFFF03 82.81%, #FFFFFF00 100%);
  ...
  --background-modal-sheet: linear-gradient(180deg, #FFFFFF1A 0%, #01B6FF00 50%),#080808FF;
  --background-mobile-assistant-athena: linear-gradient(336.9deg, #143787FF 0%, #08080800 64.95%),radial-gradient(66.53% 100% at 73.33% 100%, #6E05C170 0%, #3513951A 99.69%),linear-gradient(180.03deg, #08080800 50%, #193F9869 99.97%),linear-gradient(270deg, #270F6B4D 0%, #08080800 100%),#080808FF;
  --background-mobile-assistant-joy: linear-gradient(336.9deg, #FF9C653D 0%, #08080800 64.95%),radial-gradient(66.53% 100% at 73.33% 100%, #3D139557 0%, #1318951A 99.69%),linear-gradient(180.03deg, #08080800 50%, #FFD7B326 99.97%),linear-gradient(270deg, #6B0F5733 0%, #08080800 100%),#080808FF;
  --background-mobile-assistant-b2-e: linear-gradient(336.84deg, #14744699 0%, #08080800 64.88%),radial-gradient(100% 100% at 75.89% 100%, #0085FF3D 0%, #0047FF08 100%),linear-gradient(180deg, #08080800 50%, #0747214D 100%),linear-gradient(270deg, #061621FF 0%, #08080800 100%),#080808FF;
  --background-mobile-assistant-brand: linear-gradient(336.9deg, #184BABFF 0%, #08080800 64.95%),radial-gradient(66.53% 100% at 73.33% 100%, #1645A470 0%, #0B272D1A 100%),linear-gradient(180.03deg, #08080800 50%, #1645A469 99.97%),linear-gradient(269.47deg, #1645A44D 0.52%, #08080800 99.61%),#080808FF;
  --background-mobile-assistant-main: linear-gradient(336.84deg, #14744699 0%, #08080800 64.88%),radial-gradient(100% 100% at 75.89% 100%, #0085FF3D 0%, #0047FF08 100%),linear-gradient(180deg, #08080800 50%, #0747214D 100%),linear-gradient(270deg, #061621FF 0%, #08080800 100%),#080808FF;
}
