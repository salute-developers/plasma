...
:root {
  ...
  --syntax-orange: #85380C;
  --syntax-pink: #9B0D46;
  --syntax-spring: #629405;
  --syntax-sky-blue: #0492B9;
  --syntax-red: #FF3D51;
  ...
  --inverse-syntax-orange: #FFB38A;
  --inverse-syntax-pink: #FF4791;
  --inverse-syntax-spring: #C5FC5F;
  --inverse-syntax-sky-blue: #8AE6FF;
  --inverse-syntax-red: #FF8F9A;
  ...
  --text-accent: #122654FF;
  --text-accent-minor: #333F65FF;
  ...
  --on-dark-text-accent: #FFFFFFFF;
  --on-dark-text-accent-minor: #D8D8D8FF;
  ...
  --on-light-text-accent-minor: #333F65FF;
  ...
  --inverse-text-accent: #FFFFFFFF;
  --inverse-text-accent-minor: #D8D8D8FF;
  ...
  --surface-solid-default: #122654FF;
  --surface-accent: #122654FF;
  --surface-accent-minor: #333F65FF;
  ...
  --on-light-surface-solid-default: #122654FF;
  ...
  --inverse-surface-accent: #FFFFFFFF;
  --inverse-surface-accent-minor: #D8D8D8FF;
  ...
  --inverse-surface-solid-contrast: #FFFFFFFF;
  --background-primary: #FAFCFFFF;
  ...
  --outline-accent: #122654FF;
  --outline-accent-minor: #333F65FF;
  ...
  --on-dark-outline-accent: #FFFFFFFF;
  --on-dark-outline-accent-minor: #D8D8D8FF;
  ...
  --on-light-outline-accent: #122654FF;
  --on-light-outline-accent-minor: #333F65FF;
  ...
  --inverse-outline-accent: #FFFFFFFF;
  --inverse-outline-accent-minor: #D8D8D8FF;
...
:root {
  ...
  --text-accent-gradient: linear-gradient(90deg, #122654FF 0%, #2D5FD2FF 100%);
  --on-dark-text-accent-gradient-hover: #858585FF;
  --on-dark-text-accent-gradient-active: #666666FF;
  --on-dark-text-accent-gradient: linear-gradient(90deg, #7D98CFFF 0%, #A9C6FFFF 100%);
  --on-light-text-accent-gradient-hover: #CCCCCCFF;
  --on-light-text-accent-gradient-active: #E6E6E6FF;
  --on-light-text-accent-gradient: linear-gradient(90deg, #122654FF 0%, #2D5FD2FF 100%);
  --inverse-text-accent-gradient-hover: #858585FF;
  --inverse-text-accent-gradient-active: #666666FF;
  --inverse-text-accent-gradient: linear-gradient(90deg, #7D98CFFF 0%, #A9C6FFFF 100%);
  --surface-accent-gradient-hover: #FFFFFFFF;
  --surface-accent-gradient-active: #FFFFFFFF;
  --surface-accent-gradient: linear-gradient(90deg, #122654FF 0%, #2D5FD2FF 100%);
  ...
  --on-dark-surface-accent-gradient: linear-gradient(90deg, #7D98CFFF 0%, #A9C6FFFF 100%);
  ...
  --on-light-surface-accent-gradient: linear-gradient(90deg, #122654FF 0%, #2D5FD2FF 100%);
  ...
  --inverse-surface-accent-gradient: linear-gradient(90deg, #7D98CFFF 0%, #A9C6FFFF 100%);
...
:root {
  ...
  --plasma-typo-h2-medium-letter-spacing: -0.01em;
