...
:root {
  ...
  --surface-accent: #1FCCA0FF;
  --surface-accent-minor: #DEFFF7FF;
  --surface-transparent-accent: #1FCCA047;
  ...
  --on-dark-surface-accent: #24F2BFFF;
  --on-dark-surface-accent-minor: #0D5442FF;
  --on-dark-surface-transparent-accent: #24F2BF47;
  ...
  --on-light-surface-accent: #1FCCA0FF;
  --on-light-surface-accent-minor: #DEFFF7FF;
  --on-light-surface-transparent-accent: #1FCCA047;
  ...
  --inverse-surface-accent: #24F2BFFF;
  --inverse-surface-accent-minor: #0D5442FF;
  --inverse-surface-transparent-accent: #24F2BF47;
