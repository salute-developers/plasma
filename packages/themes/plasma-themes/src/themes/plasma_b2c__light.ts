...
:root {
  ...
  --outline-solid-primary-hover: #787878FF;
  --outline-solid-primary-active: #4F4F4FFF;
  --outline-solid-secondary: #4E4E4E;
  --outline-solid-secondary-hover: #FFFFFFFF;
  --outline-solid-secondary-active: #404040FF;
  ...
  --inverse-outline-solid-primary-active: #B3B3B3FF;
  --inverse-outline-solid-secondary: #949494;
  --inverse-outline-solid-secondary-hover: #FFFFFFFF;
  --inverse-outline-solid-secondary-active: #757575FF;
