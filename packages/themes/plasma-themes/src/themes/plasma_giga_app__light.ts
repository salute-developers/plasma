...
:root {
  ...
  --inverse-outline-transparent-accent: #3F81FD47;
...
:root {
  ...
  --inverse-surface-accent-gradient: linear-gradient(135deg, #000000FF 0%, #FFFFFFFF 100%);
...
:root {
  ...
  --plasma-typo-display-font-family: 'Noto Sans Display', sans-serif;
  --plasma-typo-body-font-family: 'Noto Sans Text', sans-serif;
  --plasma-typo-header-font-family: 'Noto Sans Display', sans-serif;
  --plasma-typo-text-font-family: 'Noto Sans Text', sans-serif;
