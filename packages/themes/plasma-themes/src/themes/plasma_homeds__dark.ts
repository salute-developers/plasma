...
export const plasma_homeds__dark = ([
    `
:root {
  ...
  --on-dark-outline-transparent-secondary-active: #FAFAFA56;
  --on-dark-outline-transparent-tertiary-hover: #FAFAFAFF;
  --on-dark-outline-transparent-tertiary-active: #FAFAFAAB;
...
:root {
  ...
  --on-dark-surface-accent-gradient: #FFFFFF;
  ...
  --overlay-gradient-up: linear-gradient(0deg, #00000000 0%, #00000003 0.77%, #0000000A 1.54%, #00000014 2.31%, #00000026 3.08%, #0000003B 3.86%, #00000054 4.63%, #00000070 5.4%, #0000008F 6.17%, #000000AB 6.94%, #000000C4 7.71%, #000000D9 8.48%, #000000EB 9.25%, #000000F5 10.02%, #000000FC 10.8%, #000000FF 11.57%);
  --overlay-gradient-down: linear-gradient(180deg, #00000000 0%, #00000003 0.95%, #0000000A 1.9%, #00000014 2.86%, #00000026 3.81%, #0000003B 4.76%, #00000054 5.71%, #00000070 6.67%, #0000008F 7.62%, #000000AB 8.57%, #000000C4 9.52%, #000000D9 10.48%, #000000EB 11.43%, #000000F5 12.38%, #000000FC 13.33%, #000000FF 14.29%);
  ...
  --inverse-overlay-gradient-up: linear-gradient(0deg, #FFFFFF00 0%, #FFFFFF03 0.77%, #FFFFFF0A 1.54%, #FFFFFF14 2.31%, #FFFFFF26 3.08%, #FFFFFF3B 3.86%, #FFFFFF54 4.63%, #FFFFFF70 5.4%, #FFFFFF8F 6.17%, #FFFFFFAB 6.94%, #FFFFFFC4 7.71%, #FFFFFFD9 8.48%, #FFFFFFEB 9.25%, #FFFFFFF5 10.02%, #FFFFFFFC 10.8%, #FFFFFFFF 11.57%);
  --inverse-overlay-gradient-down: linear-gradient(180deg, #FFFFFF00 0%, #FFFFFF03 0.95%, #FFFFFF0A 1.9%, #FFFFFF14 2.86%, #FFFFFF26 3.81%, #FFFFFF3B 4.76%, #FFFFFF54 5.71%, #FFFFFF70 6.67%, #FFFFFF8F 7.62%, #FFFFFFAB 8.57%, #FFFFFFC4 9.52%, #FFFFFFD9 10.48%, #FFFFFFEB 11.43%, #FFFFFFF5 12.38%, #FFFFFFFC 13.33%, #FFFFFFFF 14.29%);
  --outline-accent-gradient-hover: #CCCCCCFF;
  --outline-accent-gradient-active: #E6E6E6FF;
  --outline-accent-gradient: linear-gradient(45deg, #1A9E32FF 0%, #04C6C9FF 100%);
  ...
  --inverse-outline-accent-gradient: linear-gradient(45deg, #0D8523FF 0%, #0DA8ABFF 100%);
}
