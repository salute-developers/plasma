...
:root {
  ...
  --inverse-text-primary-hover-brightness: #4E4E4EFF;
  --inverse-text-primary-active: #080808C4;
  --inverse-text-primary-active-brightness: #343434FF;
  ...
  --surface-solid-default-brightness: #F9F9F9FF;
  --surface-solid-default-hover: #FFFFFFFF;
  --surface-solid-default-hover-brightness: #FFFFFFFF;
  --surface-solid-default-active: #F5F5F5FF;
  --surface-solid-default-active-brightness: #F6F6F6FF;
  --surface-info: #3F81FD;
