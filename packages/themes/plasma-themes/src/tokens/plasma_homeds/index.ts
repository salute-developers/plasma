...
export const overlayGradientUp =
    'var(--overlay-gradient-up, linear-gradient(0deg, #08080800 0%, #08080803 0.77%, #0808080A 1.54%, #08080814 2.31%, #08080826 3.08%, #0808083B 3.86%, #08080854 4.63%, #08080870 5.4%, #0808088F 6.17%, #080808AB 6.94%, #080808C4 7.71%, #080808D9 8.48%, #080808EB 9.25%, #080808F5 10.02%, #080808FC 10.8%, #080808FF 11.57%))';

/** dark overlay default overlayGradientDown */
export const overlayGradientDown =
    'var(--overlay-gradient-down, linear-gradient(180deg, #08080800 0%, #08080803 0.95%, #0808080A 1.9%, #08080814 2.86%, #08080826 3.81%, #0808083B 4.76%, #08080854 5.71%, #08080870 6.67%, #0808088F 7.62%, #080808AB 8.57%, #080808C4 9.52%, #080808D9 10.48%, #080808EB 11.43%, #080808F5 12.38%, #080808FC 13.33%, #080808FF 14.29%))';

/** dark overlay onDark overlayGradientUp */
export const onDarkOverlayGradientUp =
    'var(--on-dark-overlay-gradient-up, linear-gradient(0deg, #08080800 0%, #08080803 0.77%, #0808080A 1.54%, #08080814 2.31%, #08080826 3.08%, #0808083B 3.86%, #08080854 4.63%, #08080870 5.4%, #0808088F 6.17%, #080808AB 6.94%, #080808C4 7.71%, #080808D9 8.48%, #080808EB 9.25%, #080808F5 10.02%, #080808FC 10.8%, #080808FF 11.57%))';

/** dark overlay onDark overlayGradientDown */
export const onDarkOverlayGradientDown =
    'var(--on-dark-overlay-gradient-down, linear-gradient(180deg, #08080800 0%, #08080803 0.95%, #0808080A 1.9%, #08080814 2.86%, #08080826 3.81%, #0808083B 4.76%, #08080854 5.71%, #08080870 6.67%, #0808088F 7.62%, #080808AB 8.57%, #080808C4 9.52%, #080808D9 10.48%, #080808EB 11.43%, #080808F5 12.38%, #080808FC 13.33%, #080808FF 14.29%))';

/** dark overlay onLight overlayGradientUp */
export const onLightOverlayGradientUp =
    'var(--on-light-overlay-gradient-up, linear-gradient(0deg, #F9F9F900 0%, #F9F9F903 0.77%, #F9F9F90A 1.54%, #F9F9F914 2.31%, #F9F9F926 3.08%, #F9F9F93B 3.86%, #F9F9F954 4.63%, #F9F9F970 5.4%, #F9F9F98F 6.17%, #F9F9F9AB 6.94%, #F9F9F9C4 7.71%, #F9F9F9D9 8.48%, #F9F9F9EB 9.25%, #F9F9F9F5 10.02%, #F9F9F9FC 10.8%, #F9F9F9FF 11.57%))';

/** dark overlay onLight overlayGradientDown */
export const onLightOverlayGradientDown =
    'var(--on-light-overlay-gradient-down, linear-gradient(180deg, #F9F9F900 0%, #F9F9F903 0.95%, #F9F9F90A 1.9%, #F9F9F914 2.86%, #F9F9F926 3.81%, #F9F9F93B 4.76%, #F9F9F954 5.71%, #F9F9F970 6.67%, #F9F9F98F 7.62%, #F9F9F9AB 8.57%, #F9F9F9C4 9.52%, #F9F9F9D9 10.48%, #F9F9F9EB 11.43%, #F9F9F9F5 12.38%, #F9F9F9FC 13.33%, #F9F9F9FF 14.29%))';

/** dark overlay inverse overlayGradientUp */
export const inverseOverlayGradientUp =
    'var(--inverse-overlay-gradient-up, linear-gradient(0deg, #F9F9F900 0%, #F9F9F903 0.77%, #F9F9F90A 1.54%, #F9F9F914 2.31%, #F9F9F926 3.08%, #F9F9F93B 3.86%, #F9F9F954 4.63%, #F9F9F970 5.4%, #F9F9F98F 6.17%, #F9F9F9AB 6.94%, #F9F9F9C4 7.71%, #F9F9F9D9 8.48%, #F9F9F9EB 9.25%, #F9F9F9F5 10.02%, #F9F9F9FC 10.8%, #F9F9F9FF 11.57%))';

/** dark overlay inverse overlayGradientDown */
export const inverseOverlayGradientDown =
    'var(--inverse-overlay-gradient-down, linear-gradient(180deg, #F9F9F900 0%, #F9F9F903 0.95%, #F9F9F90A 1.9%, #F9F9F914 2.86%, #F9F9F926 3.81%, #F9F9F93B 4.76%, #F9F9F954 5.71%, #F9F9F970 6.67%, #F9F9F98F 7.62%, #F9F9F9AB 8.57%, #F9F9F9C4 9.52%, #F9F9F9D9 10.48%, #F9F9F9EB 11.43%, #F9F9F9F5 12.38%, #F9F9F9FC 13.33%, #F9F9F9FF 14.29%))';
...
export const outlineAccentGradient =
    'var(--outline-accent-gradient, linear-gradient(45deg, #1A9E32FF 0%, #04C6C9FF 100%))';
...
export const onDarkOutlineAccentGradient =
    'var(--on-dark-outline-accent-gradient, linear-gradient(45deg, #1A9E32FF 0%, #04C6C9FF 100%))';
...
export const onLightOutlineAccentGradient =
    'var(--on-light-outline-accent-gradient, linear-gradient(45deg, #0D8523FF 0%, #0DA8ABFF 100%))';
...
export const inverseOutlineAccentGradient =
    'var(--inverse-outline-accent-gradient, linear-gradient(45deg, #0D8523FF 0%, #0DA8ABFF 100%))';
