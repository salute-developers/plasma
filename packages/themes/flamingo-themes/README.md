...
Пакет предоставляет набор _дизайн-токенов_, а также _тем_, реализующих дизайн вертикали «Flamingo».

## Конфигурация пакета

| Тема       | Библиотека | Шрифты                                                                                                                                                                                               |
| ---------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `flamingo` | -          | [SB Sans Display](https://cdn-app.sberdevices.ru/shared-static/0.0.0/styles/SBSansDisplay.0.2.0.css), [SB Sans Text](https://cdn-app.sberdevices.ru/shared-static/0.0.0/styles/SBSansText.0.2.0.css) |
...
```sh
npm i --save @salutejs/flamingo-themes
```
...
import { flamingo__light } from '@salutejs/flamingo-themes';
...
import '@salutejs/flamingo-themes/css/flamingo__dark.css';
...
import styles from '@salutejs/flamingo-themes/css/flamingo.module.css';
...
import { textAccent, backgroundPrimary, textL } from '@salutejs/flamingo-themes/tokens';
