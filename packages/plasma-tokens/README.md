...
```sh
npm i --save @salutejs/plasma-tokens@rc
```
...
Посмотреть в живую можно в документации [типографической системы](https://bit.ly/36MIrA0current/typography#%D0%B2%D0%B0%D1%80%D0%B8%D0%B0%D0%BD%D1%82%D1%8B)
...
Всю представленную палитру можно посмотреть в документации: https://bit.ly/36MIrA0current/pallete
