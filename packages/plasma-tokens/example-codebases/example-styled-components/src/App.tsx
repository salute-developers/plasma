...
import { text, background, accent, gradient } from '@salutejs/plasma-tokens';
import { darkSber, darkEva, darkJoy, lightSber, lightEva, lightJoy } from '@salutejs/plasma-tokens/themes';
// you probably don't need to cycle through typo scales
// by default we use SberBox
import { sberBox, sberPortal, touch } from '@salutejs/plasma-tokens/typo';

// Some type helpers
type textVariants = keyof typeof typography;

// actually you could use components from @salutejs/plasma-styles
// For h1/h2/h3/h4/p ...
...
// For Button and more complex components you could use "@salutejs/ui"
