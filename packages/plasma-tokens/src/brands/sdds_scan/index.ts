...
export const textAccentGradient =
    'var(--text-accent-gradient, radial-gradient(88.00% 150.00% at 0% 100%, #00789999 0%, #197d6100 100%)), var(--text-accent-gradient, radial-gradient(88.00% 100.00% at 100% 0%, #3fe0b1 0.064%, #8ae6ff00 100%)), var(--text-accent-gradient, radial-gradient(44.00% 100.00% at 0% 0%, #00a4d199 0.695%, #0e594400 100%)), var(--text-accent-gradient, #007d80)';
