...
export const sdds_bcp__light = {
    ':root': {
        ...
        '--text-accent-hover': '#8977DAFF',
        '--text-accent-active': '#412CA0FF',
        '--text-accent-gradient-hover': '#CCCCCCFF',
        '--text-accent-gradient-active': '#E6E6E6FF',
        '--text-accent-minor-hover': '#B7A3FFFF',
        '--text-accent-minor-active': '#7752FFFF',
        ...
        '--text-accent': '#4B32B8',
        '--text-accent-minor': '#967AFF',
        '--text-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--on-dark-text-accent-hover': '#B9A9F9FF',
        '--on-dark-text-accent-active': '#633FF3FF',
        '--on-dark-text-accent-gradient-hover': '#858585FF',
        '--on-dark-text-accent-gradient-active': '#666666FF',
        '--on-dark-text-accent-minor-hover': '#412AA7FF',
        '--on-dark-text-accent-minor-active': '#281966FF',
        ...
        '--on-dark-text-accent': '#7B5CF5',
        '--on-dark-text-accent-minor': '#2F1E77',
        '--on-dark-text-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--on-light-text-accent-hover': '#8977DAFF',
        '--on-light-text-accent-active': '#412CA0FF',
        '--on-light-text-accent-gradient-hover': '#CCCCCCFF',
        '--on-light-text-accent-gradient-active': '#E6E6E6FF',
        '--on-light-text-accent-minor-hover': '#B7A3FFFF',
        '--on-light-text-accent-minor-active': '#7752FFFF',
        ...
        '--on-light-text-accent': '#4B32B8',
        '--on-light-text-accent-minor': '#967AFF',
        '--on-light-text-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--inverse-text-accent-hover': '#B9A9F9FF',
        '--inverse-text-accent-active': '#633FF3FF',
        '--inverse-text-accent-gradient-hover': '#858585FF',
        '--inverse-text-accent-gradient-active': '#666666FF',
        '--inverse-text-accent-minor-hover': '#412AA7FF',
        '--inverse-text-accent-minor-active': '#281966FF',
        ...
        '--inverse-text-accent': '#7B5CF5',
        '--inverse-text-accent-minor': '#2F1E77',
        '--inverse-text-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--surface-accent-hover': '#6C50DCFF',
        '--surface-accent-active': '#502ED6FF',
        '--surface-accent-gradient-hover': '#FFFFFFFF',
        '--surface-accent-gradient-active': '#FFFFFFFF',
        '--surface-accent-minor-hover': '#D3C7FFFF',
        '--surface-accent-minor-active': '#CFC2FFFF',
        '--surface-transparent-accent-hover': '#5E3FD92E',
        '--surface-transparent-accent-active': '#5E3FD933',
        ...
        '--surface-accent': '#5F41D9',
        '--surface-transparent-accent': '#5F41D91F',
        '--surface-accent-minor': '#DAD0FF',
        '--surface-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--on-dark-surface-accent-hover': '#6C50DCFF',
        '--on-dark-surface-accent-active': '#5737D7FF',
        '--on-dark-surface-accent-gradient-hover': '#FFFFFFFF',
        '--on-dark-surface-accent-gradient-active': '#FFFFFFFF',
        '--on-dark-surface-accent-minor-hover': '#211556FF',
        '--on-dark-surface-accent-minor-active': '#170F3EFF',
        '--on-dark-surface-transparent-accent-hover': '#5E3FD952',
        '--on-dark-surface-transparent-accent-active': '#5E3FD924',
        ...
        '--on-dark-surface-accent': '#5F41D9',
        '--on-dark-surface-transparent-accent': '#5F41D933',
        '--on-dark-surface-accent-minor': '#1B1147',
        '--on-dark-surface-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--on-light-surface-accent-hover': '#6C50DCFF',
        '--on-light-surface-accent-active': '#502ED6FF',
        '--on-light-surface-accent-gradient-hover': '#FFFFFFFF',
        '--on-light-surface-accent-gradient-active': '#FFFFFFFF',
        '--on-light-surface-accent-minor-hover': '#D3C7FFFF',
        '--on-light-surface-accent-minor-active': '#CFC2FFFF',
        '--on-light-surface-transparent-accent-hover': '#5E3FD92E',
        '--on-light-surface-transparent-accent-active': '#5E3FD933',
        ...
        '--on-light-surface-accent': '#5F41D9',
        '--on-light-surface-transparent-accent': '#5F41D91F',
        '--on-light-surface-accent-minor': '#DAD0FF',
        '--on-light-surface-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--inverse-surface-accent-hover': '#6C50DCFF',
        '--inverse-surface-accent-active': '#5737D7FF',
        '--inverse-surface-accent-gradient-hover': '#FFFFFFFF',
        '--inverse-surface-accent-gradient-active': '#FFFFFFFF',
        '--inverse-surface-accent-minor-hover': '#211556FF',
        '--inverse-surface-accent-minor-active': '#170F3EFF',
        '--inverse-surface-transparent-accent-hover': '#5E3FD952',
        '--inverse-surface-transparent-accent-active': '#5E3FD924',
        ...
        '--inverse-surface-accent': '#5F41D9',
        '--inverse-surface-transparent-accent': '#5F41D933',
        '--inverse-surface-accent-minor': '#1B1147',
        '--inverse-surface-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--outline-accent-hover': '#8977DAFF',
        '--outline-accent-active': '#412CA0FF',
        '--outline-accent-gradient-hover': '#CCCCCCFF',
        '--outline-accent-gradient-active': '#E6E6E6FF',
        '--outline-accent-minor-hover': '#B7A3FFFF',
        '--outline-accent-minor-active': '#7752FFFF',
        '--outline-transparent-accent-hover': '#4B32B81F',
        '--outline-transparent-accent-active': '#4B32B852',
        ...
        '--outline-accent': '#4B32B8',
        '--outline-transparent-accent': '#4B32B833',
        '--outline-accent-minor': '#967AFF',
        '--outline-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--on-dark-outline-accent-hover': '#B9A9F9FF',
        '--on-dark-outline-accent-active': '#633FF3FF',
        '--on-dark-outline-accent-gradient-hover': '#858585FF',
        '--on-dark-outline-accent-gradient-active': '#666666FF',
        '--on-dark-outline-accent-minor-hover': '#412AA7FF',
        '--on-dark-outline-accent-minor-active': '#281966FF',
        '--on-dark-outline-transparent-accent-hover': '#7B5CF5B3',
        '--on-dark-outline-transparent-accent-active': '#7B5CF52B',
        ...
        '--on-dark-outline-accent': '#7B5CF5',
        '--on-dark-outline-transparent-accent': '#7B5CF547',
        '--on-dark-outline-accent-minor': '#2F1E77',
        '--on-dark-outline-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--on-light-outline-accent-hover': '#8977DAFF',
        '--on-light-outline-accent-active': '#412CA0FF',
        '--on-light-outline-accent-gradient-hover': '#CCCCCCFF',
        '--on-light-outline-accent-gradient-active': '#E6E6E6FF',
        '--on-light-outline-accent-minor-hover': '#B7A3FFFF',
        '--on-light-outline-accent-minor-active': '#7752FFFF',
        '--on-light-outline-transparent-accent-hover': '#4B32B81F',
        '--on-light-outline-transparent-accent-active': '#4B32B852',
        ...
        '--on-light-outline-accent': '#4B32B8',
        '--on-light-outline-transparent-accent': '#4B32B833',
        '--on-light-outline-accent-minor': '#967AFF',
        '--on-light-outline-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
        ...
        '--inverse-outline-accent-hover': '#B9A9F9FF',
        '--inverse-outline-accent-active': '#633FF3FF',
        '--inverse-outline-accent-gradient-hover': '#858585FF',
        '--inverse-outline-accent-gradient-active': '#666666FF',
        '--inverse-outline-accent-minor-hover': '#412AA7FF',
        '--inverse-outline-accent-minor-active': '#281966FF',
        '--inverse-outline-transparent-accent-hover': '#7B5CF5B3',
        '--inverse-outline-transparent-accent-active': '#7B5CF52B',
        ...
        '--inverse-outline-accent': '#7B5CF5',
        '--inverse-outline-transparent-accent': '#7B5CF547',
        '--inverse-outline-accent-minor': '#2F1E77',
        '--inverse-outline-accent-gradient': 'linear-gradient(45.00deg, rgb(95,65,217) 0%, rgb(167,77,231)100%)',
