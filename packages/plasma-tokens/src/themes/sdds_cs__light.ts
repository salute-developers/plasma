...
export const sdds_cs__light = {
    ':root': {
        ...
        '--on-dark-text-secondary-active': '#90A3B2FF',
        '--on-dark-text-tertiary-hover': '#FFFFFFFF',
        '--on-dark-text-tertiary-active': '#636D74FF',
        ...
        '--on-dark-text-secondary': '#C0CBD3',
        '--on-dark-text-tertiary': '#7B868E',
        ...
        '--on-dark-outline-solid-secondary-active': '#515B61FF',
        ...
        '--on-dark-outline-solid-secondary': '#657179',
