...
export const plasma_homeds__dark = {
    ':root': {
        ...
        '--outline-accent-gradient': 'linear-gradient(45deg, #1A9E32 0%, #04C6C9 100%)',
        ...
        '--inverse-outline-accent-gradient': 'linear-gradient(45deg, #0D8523 0%, #0DA8AB 100%)',
...
/** @deprecated использовать вместо этого plasma_homeds__dark */
export const darkPlasma_homeds = plasma_homeds__dark;
