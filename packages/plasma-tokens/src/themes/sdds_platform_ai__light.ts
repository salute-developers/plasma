...
export const sdds_platform_ai__light = {
    ':root': {
        ...
        '--on-dark-text-accent-gradient': 'linear-gradient(45deg, #52F2C5, #C5FC5F 100%)',
        ...
        '--inverse-text-accent-gradient': 'linear-gradient(45deg, #52F2C5, #C5FC5F 100%)',
        ...
        '--on-dark-surface-accent-gradient': 'linear-gradient(45deg, #52F2C5 0.323%, #C5FC5F 100%)',
        ...
        '--inverse-surface-accent-gradient': 'linear-gradient(45deg, #52F2C5 0.323%, #C5FC5F 100%)',
        ...
        '--on-dark-outline-accent-gradient': 'linear-gradient(45deg, #C5FC5F, #04C6C9 100%)',
        ...
        '--inverse-outline-accent-gradient': 'linear-gradient(45deg, #C5FC5F, #04C6C9 100%)',
