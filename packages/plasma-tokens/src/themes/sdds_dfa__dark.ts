...
export const sdds_dfa__dark = {
    ':root': {
        ...
        '--text-primary-active': '#F5F5F562',
        '--text-secondary-hover': '#F5F5F5FF',
        '--text-secondary-active': '#F5F5F547',
        '--text-tertiary-hover': '#F5F5F5B3',
        '--text-tertiary-active': '#F5F5F52B',
        '--text-paragraph-hover': '#F5F5F57A',
        '--text-paragraph-active': '#F5F5F552',
        '--text-accent-hover': '#58EEC4FF',
        '--text-accent-active': '#11B083FF',
        '--text-accent-gradient-hover': '#858585FF',
        '--text-accent-gradient-active': '#666666FF',
        '--text-accent-minor-hover': '#199F79FF',
        '--text-accent-minor-active': '#0B4736FF',
        '--text-positive-hover': '#5EDE76FF',
        ...
        '--text-positive-minor-active': '#074A14FF',
        ...
        '--on-dark-text-primary-active': '#F5F5F562',
        '--on-dark-text-secondary-hover': '#F5F5F5FF',
        '--on-dark-text-secondary-active': '#F5F5F547',
        '--on-dark-text-tertiary-hover': '#F5F5F5B3',
        '--on-dark-text-tertiary-active': '#F5F5F52B',
        '--on-dark-text-paragraph-hover': '#F5F5F57A',
        '--on-dark-text-paragraph-active': '#F5F5F552',
        ...
        '--on-dark-text-accent-minor-active': '#0B4736FF',
        ...
        '--on-light-text-primary-active': '#17171762',
        '--on-light-text-secondary-hover': '#171717FF',
        '--on-light-text-secondary-active': '#17171747',
        '--on-light-text-tertiary-hover': '#171717B3',
        '--on-light-text-tertiary-active': '#1717172B',
        '--on-light-text-paragraph-hover': '#1717177A',
        '--on-light-text-paragraph-active': '#17171752',
        '--on-light-text-accent-hover': '#07D59AFF',
        '--on-light-text-accent-active': '#048661FF',
        '--on-light-text-accent-gradient-hover': '#858585FF',
        '--on-light-text-accent-gradient-active': '#666666FF',
        '--on-light-text-accent-minor-hover': '#58EEC4FF',
        '--on-light-text-accent-minor-active': '#11B083FF',
        '--on-light-text-positive-hover': '#22D343FF',
        '--on-light-text-positive-active': '#178C2CFF',
        '--on-light-text-warning-hover': '#FC9255FF',
        '--on-light-text-warning-active': '#DC5304FF',
        '--on-light-text-negative-hover': '#FF7A88FF',
        '--on-light-text-negative-active': '#FF0A23FF',
        '--on-light-text-info-hover': '#62B9F3FF',
        ...
        '--on-light-text-warning-minor-hover': '#FED1B9FF',
        '--on-light-text-warning-minor-active': '#FC884AFF',
        '--on-light-text-negative-minor-hover': '#FFE0E3FF',
        ...
        '--inverse-text-primary-active': '#17171762',
        '--inverse-text-secondary-hover': '#171717FF',
        '--inverse-text-secondary-active': '#17171747',
        '--inverse-text-tertiary-hover': '#171717B3',
        '--inverse-text-tertiary-active': '#1717172B',
        '--inverse-text-paragraph-hover': '#1717177A',
        '--inverse-text-paragraph-active': '#17171752',
        '--inverse-text-accent-hover': '#07D59AFF',
        '--inverse-text-accent-active': '#048661FF',
        ...
        '--inverse-text-positive-hover': '#22D343FF',
        '--inverse-text-positive-active': '#178C2CFF',
        '--inverse-text-warning-hover': '#FC9255FF',
        ...
        '--inverse-text-warning-minor-hover': '#FED1B9FF',
        '--inverse-text-warning-minor-active': '#FC884AFF',
        '--inverse-text-negative-minor-hover': '#FFE0E3FF',
        ...
        '--on-light-outline-solid-primary-hover': '#8C8C8CFF',
        '--on-light-outline-solid-primary-active': '#636363FF',
        '--on-light-outline-solid-secondary-hover': '#FFFFFFFF',
        '--on-light-outline-solid-secondary-active': '#808080FF',
        '--on-light-outline-solid-tertiary-hover': '#CCCCCCFF',
        '--on-light-outline-solid-tertiary-active': '#575757FF',
        '--on-light-outline-transparent-primary-hover': '#0808084D',
        '--on-light-outline-transparent-primary-active': '#08080812',
        '--on-light-outline-transparent-secondary-hover': '#080808B3',
        '--on-light-outline-transparent-secondary-active': '#0808082B',
        '--on-light-outline-transparent-tertiary-hover': '#080808FF',
        '--on-light-outline-transparent-tertiary-active': '#08080847',
        '--on-light-outline-clear-hover': '#FFFFFFFF',
        '--on-light-outline-clear-active': '#FFFFFFFF',
        '--on-light-outline-accent-hover': '#07D59AFF',
        '--on-light-outline-accent-active': '#048661FF',
        '--on-light-outline-accent-gradient-hover': '#858585FF',
        '--on-light-outline-accent-gradient-active': '#666666FF',
        '--on-light-outline-accent-minor-hover': '#58EEC4FF',
        '--on-light-outline-accent-minor-active': '#11B083FF',
        '--on-light-outline-transparent-accent-hover': '#05996F80',
        '--on-light-outline-transparent-accent-active': '#05996F1F',
        '--on-light-outline-positive-hover': '#22D343FF',
        '--on-light-outline-positive-active': '#178C2CFF',
        '--on-light-outline-warning-hover': '#FC9255FF',
        ...
        '--on-light-outline-warning-minor-hover': '#FED1B9FF',
        '--on-light-outline-warning-minor-active': '#FC884AFF',
        '--on-light-outline-negative-minor-hover': '#FFE0E3FF',
        ...
        '--on-light-outline-transparent-positive-hover': '#1A9E3280',
        '--on-light-outline-transparent-positive-active': '#1A9E321F',
        '--on-light-outline-transparent-warning-hover': '#FA5F0580',
        '--on-light-outline-transparent-warning-active': '#FA5F051F',
        '--on-light-outline-transparent-negative-hover': '#FF293E80',
        '--on-light-outline-transparent-negative-active': '#FF293E1F',
        '--on-light-outline-transparent-info-hover': '#118CDF80',
        '--on-light-outline-transparent-info-active': '#118CDF1F',
        ...
        '--inverse-outline-solid-primary-hover': '#8C8C8CFF',
        '--inverse-outline-solid-primary-active': '#636363FF',
        '--inverse-outline-solid-secondary-hover': '#FFFFFFFF',
        '--inverse-outline-solid-secondary-active': '#808080FF',
        '--inverse-outline-solid-tertiary-hover': '#CCCCCCFF',
        '--inverse-outline-solid-tertiary-active': '#575757FF',
        '--inverse-outline-transparent-primary': '#0808081F',
        '--inverse-outline-transparent-primary-hover': '#0808084D',
        '--inverse-outline-transparent-primary-active': '#08080812',
        '--inverse-outline-transparent-secondary': '#08080847',
        '--inverse-outline-transparent-secondary-hover': '#080808B3',
        '--inverse-outline-transparent-secondary-active': '#0808082B',
        '--inverse-outline-transparent-tertiary': '#0808088F',
        '--inverse-outline-transparent-tertiary-hover': '#080808FF',
        '--inverse-outline-transparent-tertiary-active': '#08080847',
        '--inverse-outline-clear-hover': '#FFFFFFFF',
        '--inverse-outline-clear-active': '#FFFFFFFF',
        '--inverse-outline-accent-hover': '#07D59AFF',
        '--inverse-outline-accent-active': '#048661FF',
        ...
        '--inverse-outline-transparent-accent-hover': '#05996F80',
        '--inverse-outline-transparent-accent-active': '#05996F1F',
        '--inverse-outline-positive-hover': '#22D343FF',
        '--inverse-outline-positive-active': '#178C2CFF',
        '--inverse-outline-warning-hover': '#FC9255FF',
        ...
        '--inverse-outline-warning-minor-hover': '#FED1B9FF',
        '--inverse-outline-warning-minor-active': '#FC884AFF',
        '--inverse-outline-negative-minor-hover': '#FFE0E3FF',
        ...
        '--inverse-outline-transparent-positive-hover': '#1A9E3280',
        '--inverse-outline-transparent-positive-active': '#1A9E321F',
        '--inverse-outline-transparent-warning-hover': '#FA5F0580',
        '--inverse-outline-transparent-warning-active': '#FA5F051F',
        '--inverse-outline-transparent-negative-hover': '#FF293E80',
        '--inverse-outline-transparent-negative-active': '#FF293E1F',
        '--inverse-outline-transparent-info-hover': '#118CDF80',
        '--inverse-outline-transparent-info-active': '#118CDF1F',
