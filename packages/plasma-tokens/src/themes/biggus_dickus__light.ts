...
export const biggus_dickus__light = {
    ':root': {
        ...
        '--outline-default-outline-transparent-accent': '#0B7ECB33',
        ...
        '--outline-on-dark-outline-transparent-accent': '#199AF047',
        ...
        '--outline-on-light-outline-transparent-accent': '#0B7ECB33',
        ...
        '--outline-inverse-outline-transparent-accent': '#199AF047',
...
/** @deprecated использовать вместо этого biggus_dickus__light */
export const lightBiggus_dickus = biggus_dickus__light;
