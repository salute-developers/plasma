...
export const plasma_web_ACTUAL_TYPOGRAPHY__light = {
    ':root': {
        ...
        '--outline-read-only': 'rgba(8, 8, 8, 0.1)',
        '--outline-read-only-hover': 'rgba(8, 8, 8, 0.3)',
        '--outline-read-only-active': 'rgba(8, 8, 8, 0.2)',
        ...
        '--on-dark-outline-read-only': 'rgba(255, 255, 255, 0.12)',
        '--on-dark-outline-read-only-hover': 'rgba(255, 255, 255, 0.3)',
        '--on-dark-outline-read-only-active': 'rgba(255, 255, 255, 0.07)',
        ...
        '--on-light-outline-read-only': 'rgba(8, 8, 8, 0.1)',
        '--on-light-outline-read-only-hover': 'rgba(8, 8, 8, 0.3)',
        '--on-light-outline-read-only-active': 'rgba(8, 8, 8, 0.2)',
        ...
        '--inverse-outline-read-only': 'rgba(255, 255, 255, 0.12)',
        '--inverse-outline-read-only-hover': 'rgba(255, 255, 255, 0.3)',
        '--inverse-outline-read-only-active': 'rgba(255, 255, 255, 0.07)',
...
/** @deprecated использовать вместо этого plasma_web_ACTUAL_TYPOGRAPHY__light */
export const lightPlasma_web_ACTUAL_TYPOGRAPHY = plasma_web_ACTUAL_TYPOGRAPHY__light;
