...
export const plasma_infra__dark = {
    ':root': {
        ...
        '--surface-solid-card-hover': '#B9BDCAFF',
        '--surface-solid-card-active': '#A8ACBDFF',
        '--surface-solid-card-brightness': '#BFC2CFFF',
        '--surface-solid-default-hover': '#545663FF',
        '--surface-solid-default-active': '#464753FF',
        '--surface-transparent-primary-hover': '#F8F9FC14',
        '--surface-transparent-primary-active': '#F8F9FC05',
        '--surface-solid-default': '#4B4C58',
        '--surface-solid-card': '#AEB2C2',
