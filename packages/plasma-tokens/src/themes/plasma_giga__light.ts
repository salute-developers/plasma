...
export const plasma_giga__light = {
    ':root': {
        ...
        '--text-accent-hover': '#244BA8FF',
        '--text-accent-active': '#10224CFF',
        '--text-accent-gradient-hover': '#CCCCCCFF',
        '--text-accent-gradient-active': '#E6E6E6FF',
        '--text-accent-minor-hover': '#4B5C95FF',
        '--text-accent-minor-active': '#2C3758FF',
        ...
        '--text-accent-gradient': 'linear-gradient(90deg, #122654 0%, #2D5FD2 100%)',
        '--text-accent': '#122654',
        '--text-accent-minor': '#333F65',
        ...
        '--on-dark-text-accent-hover': '#858585FF',
        '--on-dark-text-accent-active': '#666666FF',
        '--on-dark-text-accent-gradient-hover': '#858585FF',
        '--on-dark-text-accent-gradient-active': '#666666FF',
        '--on-dark-text-accent-minor-hover': '#878787FF',
        '--on-dark-text-accent-minor-active': '#5E5E5EFF',
        ...
        '--on-dark-text-accent-gradient': 'linear-gradient(90deg, #7D98CF 0%, #A9C6FF 100%)',
        '--on-dark-text-accent': '#ffffff',
        '--on-dark-text-accent-minor': '#D8D8D8',
        ...
        '--on-light-text-accent-hover': '#244BA8FF',
        '--on-light-text-accent-active': '#10224CFF',
        '--on-light-text-accent-gradient-hover': '#CCCCCCFF',
        '--on-light-text-accent-gradient-active': '#E6E6E6FF',
        '--on-light-text-accent-minor-hover': '#4B5C95FF',
        '--on-light-text-accent-minor-active': '#2C3758FF',
        ...
        '--on-light-text-accent-gradient': 'linear-gradient(90deg, #122654 0%, #2D5FD2 100%)',
        '--on-light-text-accent': '#122654FF',
        '--on-light-text-accent-minor': '#333F65',
        ...
        '--inverse-text-accent-hover': '#858585FF',
        '--inverse-text-accent-active': '#666666FF',
        '--inverse-text-accent-gradient-hover': '#858585FF',
        '--inverse-text-accent-gradient-active': '#666666FF',
        '--inverse-text-accent-minor-hover': '#878787FF',
        '--inverse-text-accent-minor-active': '#5E5E5EFF',
        ...
        '--inverse-text-accent-gradient': 'linear-gradient(90deg, #7D98CF 0%, #A9C6FF 100%)',
        '--inverse-text-accent': '#ffffff',
        '--inverse-text-accent-minor': '#D8D8D8',
        ...
        '--surface-accent-hover': '#152D65FF',
        '--surface-accent-active': '#0E1E43FF',
        '--surface-accent-gradient-hover': '#FFFFFFFF',
        '--surface-accent-gradient-active': '#FFFFFFFF',
        '--surface-accent-minor-hover': '#3A4773FF',
        '--surface-accent-minor-active': '#2C3758FF',
        '--surface-transparent-accent-hover': '#1226542E',
        '--surface-transparent-accent-active': '#12265433',
        ...
        '--surface-accent-gradient': 'linear-gradient(90deg, #122654 0%, #2D5FD2 100%)',
        '--surface-accent': '#122654',
        '--surface-accent-minor': '#333F65',
        '--surface-transparent-accent': '#1226541F',
        '--surface-solid-contrast': '#080808',
        '--surface-solid-contrast-hover': '#262626FF',
        '--surface-solid-contrast-active': '#030303FF',
        ...
        '--on-dark-surface-accent-hover': '#FFFFFFFF',
        '--on-dark-surface-accent-active': '#FFFFFFFF',
        '--on-dark-surface-accent-gradient-hover': '#FFFFFFFF',
        '--on-dark-surface-accent-gradient-active': '#FFFFFFFF',
        '--on-dark-surface-accent-minor-hover': '#E3E3E3FF',
        '--on-dark-surface-accent-minor-active': '#D4D4D4FF',
        '--on-dark-surface-transparent-accent-hover': '#FFFFFF52',
        '--on-dark-surface-transparent-accent-active': '#FFFFFF24',
        ...
        '--on-dark-surface-accent-gradient': 'linear-gradient(90deg, #7D98CF 0%, #A9C6FF 100%)',
        '--on-dark-surface-accent': '#ffffff',
        '--on-dark-surface-accent-minor': '#d8d8d8',
        '--on-dark-surface-transparent-accent': '#FFFFFF33',
        '--on-dark-surface-solid-contrast': '#ffffff',
        ...
        '--on-light-surface-accent-hover': '#152D65FF',
        '--on-light-surface-accent-active': '#0E1E43FF',
        '--on-light-surface-accent-gradient-hover': '#FFFFFFFF',
        '--on-light-surface-accent-gradient-active': '#FFFFFFFF',
        '--on-light-surface-accent-minor-hover': '#3A4773FF',
        '--on-light-surface-accent-minor-active': '#2C3758FF',
        '--on-light-surface-transparent-accent-hover': '#1226542E',
        '--on-light-surface-transparent-accent-active': '#12265433',
        ...
        '--on-light-surface-accent-gradient': 'linear-gradient(90deg, #122654 0%, #2D5FD2 100%)',
        '--on-light-surface-accent': '#122654',
        '--on-light-surface-accent-minor': '#333F65',
        ...
        '--inverse-surface-accent-minor-hover': '#E3E3E3FF',
        '--inverse-surface-accent-minor-active': '#D4D4D4FF',
        '--inverse-surface-transparent-accent-hover': '#FFFFFF52',
        '--inverse-surface-transparent-accent-active': '#FFFFFF24',
        ...
        '--inverse-surface-accent-gradient': 'linear-gradient(90deg, #7D98CF 0%, #A9C6FF 100%)',
        '--inverse-surface-accent': '#ffffff',
        '--inverse-surface-accent-minor': '#d8d8d8',
        '--inverse-surface-transparent-accent': '#FFFFFF33',
        '--inverse-surface-solid-contrast-hover': '#FFFFFFFF',
        '--inverse-surface-solid-contrast-active': '#FFFFFFFF',
        '--inverse-surface-solid-contrast': '#ffffff',
        ...
        '--outline-accent-hover': '#244BA8FF',
        '--outline-accent-active': '#10224CFF',
        '--outline-accent-minor-hover': '#4B5C95FF',
        '--outline-accent-minor-active': '#2C3758FF',
        '--outline-transparent-accent-hover': '#1226541F',
        '--outline-transparent-accent-active': '#12265452',
        ...
        '--outline-accent': '#122654',
        '--outline-accent-minor': '#333F65',
        '--outline-transparent-accent': '#12265433',
        ...
        '--on-dark-outline-accent-hover': '#858585FF',
        '--on-dark-outline-accent-active': '#666666FF',
        '--on-dark-outline-accent-minor-hover': '#878787FF',
        '--on-dark-outline-accent-minor-active': '#5E5E5EFF',
        '--on-dark-outline-transparent-accent-hover': '#FFFFFFB3',
        '--on-dark-outline-transparent-accent-active': '#FFFFFF2B',
        ...
        '--on-dark-outline-accent': '#ffffff',
        '--on-dark-outline-accent-minor': '#d8d8d8',
        '--on-dark-outline-transparent-accent': '#FFFFFF47',
        ...
        '--on-light-outline-accent-hover': '#244BA8FF',
        '--on-light-outline-accent-active': '#10224CFF',
        '--on-light-outline-accent-minor-hover': '#4B5C95FF',
        '--on-light-outline-accent-minor-active': '#2C3758FF',
        '--on-light-outline-transparent-accent-hover': '#1226541F',
        '--on-light-outline-transparent-accent-active': '#12265452',
        ...
        '--on-light-outline-accent': '#122654',
        '--on-light-outline-accent-minor': '#333F65',
        '--on-light-outline-transparent-accent': '#12265433',
        ...
        '--inverse-outline-accent-hover': '#858585FF',
        '--inverse-outline-accent-active': '#666666FF',
        '--inverse-outline-accent-minor-hover': '#878787FF',
        '--inverse-outline-accent-minor-active': '#5E5E5EFF',
        '--inverse-outline-transparent-accent-hover': '#FFFFFFB3',
        '--inverse-outline-transparent-accent-active': '#FFFFFF2B',
        ...
        '--inverse-outline-accent': '#ffffff',
        '--inverse-outline-accent-minor': '#d8d8d8',
        '--inverse-outline-transparent-accent': '#FFFFFF47',
