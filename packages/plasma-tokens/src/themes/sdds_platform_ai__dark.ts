...
export const sdds_platform_ai__dark = {
    ':root': {
        ...
        '--text-primary': '#F5F5F5',
        '--text-accent-gradient': 'linear-gradient(45deg, #52F2C5, #C5FC5F 100%)',
        ...
        '--surface-accent-gradient': 'linear-gradient(45deg, #52F2C5 0.323%, #C5FC5F 100%)',
        ...
        '--outline-accent-gradient': 'linear-gradient(45deg, #C5FC5F, #04C6C9 100%)',
