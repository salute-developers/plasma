...
export const Test__light = {
    ':root': {
        ...
        '--text-accent': '#F31B31',
        '--text-accent-hover': '#F54254FF',
        '--text-accent-active': '#DA0B20FF',
        '--text-accent-minor': '#FF8F9A',
        '--text-accent-minor-hover': '#FFB8BFFF',
        '--text-accent-minor-active': '#FF6675FF',
        ...
        '--on-dark-text-accent-hover': '#FF6675FF',
        '--on-dark-text-accent-active': '#FF142CFF',
        '--on-dark-text-accent-minor': '#9C1422',
        '--on-dark-text-accent-minor-hover': '#C2192AFF',
        '--on-dark-text-accent-minor-active': '#7A101AFF',
        ...
        '--on-light-text-accent-hover': '#F54254FF',
        '--on-light-text-accent-active': '#DA0B20FF',
        '--on-light-text-accent-minor': '#FF8F9A',
        '--on-light-text-accent-minor-hover': '#FFB8BFFF',
        '--on-light-text-accent-minor-active': '#FF6675FF',
        ...
        '--inverse-text-accent': '#FF3D51',
        '--inverse-text-accent-hover': '#FF6675FF',
        '--inverse-text-accent-active': '#FF142CFF',
        '--inverse-text-accent-minor': '#9C1422',
        '--inverse-text-accent-minor-hover': '#C2192AFF',
        '--inverse-text-accent-minor-active': '#7A101AFF',
        ...
        '--surface-accent-hover': '#FF5263FF',
        '--surface-accent-active': '#FF142CFF',
        '--surface-accent-minor': '#FFE0E3',
        '--surface-accent-minor-hover': '#FFF5F6FF',
        '--surface-accent-minor-active': '#FFD6DAFF',
        '--surface-transparent-accent': '#FF293E1F',
        '--surface-transparent-accent-hover': '#FF293E0A',
        '--surface-transparent-accent-active': '#FF293E29',
        ...
        '--on-dark-surface-accent-hover': '#FF5263FF',
        '--on-dark-surface-accent-active': '#FF142CFF',
        '--on-dark-surface-accent-minor': '#4A0D13',
        '--on-dark-surface-accent-minor-hover': '#64121AFF',
        '--on-dark-surface-accent-minor-active': '#380A0FFF',
        '--on-dark-surface-transparent-accent': '#FF293E33',
        '--on-dark-surface-transparent-accent-hover': '#FF293E1F',
        '--on-dark-surface-transparent-accent-active': '#FF293E3D',
        ...
        '--on-light-surface-accent-hover': '#FF5263FF',
        '--on-light-surface-accent-active': '#FF142CFF',
        '--on-light-surface-accent-minor': '#FFE0E3',
        '--on-light-surface-accent-minor-hover': '#FFF5F6FF',
        '--on-light-surface-accent-minor-active': '#FFD6DAFF',
        '--on-light-surface-transparent-accent': '#FF293E1F',
        '--on-light-surface-transparent-accent-hover': '#FF293E0A',
        '--on-light-surface-transparent-accent-active': '#FF293E29',
        ...
        '--inverse-surface-accent-hover': '#FF5263FF',
        '--inverse-surface-accent-active': '#FF142CFF',
        '--inverse-surface-accent-minor': '#4A0D13',
        '--inverse-surface-accent-minor-hover': '#64121AFF',
        '--inverse-surface-accent-minor-active': '#380A0FFF',
        '--inverse-surface-transparent-accent': '#FF293E33',
        '--inverse-surface-transparent-accent-hover': '#FF293E1F',
        '--inverse-surface-transparent-accent-active': '#FF293E3D',
        ...
        '--outline-accent': '#F31B31',
        '--outline-accent-hover': '#F54254FF',
        '--outline-accent-active': '#DA0B20FF',
        '--outline-accent-minor': '#FF8F9A',
        '--outline-accent-minor-hover': '#FFB8BFFF',
        '--outline-accent-minor-active': '#FF6675FF',
        '--outline-transparent-accent': '#F31B3133',
        '--outline-transparent-accent-hover': '#F31B31FF',
        '--outline-transparent-accent-active': '#F31B313D',
        ...
        '--on-dark-outline-accent-hover': '#FF6675FF',
        '--on-dark-outline-accent-active': '#FF142CFF',
        '--on-dark-outline-accent-minor': '#9C1422',
        '--on-dark-outline-accent-minor-hover': '#C2192AFF',
        '--on-dark-outline-accent-minor-active': '#7A101AFF',
        ...
        '--on-light-outline-accent-hover': '#F54254FF',
        '--on-light-outline-accent-active': '#DA0B20FF',
        '--on-light-outline-accent-minor': '#FF8F9A',
        '--on-light-outline-accent-minor-hover': '#FFB8BFFF',
        '--on-light-outline-accent-minor-active': '#FF6675FF',
        ...
        '--inverse-outline-accent': '#FF3D51',
        '--inverse-outline-accent-hover': '#FF6675FF',
        '--inverse-outline-accent-active': '#FF142CFF',
        '--inverse-outline-accent-minor': '#9C1422',
        '--inverse-outline-accent-minor-hover': '#C2192AFF',
        '--inverse-outline-accent-minor-active': '#7A101AFF',
        '--inverse-outline-transparent-accent': '#FF3D5147',
        '--inverse-outline-transparent-accent-hover': '#FF3D51FF',
        '--inverse-outline-transparent-accent-active': '#FF3D5156',
