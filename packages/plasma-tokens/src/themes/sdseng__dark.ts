...
export const sdseng__dark = {
    ':root': {
        ...
        '--inverse-text-tertiary': 'rgba(8, 8, 8, 0.4)',
        ...
        '--inverse-text-positive': '#108E25',
        '--inverse-text-warning': '#E85702',
        '--inverse-text-negative': '#F31B30',
        ...
        '--surface-transparent-default': '#FFFFFF',
        ...
        '--inverse-surface-solid-card': '#F7F7F7',
        '--inverse-surface-transparent-default': '#080808',
