...
export const sdds_serv_malachite__light = {
    ':root': {
...
/** @deprecated использовать вместо этого sdds_serv_malachite__light */
export const lightSdds_serv_malachite = sdds_serv_malachite__light;
