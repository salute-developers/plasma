...
export const asd__light = {
    ':root': {
        ...
        '--text-accent': '#FFFFFF',
        '--text-accent-gradient': 'linear-gradient(135deg, white 0%, #FFFFFF 100%)',
        ...
        '--text-transparent-accent-gradient': 'linear-gradient(135deg, white 0%, rgba(255, 255, 255, 0.12) 100%)',
        ...
        '--inverse-text-accent-gradient': 'linear-gradient(135deg, black 0%, #FFFFFF 100%)',
        ...
        '--surface-accent-gradient': 'linear-gradient(135deg, white 0%, #FFFFFF 100%)',
        ...
        '--surface-transparent-accent-gradient': 'linear-gradient(135deg, white 0%, rgba(255, 255, 255, 0.12) 100%)',
...
/** @deprecated использовать вместо этого asd__light */
export const lightAsd = asd__light;
