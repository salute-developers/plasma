...
export const sdds_cs__dark = {
    ':root': {
        ...
        '--outline-default-outline-solid-primary-hover': '#2C343AFF',
        '--outline-default-outline-solid-primary-active': '#1F2528FF',
        '--outline-default-outline-solid-secondary': '#30373C',
        '--outline-default-outline-solid-secondary-hover': '#394147FF',
        '--outline-default-outline-solid-secondary-active': '#2B3136FF',
        ...
        '--outline-default-outline-accent-hover': '#0DAF0DFF',
        '--outline-default-outline-accent-active': '#0B930BFF',
        '--outline-default-outline-positive': '#1A9E32',
        '--outline-default-outline-positive-hover': '#1DAF37FF',
        '--outline-default-outline-positive-active': '#18952FFF',
        ...
        '--outline-default-outline-info-hover': '#1798EEFF',
        '--outline-default-outline-info-active': '#1086D5FF',
        '--outline-on-dark-outline-solid-primary': '#23292D',
        '--outline-on-dark-outline-solid-primary-hover': '#2C343AFF',
        '--outline-on-dark-outline-solid-primary-active': '#1F2528FF',
        '--outline-on-dark-outline-solid-secondary': '#30373C',
        '--outline-on-dark-outline-solid-secondary-hover': '#394147FF',
        '--outline-on-dark-outline-solid-secondary-active': '#2B3136FF',
        ...
        '--outline-on-dark-outline-accent-active': '#0B930BFF',
        '--outline-on-dark-outline-positive': '#1A9E32',
        '--outline-on-dark-outline-positive-hover': '#1DAF37FF',
        '--outline-on-dark-outline-positive-active': '#18952FFF',
        ...
        '--outline-on-dark-outline-info-active': '#1086D5FF',
        '--outline-on-light-outline-solid-primary': '#D5DFE6',
        '--outline-on-light-outline-solid-primary-hover': '#E2E9EEFF',
        '--outline-on-light-outline-solid-primary-active': '#CFDAE2FF',
        '--outline-on-light-outline-solid-secondary': '#ADB9C2',
        '--outline-on-light-outline-solid-secondary-hover': '#B9C3CBFF',
        '--outline-on-light-outline-solid-secondary-active': '#A7B4BEFF',
        ...
        '--outline-on-light-outline-accent-hover': '#139613FF',
        '--outline-on-light-outline-accent-active': '#0F7B0FFF',
        ...
        '--outline-on-light-outline-info-hover': '#0C8ADFFF',
        '--outline-on-light-outline-info-active': '#0A78C2FF',
        '--outline-inverse-outline-solid-primary': '#D5DFE6',
        '--outline-inverse-outline-solid-primary-hover': '#E2E9EEFF',
        '--outline-inverse-outline-solid-primary-active': '#CFDAE2FF',
        '--outline-inverse-outline-solid-secondary': '#ADB9C2',
        '--outline-inverse-outline-solid-secondary-hover': '#B9C3CBFF',
        '--outline-inverse-outline-solid-secondary-active': '#A7B4BEFF',
        ...
        '--outline-inverse-outline-accent-hover': '#139613FF',
        '--outline-inverse-outline-accent-active': '#0F7B0FFF',
        '--outline-inverse-outline-positive': '#108E26',
        '--outline-inverse-outline-positive-hover': '#12A12AFF',
        '--outline-inverse-outline-positive-active': '#0F8523FF',
        '--outline-inverse-outline-negative': '#F31B31',
        '--outline-inverse-outline-negative-hover': '#F5384BFF',
        '--outline-inverse-outline-negative-active': '#F31228FF',
        '--outline-inverse-outline-info': '#0B7ECB',
        '--outline-inverse-outline-info-hover': '#0C8ADFFF',
        '--outline-inverse-outline-info-active': '#0A78C2FF',
