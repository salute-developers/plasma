...
export const salutejs_joy__light = {
    ':root': {
        ...
        '--plasma-colors-button-accent': '#AD42F5',
        ...
        '--plasma-colors-voice-phrase-gradient':
            'linear-gradient(45deg, hsla(30.167597765363123, 96.75675675675677%, 63.725490196078425%, 1) 0%, hsla(320.11560693641616, 100%, 66.07843137254902%, 1) 100%)',
        color: '#080808',
        backgroundColor: '#FFFFFF',
    },
};
/** @deprecated использовать вместо этого salutejs_joy__light */
export const lightJoy = salutejs_joy__light;
