...
export const sdds_serv__light = {
    ':root': {
        ...
        '--outline-on-dark-outline-accent-gradient-hover': '#525252FF',
        '--outline-on-dark-outline-accent-gradient-active': '#292929FF',
        ...
        '--outline-on-light-outline-accent-gradient': 'rgb(13, 133, 35) 0%,rgb(13, 168, 171) 100%)',
        ...
        '--outline-inverse-outline-accent-gradient': 'linear-gradient(45.00deg,rgb(26,158,50),rgb(4,198,201)99.688%)',
