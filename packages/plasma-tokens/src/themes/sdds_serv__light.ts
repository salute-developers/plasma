...
export const sdds_serv__light = {
    ':root': {
        ...
        '--syntax-default-syntax-yellow-hover': '#F8CB72FF',
        '--syntax-default-syntax-yellow-active': '#DA950BFF',
        '--syntax-default-syntax-orange-hover': '#B14B10FF',
        '--syntax-default-syntax-orange-active': '#5D2809FF',
        '--syntax-default-syntax-pink-hover': '#CB105BFF',
        '--syntax-default-syntax-pink-active': '#760A35FF',
        '--syntax-default-syntax-spring-hover': '#82C507FF',
        '--syntax-default-syntax-spring-active': '#486C04FF',
        '--syntax-default-syntax-sky-blue-hover': '#05B9EBFF',
        '--syntax-default-syntax-sky-blue-active': '#037291FF',
        '--syntax-default-syntax-red-hover': '#FF8F9AFF',
        '--syntax-default-syntax-red-active': '#FF142CFF',
        ...
        '--syntax-on-dark-syntax-yellow-hover': '#F7C45FFF',
        '--syntax-on-dark-syntax-yellow-active': '#DA950BFF',
        '--syntax-on-dark-syntax-orange': '#FFB38A',
        '--syntax-on-dark-syntax-orange-hover': '#FFE8DBFF',
        '--syntax-on-dark-syntax-orange-active': '#FF9F6BFF',
        '--syntax-on-dark-syntax-pink': '#FF4791',
        '--syntax-on-dark-syntax-pink-hover': '#FF99C2FF',
        '--syntax-on-dark-syntax-pink-active': '#FF297EFF',
        '--syntax-on-dark-syntax-spring': '#C5FC5F',
        '--syntax-on-dark-syntax-spring-hover': '#E2FDAFFF',
        '--syntax-on-dark-syntax-spring-active': '#BAFB41FF',
        '--syntax-on-dark-syntax-sky-blue': '#8AE6FF',
        '--syntax-on-dark-syntax-sky-blue-hover': '#DBF7FFFF',
        '--syntax-on-dark-syntax-sky-blue-active': '#6BDFFFFF',
        '--syntax-on-dark-syntax-red': '#FF8F9A',
        '--syntax-on-dark-syntax-red-hover': '#FFE0E3FF',
        '--syntax-on-dark-syntax-red-active': '#FF707EFF',
        '--syntax-on-light-syntax-yellow': '#F3A912',
        '--syntax-on-light-syntax-yellow-hover': '#F8CB72FF',
        '--syntax-on-light-syntax-yellow-active': '#DA950BFF',
        '--syntax-on-light-syntax-orange': '#85380C',
        '--syntax-on-light-syntax-orange-hover': '#B14B10FF',
        '--syntax-on-light-syntax-orange-active': '#5D2809FF',
        '--syntax-on-light-syntax-pink': '#9B0D46',
        '--syntax-on-light-syntax-pink-hover': '#CB105BFF',
        '--syntax-on-light-syntax-pink-active': '#760A35FF',
        '--syntax-on-light-syntax-spring': '#629405',
        '--syntax-on-light-syntax-spring-hover': '#82C507FF',
        '--syntax-on-light-syntax-spring-active': '#486C04FF',
        '--syntax-on-light-syntax-sky-blue': '#0492B9',
        '--syntax-on-light-syntax-sky-blue-hover': '#05B9EBFF',
        '--syntax-on-light-syntax-sky-blue-active': '#037291FF',
        '--syntax-on-light-syntax-red': '#FF3D51',
        '--syntax-on-light-syntax-red-hover': '#FF8F9AFF',
        '--syntax-on-light-syntax-red-active': '#FF142CFF',
        '--syntax-inverse-syntax-yellow': '#F3A912',
        '--syntax-inverse-syntax-yellow-hover': '#F7C45FFF',
        '--syntax-inverse-syntax-yellow-active': '#DA950BFF',
        '--syntax-inverse-syntax-orange-hover': '#FFE8DBFF',
        '--syntax-inverse-syntax-orange-active': '#FF9F6BFF',
        '--syntax-inverse-syntax-pink-hover': '#FF99C2FF',
        '--syntax-inverse-syntax-pink-active': '#FF297EFF',
        '--syntax-inverse-syntax-spring-hover': '#E2FDAFFF',
        '--syntax-inverse-syntax-spring-active': '#BAFB41FF',
        '--syntax-inverse-syntax-sky-blue-hover': '#DBF7FFFF',
        '--syntax-inverse-syntax-sky-blue-active': '#6BDFFFFF',
        '--syntax-inverse-syntax-red-hover': '#FFE0E3FF',
        '--syntax-inverse-syntax-red-active': '#FF707EFF',
