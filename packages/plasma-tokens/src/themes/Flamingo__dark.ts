...
export const Flamingo__dark = {
    ':root': {
        ...
        '--on-dark-overlay-soft': '#108210, #14CC98',
        ...
        '--text-transparent-accent-gradient': 'linear-gradient(135deg, black 0%, rgba(26, 158, 50, 0.12) 100%)',
        ...
        '--inverse-text-accent-gradient': 'linear-gradient(135deg, white 0%, #1A9E32 100%)',
        ...
        '--inverse-text-transparent-accent-gradient': 'linear-gradient(135deg, white 0%, rgba(26, 158, 50, 0.12) 100%)',
        ...
        '--surface-accent-gradient': 'linear-gradient(135deg, black 0%, #1A9E32 100%)',
        ...
        '--surface-transparent-accent-gradient': 'linear-gradient(135deg, black 0%, rgba(26, 158, 50, 0.12) 100%)',
        ...
        '--inverse-surface-accent-gradient': 'linear-gradient(135deg, white 0%, #1A9E32 100%)',
