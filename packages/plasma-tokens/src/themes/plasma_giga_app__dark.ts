...
export const plasma_giga_app__dark = {
    ':root': {
        ...
        '--outline-default-outline-primary-hover': '#303030FF',
        '--outline-default-outline-primary-active': '#212121FF',
        '--outline-default-outline-secondary-hover': '#595959FF',
        '--outline-default-outline-secondary-active': '#4A4A4AFF',
        '--outline-default-outline-tertiary-hover': '#7A7A7AFF',
        '--outline-default-outline-tertiary-active': '#6B6B6BFF',
        ...
        '--outline-default-outline-transparent-accent-hover': '#3F82FD66',
        '--outline-default-outline-transparent-accent-active': '#3F82FD38',
        ...
        '--outline-default-outline-transparent-positive-hover': '#1A9E3266',
        '--outline-default-outline-transparent-positive-active': '#1A9E3238',
        '--outline-default-outline-transparent-warning-hover': '#FA5F0566',
        '--outline-default-outline-transparent-warning-active': '#FA5F0538',
        '--outline-default-outline-negative-transparent-hover': '#CCCCCCFF',
        '--outline-default-outline-negative-transparent-active': '#E6E6E6FF',
        '--outline-default-outline-transparent-info-hover': '#3F82FD66',
        '--outline-default-outline-transparent-info-active': '#3F82FD38',
        ...
        '--outline-default-outline-transparent-negative-hover': '#F31B3152',
        '--outline-default-outline-transparent-negative-active': '#F31B3124',
        ...
        '--outline-on-dark-outline-primary-hover': '#303030FF',
        '--outline-on-dark-outline-primary-active': '#212121FF',
        '--outline-on-dark-outline-secondary-hover': '#595959FF',
        '--outline-on-dark-outline-secondary-active': '#4A4A4AFF',
        '--outline-on-dark-outline-tertiary-hover': '#7A7A7AFF',
        '--outline-on-dark-outline-tertiary-active': '#6B6B6BFF',
        ...
        '--outline-on-dark-outline-transparent-accent-hover': '#3F82FD66',
        '--outline-on-dark-outline-transparent-accent-active': '#3F82FD38',
        ...
        '--outline-on-dark-outline-transparent-positive-hover': '#1A9E3266',
        '--outline-on-dark-outline-transparent-positive-active': '#1A9E3238',
        '--outline-on-dark-outline-transparent-warning-hover': '#FA5F0566',
        '--outline-on-dark-outline-transparent-warning-active': '#FA5F0538',
        '--outline-on-dark-outline-negative-transparent-hover': '#FF293E66',
        '--outline-on-dark-outline-negative-transparent-active': '#FF293E38',
        '--outline-on-dark-outline-transparent-info-hover': '#3F82FD66',
        '--outline-on-dark-outline-transparent-info-active': '#3F82FD38',
        ...
        '--outline-on-light-outline-primary-hover': '#E8E8E8FF',
        '--outline-on-light-outline-primary-active': '#D9D9D9FF',
        '--outline-on-light-outline-secondary-hover': '#9E9E9EFF',
        '--outline-on-light-outline-secondary-active': '#8F8F8FFF',
        '--outline-on-light-outline-tertiary-hover': '#7A7A7AFF',
        '--outline-on-light-outline-tertiary-active': '#6B6B6BFF',
        ...
        '--outline-on-light-outline-positive-hover': '#1DAF37FF',
        '--outline-on-light-outline-positive-active': '#18952FFF',
        '--outline-on-light-outline-warning': '#FA5F05',
        '--outline-on-light-outline-warning-hover': '#FB7223FF',
        '--outline-on-light-outline-warning-active': '#F05B05FF',
        ...
        '--outline-on-light-outline-info-hover': '#5D95FDFF',
        '--outline-on-light-outline-info-active': '#357BFDFF',
        ...
        '--outline-on-light-outline-transparent-positive-hover': '#1A9E3252',
        '--outline-on-light-outline-transparent-positive-active': '#1A9E3224',
        ...
        '--outline-on-light-outline-negative-transparent-hover': '#F31B3152',
        '--outline-on-light-outline-negative-transparent-active': '#F31B3124',
        ...
        '--outline-inverse-outline-primary-hover': '#ABABABFF',
        '--outline-inverse-outline-primary-active': '#C4C4C4FF',
        '--outline-inverse-outline-secondary-hover': '#FFFFFFFF',
        '--outline-inverse-outline-secondary-active': '#575757FF',
        '--outline-inverse-outline-tertiary-hover': '#FFFFFFFF',
        '--outline-inverse-outline-tertiary-active': '#737373FF',
        ...
        '--outline-inverse-outline-accent': '#2A72F8',
        '--outline-inverse-outline-accent-hover': '#79A7FBFF',
        '--outline-inverse-outline-accent-active': '#0D5FF8FF',
        '--outline-inverse-outline-accent-minor': '#8BB2FC',
        '--outline-inverse-outline-accent-minor-hover': '#DCE8FEFF',
        '--outline-inverse-outline-accent-minor-active': '#6FA0FBFF',
        '--outline-inverse-outline-transparent-accent': 'rgba(42,114,248,0.20)',
        '--outline-inverse-outline-transparent-accent-hover': '#2A72F8FF',
        '--outline-inverse-outline-transparent-accent-active': '#2A72F83D',
        ...
        '--outline-inverse-outline-transparent-negative': 'rgba(243,27,49,0.20)',
