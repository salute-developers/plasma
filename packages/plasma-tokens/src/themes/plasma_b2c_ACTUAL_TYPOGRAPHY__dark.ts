...
export const plasma_b2c_ACTUAL_TYPOGRAPHY__dark = {
    ':root': {
...
/** @deprecated использовать вместо этого plasma_b2c_ACTUAL_TYPOGRAPHY__dark */
export const darkPlasma_b2c_ACTUAL_TYPOGRAPHY = plasma_b2c_ACTUAL_TYPOGRAPHY__dark;
