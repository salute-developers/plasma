...
export const biggus_dickus__dark = {
    ':root': {
        ...
        '--outline-default-outline-transparent-accent': '#199AF047',
        ...
        '--outline-inverse-outline-transparent-accent': '#0B7ECB33',
...
/** @deprecated использовать вместо этого biggus_dickus__dark */
export const darkBiggus_dickus = biggus_dickus__dark;
