...
export const sdds_procom__light = {
    ':root': {
        ...
        '--outline-accent': '#0A8A66',
        '--outline-accent-hover': '#10D59EFF',
        '--outline-accent-active': '#0DAF82FF',
        '--outline-accent-minor': '#14CC98',
        '--outline-accent-minor-hover': '#20E9B0FF',
        '--outline-accent-minor-active': '#11A77CFF',
        '--outline-transparent-accent': '#0A8A6633',
        '--outline-transparent-accent-hover': '#0A8A66FF',
        '--outline-transparent-accent-active': '#0A8A663D',
        ...
        '--on-dark-outline-accent-hover': '#00D69AFF',
        '--on-dark-outline-accent-active': '#00855FFF',
        ...
        '--on-light-outline-accent-hover': '#10D59EFF',
        '--on-light-outline-accent-active': '#0DAF82FF',
        ...
        '--inverse-outline-accent': '#00AC7B',
        '--inverse-outline-accent-hover': '#00D69AFF',
        ...
        '--inverse-outline-transparent-accent': '#00AC7B47',
        '--inverse-outline-transparent-accent-hover': '#00AD7CFF',
        '--inverse-outline-transparent-accent-active': '#00AD7C56',
