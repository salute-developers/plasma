...
export const sdds_serv_malachite__dark = {
    ':root': {
...
/** @deprecated использовать вместо этого sdds_serv_malachite__dark */
export const darkSdds_serv_malachite = sdds_serv_malachite__dark;
