...
export const sdds_bizcom__light = {
    ':root': {
        ...
        '--inverse-text-positive': '#28D247',
        '--inverse-text-positive-hover': '#47DC62FF',
        '--inverse-text-positive-active': '#21B03CFF',
        '--inverse-text-warning': '#FD9C68',
        '--inverse-text-warning-hover': '#FDB790FF',
        '--inverse-text-warning-active': '#FC8240FF',
        '--inverse-text-negative': '#FF8F9A',
        '--inverse-text-negative-hover': '#FFB8BFFF',
        '--inverse-text-negative-active': '#FF6675FF',
        '--inverse-text-info': '#52BAFF',
        '--inverse-text-info-hover': '#7ACAFFFF',
        '--inverse-text-info-active': '#29A9FFFF',
