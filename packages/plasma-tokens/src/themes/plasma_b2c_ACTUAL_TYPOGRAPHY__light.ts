...
export const plasma_b2c_ACTUAL_TYPOGRAPHY__light = {
    ':root': {
...
/** @deprecated использовать вместо этого plasma_b2c_ACTUAL_TYPOGRAPHY__light */
export const lightPlasma_b2c_ACTUAL_TYPOGRAPHY = plasma_b2c_ACTUAL_TYPOGRAPHY__light;
