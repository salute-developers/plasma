...
export const sdds_serv__dark = {
    ':root': {
        ...
        '--outline-inverse-outline-transparent-primary-hover': '#0808083D',
        '--outline-inverse-outline-transparent-primary-active': '#0808080F',
        '--outline-inverse-outline-transparent-secondary-hover': '#08080866',
        '--outline-inverse-outline-transparent-secondary-active': '#08080838',
        '--outline-inverse-outline-transparent-tertiary-hover': '#080808AD',
        '--outline-inverse-outline-transparent-tertiary-active': '#08080880',
        ...
        '--outline-inverse-outline-accent-gradient':
            'linear-gradient(45.00deg, rgb(13, 133, 35) 0%, rgb(13, 168, 171) 100%)',
        '--outline-inverse-outline-transparent-primary': 'rgba(8,8,8,0.12)',
        '--outline-inverse-outline-transparent-secondary': 'rgba(8,8,8,0.28)',
