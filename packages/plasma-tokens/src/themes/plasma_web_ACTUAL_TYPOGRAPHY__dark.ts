...
export const plasma_web_ACTUAL_TYPOGRAPHY__dark = {
    ':root': {
        ...
        '--outline-read-only': 'rgba(255, 255, 255, 0.12)',
        '--outline-read-only-hover': 'rgba(255, 255, 255, 0.3)',
        '--outline-read-only-active': 'rgba(255, 255, 255, 0.07)',
        ...
        '--inverse-outline-transparent-positive': 'rgba(16,142,38,0.20)',
        '--inverse-outline-transparent-warning': 'rgba(232,87,2,0.20)',
        ...
        '--inverse-outline-read-only': 'rgba(8, 8, 8, 0.1)',
        '--inverse-outline-read-only-hover': 'rgba(8, 8, 8, 0.3)',
        '--inverse-outline-read-only-active': 'rgba(8, 8, 8, 0.2)',
...
/** @deprecated использовать вместо этого plasma_web_ACTUAL_TYPOGRAPHY__dark */
export const darkPlasma_web_ACTUAL_TYPOGRAPHY = plasma_web_ACTUAL_TYPOGRAPHY__dark;
