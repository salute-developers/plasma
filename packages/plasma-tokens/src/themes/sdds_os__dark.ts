...
export const sdds_os__dark = {
    ':root': {
        '--text-primary-hover': '#B8BFE5FF',
        '--text-primary-active': '#A9B1E0FF',
        '--text-primary-brightness': '#FFFFFFFF',
        '--text-secondary-hover': '#FFFFFFFF',
        '--text-secondary-active': '#737A96FF',
        '--text-tertiary-hover': '#CDCFD5FF',
        '--text-tertiary-active': '#545863FF',
        '--text-paragraph-hover': '#C2CAE0FF',
        '--text-paragraph-active': '#B4BED9FF',
        '--text-accent-hover': '#5EDE76FF',
        '--text-accent-active': '#1F9835FF',
        '--text-accent-minor-hover': '#0F9527FF',
        '--text-accent-minor-active': '#074A14FF',
        ...
        '--text-info-minor-hover': '#1C62E3FF',
        '--text-info-minor-active': '#13429AFF',
        '--text-positive-minor': '#095C18',
        '--text-negative-minor': '#9C1422',
        '--text-warning-minor': '#85380C',
        '--text-primary': '#F4F5FB',
        '--text-secondary': '#AEB2C2',
        '--text-tertiary': '#6C707F',
        '--text-paragraph': '#F7F8FB',
        '--text-accent': '#24B23E',
        '--text-accent-minor': '#095C18',
        '--text-info': '#528EFF',
        '--text-info-minor': '#1549AB',
        '--on-dark-text-primary-hover': '#B8BFE5FF',
        '--on-dark-text-primary-active': '#A9B1E0FF',
        '--on-dark-text-primary-brightness': '#FFFFFFFF',
        '--on-dark-text-secondary-hover': '#FFFFFFFF',
        '--on-dark-text-secondary-active': '#737A96FF',
        '--on-dark-text-tertiary-hover': '#CDCFD5FF',
        '--on-dark-text-tertiary-active': '#545863FF',
        '--on-dark-text-paragraph-hover': '#C2CAE0FF',
        '--on-dark-text-paragraph-active': '#B4BED9FF',
        ...
        '--on-dark-text-primary': '#F4F5FB',
        '--on-dark-text-secondary': '#AEB2C2',
        '--on-dark-text-tertiary': '#6C707F',
        '--on-dark-text-paragraph': '#F7F8FB',
