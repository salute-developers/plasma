...
export const accent = '#296AE3';

/** Акцентный цвет у контролов */
export const buttonAccent = '#2A72F8';

/** Цвет рамки фокуса у контрола */
export const buttonFocused = '#080808';

/** Градиент для заливки основного фона */
export const gradient = '#F5F5F5';

/** Градиент для заливки основного фона */
export const gradientDevice = '#F5F5F5';

/** Градиент подсказок о голосовых запросах */
export const voicePhraseGradient =
    'linear-gradient(45deg, hsla(220.1123595505618, 85.57692307692307%, 59.21568627450981%, 1) 0%, hsla(189.78947368421052, 78.51239669421487%, 52.54901960784314%, 1) 100%)';
