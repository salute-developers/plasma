...
import { withTheme, CALDERA_LIGHT_THEME, CALDERA_DARK_THEME } from './decoratorThemes';
...
const preview: Preview = {
    ...
    globalTypes: {
        theme: {
            ...
            defaultValue: CALDERA_LIGHT_THEME,
            toolbar: {
                title: 'Theme',
                items: [CALDERA_LIGHT_THEME, CALDERA_DARK_THEME],
            },
        },
        typoVersion: {
