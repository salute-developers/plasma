import { dateTimePickerTokens as dateTimePickerTokensBase, css } from '@salutejs/plasma-new-hope/styled-components';
import {
    /*
     * NOTE: Mixed DS tokens + raw vars. Prefer @salutejs-ds/sdds_sbcom/theme/tokens where possible.
     * Missing tokens in @salutejs/sdds-themes/tokens: bodyM, bodyMBold, bodyXs, bodyXsBold, h4, h4Bold, h5, h5Bold
     * surfaceAccent, surfaceTransparentNegative, surfaceTransparentNegativeActive, surfaceTransparentPositive
...
/*
 * `dateTimePickerTokens` from `@salutejs/plasma-new-hope/css` can lag source:
 * merge CSS variable names from plasma-new-hope DateTimePicker.tokens.
 * and add new keys to the `dateTimePickerTokens` object.
 * TODO: remove fallbacks when published `dateTimePickerTokens` includes these keys.
 */
const dateTimePickerTokenFallbacks = {
...
const tokens = { ...dateTimePickerTokensBase, ...dateTimePickerTokenFallbacks };
