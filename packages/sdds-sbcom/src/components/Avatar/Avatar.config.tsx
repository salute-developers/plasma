import { avatarTokens as tokens, css } from '@salutejs/plasma-new-hope/styled-components';
import {
    /*
     * NOTE: Mixed DS tokens + raw vars. Prefer @salutejs-ds/sdds_sbcom/theme/tokens where possible.
     * Missing tokens in @salutejs/sdds-themes/tokens: bodyXxs, surfaceAccent, surfaceTransparentNegative
     * surfaceTransparentPositive, surfaceTransparentWarning, text, textAccentGradient
     */
    bodyS,
    inverseTextPrimary,
...
export const config = {
    ...
    variations: {
        view: {
            default: css`
                /* NOTE: no token textAccentGradient in @salutejs/sdds-themes/tokens */
                ...
                /* NOTE: no token text in @salutejs/sdds-themes/tokens */
