...
export const SDDS_SBCOM_LIGHT_THEME = 'sdds-sbcom:light';
export const SDDS_SBCOM_DARK_THEME = 'sdds-sbcom:dark';
export const DEFAULT_MODE = 'default';
export const ON_DARK_MODE = 'onDark';
export const ON_LIGHT_MODE = 'onLight';

const themes = {
    [SDDS_SBCOM_LIGHT_THEME]: createGlobalStyle(sdds_sbcom__light),
    [SDDS_SBCOM_DARK_THEME]: createGlobalStyle(sdds_sbcom__dark),
};
