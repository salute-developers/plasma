...
import {
    withTheme,
    SDDS_SBCOM_LIGHT_THEME,
    SDDS_SBCOM_DARK_THEME,
    DEFAULT_MODE,
    ON_DARK_MODE,
    ON_LIGHT_MODE,
...
const preview: Preview = {
    ...
    globalTypes: {
        theme: {
            ...
            defaultValue: SDDS_SBCOM_LIGHT_THEME,
            toolbar: {
                title: 'Theme',
                items: [SDDS_SBCOM_LIGHT_THEME, SDDS_SBCOM_DARK_THEME],
            },
        },
        viewContainer: {
