...
const ExampleButton = (props: ComponentProps<typeof Button>) => (
    <Button {...props} view="clear" contentType="Left" contentLeft={<IconEdit />} />
);
    ...
    it('simple', () => {
        mount(
            <CypressTestDecoratorWithTypo>
                ...
                {sizes.map((size) => (
                    <>
                        <Toolbar size={size} placement="horizontal">
                            <ExampleButton size={size} />
                            <ExampleButton size={size} />
                            <ExampleButton size={size} />
                        </Toolbar>
    ...
    it('without shadow', () => {
        mount(
            <CypressTestDecoratorWithTypo>
                ...
                {sizes.map((size) => (
                    <>
                        <Toolbar size={size} hasShadow={false} placement="horizontal">
                            <ExampleButton size={size} />
                            <ExampleButton size={size} />
                            <ExampleButton size={size} />
                        </Toolbar>
