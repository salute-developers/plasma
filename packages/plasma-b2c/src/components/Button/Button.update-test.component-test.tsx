...
describe('plasma-b2c: Button', () => {
    ...
    it('[PLASMA-T874] Button: view=dark, isLoading', () => {
        mount(
            <CypressTestDecorator>
                <Button text="Button_view_dark_isLoading" view="dark" isLoading />
            </CypressTestDecorator>,
        );
        cy.matchImageSnapshot();
    });

    it('[PLASMA-T875] Button: view=light', () => {
        mount(
            <CypressTestDecorator>
                <Button text="Button_view_light" view="light" />
            </CypressTestDecorator>,
        );
        cy.matchImageSnapshot();
    });
    ...
    it('[PLASMA-T1013] Button: enableContentLeft=true, enableContentRight=true', () => {
        mount(
            <CypressTestDecorator>
    ...
    it('[PLASMA-T1014] Button: square, enableContentLeft=true', () => {
        mount(
            <CypressTestDecorator>
                <Button text="Button_square_contentLeft" square contentLeft={<Icon />} />
            </CypressTestDecorator>,
        );
        cy.matchImageSnapshot();
    });

    it('[PLASMA-T1015] Button: square, enableContentRight=true', () => {
        mount(
            <CypressTestDecorator>
                <Button text="Button_square_contentRight" square contentRight={<Icon />} />
            </CypressTestDecorator>,
        );
        cy.matchImageSnapshot();
    });
