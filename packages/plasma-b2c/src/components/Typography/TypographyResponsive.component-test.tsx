...
describe('plasma-core: ResponsiveTypography', () => {
    ...
    const dspl = (
        <CypressTestDecorator>
            <DsplL>DsplL</DsplL>
            <DsplL bold breakWord>
                DsplL Semibold
            </DsplL>
            <DsplM>DsplM</DsplM>
            <DsplM bold>DsplM Semibold</DsplM>
            <DsplS>DsplS</DsplS>
            <DsplS bold>DsplS Semibold</DsplS>
        </CypressTestDecorator>
    );
    const headings = (
        <CypressTestDecorator>
            <H1>H1</H1>
            <H1 bold>H1 Semibold</H1>
            <H2>H2</H2>
            <H2 bold>H2 Semibold</H2>
            <H3>H3</H3>
            <H3 bold>H3 Semibold</H3>
            <H4>H4</H4>
            <H4 bold>H4 Semibold</H4>
            <H5>H5</H5>
            <H5 bold>H5 Semibold</H5>
        </CypressTestDecorator>
    );
    const text = (
        <CypressTestDecorator>
