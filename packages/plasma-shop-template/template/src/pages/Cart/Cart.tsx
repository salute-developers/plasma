...
import { CartPage, EmptyCart, useAssistantOnSmartAppData, useCart } from '@salutejs/plasma-temple';

import { ActionType, AssistantDataAction, PageComponentProps, ServerAction, ServerActionType } from '../../types';
import { useAssistantState } from '../../hooks/useAssistantState';

export const Cart: React.FC<PageComponentProps<'cart'>> = ({ assistant, name, header, pushScreen }) => {
