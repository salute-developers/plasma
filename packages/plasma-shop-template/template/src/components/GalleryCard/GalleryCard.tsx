...
import { CardPrice, CardBody2, CardContent, CardBadge, Card, CardBody, CardMedia } from '@salutejs/plasma-ui';
import { GalleryCardProps, getMediaObjectSrc } from '@salutejs/plasma-temple';
