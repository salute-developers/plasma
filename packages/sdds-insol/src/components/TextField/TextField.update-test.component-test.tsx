...
import { TextField as TextFieldINSOL } from '.';

describe('sdds-insol: TextField', () => {
    const TextField = getComponent('TextField') as typeof TextFieldINSOL;
    ...
    it('[PLASMA-T1575] TextField: hintTrigger=click, hintHasArrow=false', () => {
        ...
        cy.matchImageSnapshot('sdds-insol TextField -- [PLASMA-T1575] TextField mouseover on hint icon');
    ...
    it('[PLASMA- ] TextField: truncate placeholder', () => {
        mount(
            <CypressTestDecorator>
