    ...
    variations: {
        size: {
            xs: css`
                ...
                ${textAreaTokens.inputPaddingRightWithRightContent}: 2.375rem;
                ...
                ${textAreaTokens.helpersPaddingBottom}: 0.5rem;
                ${textAreaTokens.helpersPaddingLeft}: 0.75rem;
                ...
                ${textAreaTokens.indicatorLabelPlacementOuterRight}: 0.125rem -0.625rem auto auto;
                ${textAreaTokens.indicatorLabelPlacementHintOuterRight}: -0.375rem;
            ...
            s: css`
                ...
                ${textAreaTokens.inputPaddingTop}: 0.813rem;
                ${textAreaTokens.inputPaddingRight}: 0.75rem;
                ${textAreaTokens.inputPaddingRightWithRightContent}: 2.5rem;
                ...
                ${textAreaTokens.helpersPaddingLeft}: 0.75rem;
                ${textAreaTokens.helpersOffset}: 0rem;
                ${textAreaTokens.rightContentTop}: 0.75rem;
                ${textAreaTokens.rightContentRight}: 0.75rem;
                ${textAreaTokens.rightContentHeight}: 1rem;
                ...
                ${textAreaTokens.labelInnerTopHelper}: 0.063rem;
                ...
                ${textAreaTokens.indicatorSizeOuter}: 0.375rem;
                ${textAreaTokens.indicatorLabelPlacementInner}: 0 0 0 0;
                ${textAreaTokens.indicatorLabelPlacementOuter}: 0.25rem auto auto -0.675rem;
                ${textAreaTokens.indicatorLabelPlacementInnerRight}: 0 0 auto auto;
                ${textAreaTokens.indicatorLabelPlacementOuterRight}: 0.125rem -0.625rem auto auto;
                ...
                ${textAreaTokens.hintCustomIconTargetSize}: 1rem;
                ${textAreaTokens.hintMargin}: -0.688rem -0.5rem;
                ${textAreaTokens.hintTargetSize}: 2.375rem;
                ${textAreaTokens.hintInnerLabelPlacementOffset}: 0.062rem -2.188rem auto auto;
                ${textAreaTokens.clearHintInnerLabelPlacementOffset}: 0.062rem -1.938rem auto auto;
                ${textAreaTokens.clearIndicatorHintInnerRight}: 1.063rem -1.988rem auto auto;
            ...
            m: css`
                ...
                ${textAreaTokens.inputPaddingTop}: 1.188rem;
                ${textAreaTokens.inputPaddingRight}: 1rem;
                ${textAreaTokens.inputPaddingRightWithRightContent}: 3rem;
                ...
                ${textAreaTokens.helpersPaddingBottom}: 0.875rem;
                ...
                ${textAreaTokens.labelInnerLetterSpacing}: var(--plasma-typo-body-xxs-letter-spacing);
                ${textAreaTokens.labelInnerLineHeight}: var(--plasma-typo-body-xxs-line-height);
                ${textAreaTokens.labelInnerTop}: 0.5rem;
            ...
            l: css`
                ...
                ${textAreaTokens.helpersOffset}: 0rem;
                ${textAreaTokens.rightContentTop}: 1rem;
                ${textAreaTokens.rightContentRight}: 1.125rem;
                ...
                ${textAreaTokens.labelInnerMarginBottom}: 0.313rem;
        ...
        view: {
            default: css`
                ${textAreaTokens.borderColor}: var(--outline-clear);
                ${textAreaTokens.borderColorFocus}: var(--outline-solid-secondary);
                ${textAreaTokens.borderColorHover}: var(--outline-clear);
                ...
                ${textAreaTokens.boxShadow}: var(--shadow-down-soft-s);
            `,
            warning: css`
        ...
        disabled: {
            true: css`
                ...
                ${textAreaTokens.boxShadow}: inset 0 0 0 0 transparent;
            `,
        },
        readOnly: {
            true: css`
