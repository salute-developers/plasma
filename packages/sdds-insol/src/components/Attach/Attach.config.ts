    ...
    variations: {
        ...
        size: {
            l: css`
                ...
                ${attachTokens.filenameDropdownWrapperHeight}: 2.375rem;
                ...
                ${attachTokens.dropdownItemPadding}: 0.563rem 1rem;
            `,
            m: css`
                ...
                ${attachTokens.dropdownPadding}: 0.125rem;
                ${attachTokens.dropdownItemPadding}: 0.4375rem 0.875rem;
            `,
            s: css`
                ...
                ${attachTokens.dropdownPadding}: 0.125rem;
                ${attachTokens.dropdownItemPadding}: 0.188rem 0.625rem;
            `,
            xs: css`
                ...
                ${attachTokens.dropdownPadding}: 0.125rem;
                ${attachTokens.dropdownItemPadding}: 0 0.5rem;
            `,
        },
    },
};
