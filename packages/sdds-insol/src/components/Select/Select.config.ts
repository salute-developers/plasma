    ...
    variations: {
        view: {
            default: css`
                ...
                ${tokens.textFieldBoxShadow}: inset 0 0 0 transparent;
        ...
        chipView: {
            default: css`
                ...
                ${tokens.textFieldChipBackground}: var(--surface-transparent-default);
                ${tokens.textFieldChipBackgroundHover}: var(--surface-transparent-default-hover);
