...
import { CodeField as CodeFieldINSOL } from '.';

describe('sdds-insol: CodeField', () => {
    const CodeField = getComponent('CodeField') as typeof CodeFieldINSOL;
    ...
    describe(':itemErrorBehavior', () => {
        const Demo = ({
            ...
            itemErrorBehavior: ComponentProps<typeof CodeFieldINSOL>['itemErrorBehavior'];
        }) => {
    ...
    describe(':codeErrorBehavior', () => {
        const Demo = ({
            ...
            codeErrorBehavior: ComponentProps<typeof CodeFieldINSOL>['codeErrorBehavior'];
        }) => {
