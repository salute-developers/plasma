...
import { CalendarDouble as CalendarDoubleINSOL, CalendarBase as CalendarBaseINSOL } from './Calendar';
...
describe('sdds-insol: Calendar', () => {
    const CalendarBase = getComponent('CalendarBase') as typeof CalendarBaseINSOL;
    const CalendarDouble = getComponent('CalendarDouble') as typeof CalendarDoubleINSOL;
