    ...
    variations: {
        view: {
            default: css`
                ...
                ${tokens.textFieldContentSlotColorHover}: ${textPrimaryHover};
                ${tokens.textFieldContentSlotColorActive}: ${textPrimaryActive};
                ...
                ${tokens.textFieldBackgroundErrorColor}: ${surfaceTransparentCard};
                ${tokens.textFieldBackgroundErrorColorFocus}: ${surfaceClear};
                ${tokens.textFieldColorSuccess}: ${textPositive};
                ${tokens.textFieldBackgroundSuccessColor}: ${surfaceTransparentCard};
                ${tokens.textFieldBackgroundSuccessColorFocus}: ${surfaceClear};
        ...
        size: {
            xl: css`
                ...
                ${tokens.calendarYearSelectedFontWeight}: ${bodyM.fontWeight};
                ...
                ${tokens.calendarMonthSelectedFontWeight}: ${bodyM.fontWeight};
                ...
                ${tokens.calendarQuarterSelectedFontWeight}: ${bodyM.fontWeight};
                ...
                ${tokens.calendarDaySelectedFontWeight}: ${bodyM.fontWeight};
            ...
            l: css`
                ...
                ${tokens.calendarYearSelectedFontWeight}: ${bodyS.fontWeight};
                ...
                ${tokens.calendarMonthSelectedFontWeight}: ${bodyS.fontWeight};
                ...
                ${tokens.calendarQuarterSelectedFontWeight}: ${bodyS.fontWeight};
                ...
                ${tokens.calendarDaySelectedFontWeight}: ${bodyS.fontWeight};
            ...
            m: css`
                ...
                ${tokens.calendarYearSelectedFontWeight}: ${bodyXS.fontWeight};
                ...
                ${tokens.calendarQuarterSelectedFontWeight}: ${bodyXS.fontWeight};
                ...
                ${tokens.calendarMonthSelectedFontWeight}: ${bodyXS.fontWeight};
                ...
                ${tokens.calendarDaySelectedFontWeight}: ${bodyXS.fontWeight};
