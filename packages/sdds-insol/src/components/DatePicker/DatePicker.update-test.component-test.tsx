...
import { DatePicker as DatePickerINSOL, DatePickerRange as DatePickerRangeINSOL } from '.';

type DatePickerProps = ComponentProps<typeof DatePickerINSOL> & {
    enableContentLeft?: boolean;
    enableContentRight?: boolean;
};

type DatePickerRangeProps = ComponentProps<typeof DatePickerRangeINSOL> & {
    enableContentLeft?: boolean;
    enableContentRight?: boolean;
...
describe('sdds-insol: DatePicker', () => {
    const DatePicker = getComponent('DatePicker') as typeof DatePickerINSOL;
...
describe('sdds-insol: DatePickerRange', () => {
    const DatePickerRange = getComponent('DatePickerRange') as typeof DatePickerRangeINSOL;
