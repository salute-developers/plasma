    ...
    variations: {
        ...
        view: {
            accent: css`
                ...
                ${checkboxTokens.triggerBorderColor}: ${outlineTransparentSecondary};
                ${checkboxTokens.triggerBorderCheckedColor}: ${surfaceAccent};
            `,
            negative: css`
                ...
                ${checkboxTokens.triggerBorderCheckedColor}: ${surfaceNegative};
            `,
        },
        disabled: {
            true: css`
