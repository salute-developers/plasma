...
export const tokens = {
    ...
    textFieldChipPaddingTop: '--plasma-select-textfield-chip-padding-top',
    textFieldChipPaddingRight: '--plasma-select-textfield-chip-padding-right',
    textFieldChipPaddingBottom: '--plasma-select-textfield-chip-padding-bottom',
    textFieldChipPaddingLeft: '--plasma-select-textfield-chip-padding-left',
