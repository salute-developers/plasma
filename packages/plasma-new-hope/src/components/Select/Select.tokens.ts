...
export const tokens = {
    ...
    textFieldHelpersPadding: '--plasma-select-textfield-helpers-padding',

    textFieldHelpersFontFamily: '--plasma-select-textfield-helpers-font-family',
    textFieldHelpersFontStyle: '--plasma-select-textfield-helpers-font-style',
    textFieldHelpersFontSize: '--plasma-select-textfield-helpers-font-size',
    textFieldHelpersFontWeight: '--plasma-select-textfield-helpers-font-weight',
    textFieldHelpersLetterSpacing: '--plasma-select-textfield-helpers-letter-spacing',
    textFieldHelpersLineHeight: '--plasma-select-textfield-helpers-line-height',
