...
export type BaseFileProps = {
     ...
     */
    fileContainerWidth?: number | string;
    /**
     * Растянуть поле компонент на всю доступную ширину
     */
    stretched?: boolean;
    /**
    ...
    /**
     * Функция вызываемая при при клике на
     */
    onActionClick?: (event: MouseEvent<HTMLDivElement>) => void;
};

export type FileProps = HTMLAttributes<HTMLDivElement> & BaseFileProps;
export type FileRootProps = Omit<FileProps, 'filename'>;
