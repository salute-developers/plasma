...
export const handleCodeError = ({
    ...
    switch (codeErrorBehavior) {
        case 'keep':
            inputContainerRef.current.classList.add(classes.codeError);
            ...
            setTimeout(() => {
                ...
                inputContainerRef.current?.classList.remove(classes.codeError);
        ...
        case 'remove-code':
        default:
            inputContainerRef.current.classList.add(classes.codeError, classes.codeErrorFade);
            captionRef.current?.classList.add(classes.captionError);
            ...
            setTimeout(() => {
                ...
                inputContainerRef.current?.classList.remove(classes.codeError, classes.codeErrorFade);
            }, ANIMATION_TIMEOUT);
    }
};
