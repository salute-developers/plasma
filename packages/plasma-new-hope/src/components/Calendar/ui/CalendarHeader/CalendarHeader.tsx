...
import { getCalendarType, MONTH_NAMES, YEAR_RENDER_COUNT, ARIA_LABELS } from '../../utils';
...
export const CalendarHeader: React.FC<CalendarHeaderProps> = ({
    ...
    const PreviousButton = () => (
        <StyledArrow
            ...
            aria-label={`${ARIA_LABELS.previous[locale]} ${currentCalendarType}`}
            onClick={handlePrev}
        >
    ...
    const NextButton = () => (
        <StyledArrow aria-label={`${ARIA_LABELS.next[locale]} ${currentCalendarType}`} onClick={handleNext}>
