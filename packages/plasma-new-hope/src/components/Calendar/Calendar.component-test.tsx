...
describeFn('Calendar', () => {
    const CalendarBase = componentExists ? getComponent('CalendarBase') : () => null;
    const CalendarDouble = componentExists ? getComponent('CalendarDouble') : () => null;
...
describeFn('Calendar keyboard navigation', () => {
    const CalendarBase = componentExists ? getComponent('CalendarBase') : () => null;
    const CalendarDouble = componentExists ? getComponent('CalendarDouble') : () => null;
    ...
    const Demo = (args) => {
        ...
        const disabledDates = disabledListArg?.length ? disabledListArg : disabledDays;
