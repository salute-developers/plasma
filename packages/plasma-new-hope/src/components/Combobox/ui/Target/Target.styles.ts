...
export const StyledTextField = styled(TextField)<{ opened: boolean }>`
    ...
    ${textFieldTokens.titleCaptionOffset}: var(${comboboxTokens.textFieldTitleCaptionOffset});
    ...
    ${textFieldTokens.chipCloseIconColorReadonly}: var(${comboboxTokens.textFieldChipCloseIconColorReadonly});
