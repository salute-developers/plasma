...
describeFn('Combobox', () => {
    ...
    const ComboboxGroup = (props: any) => {
        ...
        return (
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 2fr', gap: '30px' }}>
                <Combobox items={items} label="Label" placeholder="Placeholder" helperText="Helper text" {...props} />
    ...
    it('variant', () => {
        ...
        mount(
            <>
                <Combobox variant="tight" items={items} label="Label" placeholder="Placeholder" alwaysOpened />
            </>,
        );
        ...
        mount(
            ...
            >
                ...
                <div style={{ width: '200px', padding: '20px 300px 20px 0', boxSizing: 'content-box' }}>
                    <Combobox placement="right" alwaysOpened items={placementItems} label="Label" placeholder="Right" />
                </div>
                ...
                <div style={{ width: '200px', padding: '20px 0 20px 300px', boxSizing: 'content-box' }}>
                    <Combobox placement="left" alwaysOpened items={placementItems} label="Label" placeholder="Left" />
                </div>
    ...
    it('listMaxHeight with long list', () => {
        cy.viewport(1000, 500);
    ...
    it('virtual', () => {
        ...
        mount(
            <div style={{ display: 'grid', gap: '20px', gridTemplateColumns: 'repeat(3, 400px)' }}>
    ...
    it('onChange + renderValue + multiple + async items change', () => {
        ...
        const Component = () => {
            const [data, setData] = React.useState(list1);

            return (
                <>
                    <button type="button" id="list1" onClick={() => setData(list1)}>
                        set list 1
                    </button>
                    <button type="button" id="list2" onClick={() => setData(list2)}>
                        set list 2
                    </button>
    ...
    it('filterValue', () => {
        ...
        const Component = () => {
            ...
            return (
                <div style={{ width: '300px' }}>
                    <Combobox id="combobox" onChangeValue={handleChangeValue} filterValue={filterValue} items={items} />
                </div>
            );
        };
    ...
    it('behavior: disabled unselected item', () => {
        ...
        mount(
            <div style={{ width: '300px' }}>
                <Combobox id="multiple" multiple label="Список стран" items={disabledItems} />
            </div>,
        );
    ...
    it('flow: text input + custom filter', () => {
        ...
        const Component = () => {
            ...
            const handleChangeValue = (text: string) => {
                const newItems = flatItems.filter(({ label }) => label.toLowerCase().includes(text.toLowerCase()));
                setData(newItems);
            };
