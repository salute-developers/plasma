    ...
    forwardRef<HTMLDivElement, HorizontalTabsProps>((props, outerRef) => {
        ...
        const onPrev = useCallback(() => {
            ...
            scrollRef.current.scrollTo({
                left: firstOverflowingTab.current.offsetLeft,
            });
        ...
        const handleScroll = useCallback(
            (event: React.UIEvent<HTMLElement>): void => {
                ...
                const minScrollLeft = parseInt(style.paddingLeft, 10);
                const maxScrollLeft =
        ...
        useLayoutEffect(() => {
            ...
            scrollRef.current.scrollTo({
                left: Math.round(
                    scrollRef.current.scrollLeft + leftArrowRef.current.clientWidth + parseInt(style.paddingTop, 10),
                ),
            });
