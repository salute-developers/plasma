...
describeFn('NumberInput', () => {
    ...
    it('disabled', () => {
        mount(<NumberInput size="l" value={5} disabled />);
        cy.matchImageSnapshot();
    });
    ...
    it('invalidValue, more than max', () => {
        mount(<InteractiveNumberInput size="l" value={5} max={10} min={0} isManualInput />);
    ...
    it('empty input, decrement', () => {
        mount(<InteractiveNumberInput size="l" max={10} min={0} />);
    ...
    it('precision', () => {
        mount(
            <InteractiveNumberInput size="l" value={5} max={10} min={-10} precision={2} step={0.111} isManualInput />,
        );
    ...
    it('displayWithoutValue', () => {
        mount(
            <>
                <NumberInput size="l" min={0} max={10} displayWithoutValue="input" />
                <PadMe />
                <NumberInput size="l" min={0} max={10} displayWithoutValue="increment" />
                <PadMe />
                <NumberInput size="l" min={0} max={10} displayWithoutValue="decrement" />
            </>,
        );
        cy.matchImageSnapshot();
    });
    ...
    it('displayWithoutValue=increment, click shows full component', () => {
        mount(<InteractiveNumberInput size="l" min={0} max={10} displayWithoutValue="increment" />);
    ...
    it('displayWithoutValue=decrement, click shows full component', () => {
        mount(<InteractiveNumberInput size="l" min={0} max={10} displayWithoutValue="decrement" />);
    ...
    it('limitBehavior=disabled', () => {
        mount(
            <>
                <NumberInput size="l" value={0} min={0} max={10} limitBehavior="disabled" />
                <PadMe />
                <NumberInput size="l" value={10} min={0} max={10} limitBehavior="disabled" />
            </>,
        );
        cy.matchImageSnapshot();
    });
    ...
    it('limitBehavior=hidden', () => {
        mount(
            <>
                <NumberInput size="l" value={0} min={0} max={10} limitBehavior="hidden" />
                <PadMe />
                <NumberInput size="l" value={10} min={0} max={10} limitBehavior="hidden" />
            </>,
        );
        cy.matchImageSnapshot();
    });
    ...
    it('limitBehavior=hidden, decrement appears after increment from min', () => {
        mount(<InteractiveNumberInput size="l" value={0} min={0} max={10} limitBehavior="hidden" />);
    ...
    it('limitBehavior=hidden, increment appears after decrement from max', () => {
        mount(<InteractiveNumberInput size="l" value={10} min={0} max={10} limitBehavior="hidden" />);
