...
export const StyledTextField = styled(TextField)`
    ...
    ${textFieldTokens.helpersPadding}: var(${autocompleteTokens.textFieldHelpersPadding});
    ${textFieldTokens.helpersFontFamily}: var(${autocompleteTokens.textFieldHelpersFontFamily});
    ${textFieldTokens.helpersFontStyle}: var(${autocompleteTokens.textFieldHelpersFontStyle});
    ${textFieldTokens.helpersFontSize}: var(${autocompleteTokens.textFieldHelpersFontSize});
    ${textFieldTokens.helpersFontWeight}: var(${autocompleteTokens.textFieldHelpersFontWeight});
    ${textFieldTokens.helpersLetterSpacing}: var(${autocompleteTokens.textFieldHelpersLetterSpacing});
    ${textFieldTokens.helpersLineHeight}: var(${autocompleteTokens.textFieldHelpersLineHeight});
