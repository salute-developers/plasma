...
import { getGroupedCornerRadiusTokens } from '@salutejs/plasma-sb-utils';
...
const meta: Meta = {
    title: 'b2c/Tokens/Corner Radius',
...
const themes: Record<string, GroupedNumberTokens> = {
    light: getGroupedCornerRadiusTokens(plasma_b2c__light[0]),
    dark: getGroupedCornerRadiusTokens(plasma_b2c__dark[0]),
};
