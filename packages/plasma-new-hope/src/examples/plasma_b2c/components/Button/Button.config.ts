    ...
    variations: {
        view: {
            default: css`
                ...
                --plasma-button-bg-color-hover: color-mix(in srgb, var(--inverse-text-primary), var(--surface-solid-default) 85%);
                --plasma-button-color-active: var(--inverse-text-primary);
                --plasma-button-bg-color-active: color-mix(in srgb, var(--inverse-text-primary), var(--surface-solid-default) 80%);
            `,
            primary: css`
            ...
            secondary: css`
                ...
                --plasma-button-bg-color-hover: color-mix(in srgb, var(--inverse-text-primary), var(--surface-transparent-secondary) 85%);
                --plasma-button-color-active: var(--text-primary);
                --plasma-button-bg-color-active: color-mix(in srgb, var(--inverse-text-primary), var(--surface-transparent-secondary) 80%);
            `,
            clear: css`
                --plasma-button-color: var(--text-primary);
            ...
            positive: css`
                ...
                --plasma-button-color-hover: var(--on-dark-text-primary);
                --plasma-button-bg-color-hover: color-mix(in srgb, var(--inverse-text-primary), var(--surface-positive) 85%);
                --plasma-button-color-active: var(--on-dark-text-primary);
            ...
            warning: css`
                ...
                --plasma-button-color-hover: var(--on-dark-text-primary);
                --plasma-button-bg-color-hover: color-mix(in srgb, var(--inverse-text-primary), var(--surface-warning) 85%);
                --plasma-button-color-active: var(--on-dark-text-primary);
            ...
            negative: css`
                ...
                --plasma-button-color-hover: var(--on-dark-text-primary);
                --plasma-button-bg-color-hover: color-mix(in srgb, var(--inverse-text-primary), var(--surface-negative) 85%);
                --plasma-button-color-active: var(--on-dark-text-primary);
