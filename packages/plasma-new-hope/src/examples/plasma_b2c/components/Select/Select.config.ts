    ...
    variations: {
        target: {
            'textField-like': css`
                ...
                ${selectTokens.targetBackgroundColor}: var(--surface-transparent-primary);
                ${selectTokens.targetBackgroundColorHover}: var(--surface-transparent-primary-hover);
                ${selectTokens.targetBackgroundColorActive}: var(--surface-transparent-primary-active);
