    ...
    variations: {
        size: {
            xs: css`
                ...
                ${selectTokens.notFoundContentPadding}: 0.875rem 0.5rem 0.5rem 0.5rem;
                ${selectTokens.notFoundContentGap}: 0.25rem;
            `,
            s: css`
                ${selectTokens.padding}: 0.125rem;
                ...
                ${selectTokens.notFoundContentPadding}: 1.25rem 0.625rem 0.625rem 0.625rem;
                ${selectTokens.notFoundContentGap}: 0.25rem;
            `,
            m: css`
                ${selectTokens.padding}: 0.125rem;
                ...
                ${selectTokens.notFoundContentPadding}: 1.5rem 0.875rem 0.75rem 0.875rem;
                ${selectTokens.notFoundContentGap}: 0.375rem;
            `,
            l: css`
                ${selectTokens.padding}: 0.125rem;
                ...
                ${selectTokens.notFoundContentPadding}: 1.875rem 1rem 1rem 1rem;
                ${selectTokens.notFoundContentGap}: 0.5rem;
            `,
        },
        view: {
            default: css`
