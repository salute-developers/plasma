    ...
    variations: {
        size: {
            xs: css`
                ...
                ${dropdownTokens.itemPaddingBottom}: 0.3125rem;
            ...
            s: css`
                ...
                ${dropdownItemSizeCommon};
                ${dropdownTokens.itemPaddingTop}: 0.4375rem;
            ...
            m: css`
                ...
                ${dropdownItemSizeCommon};
                ${dropdownTokens.itemPaddingTop}: 0.625rem;
                ${dropdownTokens.itemPaddingRight}: 0.875rem;
                ${dropdownTokens.itemPaddingBottom}: 0.625rem;
            ...
            l: css`
                ...
                ${dropdownItemSizeCommon};
                ${dropdownTokens.itemPaddingTop}: 0.8125rem;
                ${dropdownTokens.itemPaddingRight}: 1rem;
                ${dropdownTokens.itemPaddingBottom}: 0.8125rem;
