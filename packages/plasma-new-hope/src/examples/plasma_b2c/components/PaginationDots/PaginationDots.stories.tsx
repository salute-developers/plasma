...
const meta: Meta<typeof PaginationDots> = {
    ...
    argTypes: {
        ...
        ...disableProps(['value', 'focused', 'pin', 'activeDotCentered']),
    },
};
...
const StoryDefault = ({ dotType, ...rest }: StoryPropsDefault) => {
    ...
    return (
        <div style={{ width: '400px', height: '400px' }}>
            <PaginationDots value={value} count={9} activeElementView={dotType} onChange={setValue} {...rest} />
        </div>
    );
};
