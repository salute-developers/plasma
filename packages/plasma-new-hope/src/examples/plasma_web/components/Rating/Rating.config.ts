    ...
    variations: {
        ...
        size: {
            ...
            displayL: css`
                ...
                ${tokens.helperTextFontFamily}: var(--plasma-typo-body-h3-font-family);
                ${tokens.helperTextFontSize}: var(--plasma-typo-body-h3-font-size);
                ${tokens.helperTextFontStyle}: var(--plasma-typo-body-h3-font-style);
                ${tokens.helperTextFontWeight}: var(--plasma-typo-body-h3-font-weight);
                ${tokens.helperTextLetterSpacing}: var(--plasma-typo-body-h3-letter-spacing);
                ${tokens.helperTextLineHeight}: var(--plasma-typo-body-h3-line-height);
