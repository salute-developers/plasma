...
import { tokens as calendarBaseTokens } from '../../../components/Calendar/Calendar.tokens';
    ...
    variations: {
        view: {
            default: css`
                ...
                ${calendarBaseTokens.calendarContentPrimaryColor}: var(--text-primary);
                ${calendarBaseTokens.calendarContentPrimaryDisabledColor}: var(--text-primary);
