...
import { informationWrapperTokens as tokens } from '../../../components/InformationWrapper';
    ...
    variations: {
        ...
        size: {
            l: css`
                ...
                ${tokens.indicatorWithoutLableInner}: auto 0 -0.5rem auto;
                ${tokens.indicatorWithoutLableInnerLeft}: auto auto -0.5rem 0;
            `,
            m: css`
            ...
            xs: css`
                ...
                ${tokens.indicatorOuterLeft}: -0.75rem;
                ${tokens.indicatorWithoutLableInner}: auto 0 -0.375rem auto;
                ${tokens.indicatorWithoutLableInnerLeft}: auto auto -0.375rem 0;
            `,
        },
        hintView: {
            default: css`
