    ...
    variations: {
        ...
        size: {
            xl: css`
                ...
                ${tokens.leftContentMargin}: 0 0 0 1.25rem;
                ...
                ${tokens.textFieldLeftContentMargin}: -0.125rem 0.625rem -0.125rem 0;
                ...
                ${tokens.leftHelperOffset}: 0.25rem 0 0;
