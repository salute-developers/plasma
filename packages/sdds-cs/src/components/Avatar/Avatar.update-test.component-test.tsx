...
describe('sdds-cs: Avatar', () => {
    ...
    it('[PLASMA-1431] Avatar: status=inactive, without Avatar url', () => {
        mount(
            <CypressTestDecorator>
                <Avatar name="Иван Фадеев" status="inactive" />
            </CypressTestDecorator>,
        );
    ...
    it('[PLASMA-1893] Avatar: size=m, hasExtra, extraPlacement=top-left, type=badge, badgeView=accent, enableContentRight', () => {
        mount(
            <CypressTestDecorator>
                <Avatar
                    size="m"
    ...
    it('[PLASMA-1901] Avatar: size=xxl, hasExtra, extraPlacement=top-left, type=counter, counterView=accent, count=5, maxCount=10', () => {
        mount(
            <CypressTestDecorator>
                <Avatar
                    size="xxl"
