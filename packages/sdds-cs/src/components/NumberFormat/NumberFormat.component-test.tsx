...
describe('sdds-cs: NumberFormat', () => {
    const NumberFormat = getComponent('NumberFormat') as typeof NumberFormatCS;

    it('empty', () => {
        mount(
            <CypressTestDecorator>
                <NumberFormat label="Числовой формат" textAfter="₽" />
            </CypressTestDecorator>,
        );
    ...
    it('remove extra zero', () => {
        mount(
            <CypressTestDecorator>
                <NumberFormat label="Числовой формат" textAfter="₽" thousandSeparator=" " />
            </CypressTestDecorator>,
        );
