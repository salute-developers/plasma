    ...
    variations: {
        view: {
            default: css`
                ...
                ${tokens.dividerGradientColor}: linear-gradient(90deg, ${surfacePositive} 35%, ${onDarkSurfaceSolidPrimary} 100%);
                ${tokens.dividerVerticalGradientColor}: linear-gradient(180deg, ${surfacePositive} 35%, ${onDarkSurfaceSolidPrimary} 100%);
