...
import { CalendarDouble as CalendarDoubleCS, CalendarBase as CalendarBaseCS } from './Calendar';
...
describe('sdds-cs: Calendar', () => {
    const CalendarBase = getComponent('CalendarBase') as typeof CalendarBaseCS;
    const CalendarDouble = getComponent('CalendarDouble') as typeof CalendarDoubleCS;
    ...
    it('days: prev month', () => {
        mount(<Demo baseValue={baseDate} type="Days" />);
