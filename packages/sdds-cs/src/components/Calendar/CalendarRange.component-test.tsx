...
import { CalendarDoubleRange as CalendarDoubleRangeCS, CalendarBaseRange as CalendarBaseRangeCS } from './Calendar';
...
describe('sdds-cs: CalendarRange', () => {
    const CalendarBaseRange = getComponent('CalendarBaseRange') as typeof CalendarBaseRangeCS;
    const CalendarDoubleRange = getComponent('CalendarDoubleRange') as typeof CalendarDoubleRangeCS;
