...
import { H3 as H3CS, H4 as H4CS } from '../Typography';

import {
    Drawer as DrawerCS,
    DrawerHeader as DrawerHeaderCS,
    DrawerContent as DrawerContentCS,
    DrawerFooter as DrawerFooterCS,
} from './Drawer';
...
describe('sdds-cs: Drawer', () => {
    ...
    const Drawer = getComponent('Drawer') as typeof DrawerCS;
    const DrawerHeader = getComponent('DrawerHeader') as typeof DrawerHeaderCS;
    const DrawerContent = getComponent('DrawerContent') as typeof DrawerContentCS;
    const DrawerFooter = getComponent('DrawerFooter') as typeof DrawerFooterCS;
    const Button = getComponent('Button') as typeof ButtonCS;
    const H3 = getComponent('H3') as typeof H3CS;
    const H4 = getComponent('H4') as typeof H4CS;
    ...
    it('[PLASMA-T1618] Drawer: placement=top, withBlur, asModal, closeOnEsc, showHeader, showFooter, showActions, hasClose, closePlacement=right, width=50vw, height: 100dvh, borderRadius=none', () => {
        mount(
            <CypressTestDecorator>
                <PopupProvider>
                    <Demo placement="top" withBlur closeOnEsc />
                </PopupProvider>
            </CypressTestDecorator>,
        );
