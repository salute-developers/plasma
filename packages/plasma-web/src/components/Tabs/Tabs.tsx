...
import { Tabs as BaseTabs, TabItem as BaseTabItem, accent, secondary, footnote2 } from '@salutejs/plasma-core';
import type { TabsProps as BaseTabsProps, TabItemProps as BaseTabItemProps } from '@salutejs/plasma-core';
