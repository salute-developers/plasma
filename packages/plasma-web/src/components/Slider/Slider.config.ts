    ...
    variations: {
        view: {
            default: css`
                ...
                ${sliderTokens.textFieldBorderColor}: ${outlineTransparentPrimary};
                ${sliderTokens.textFieldBorderColorHover}: ${outlineTransparentPrimaryHover};
                ${sliderTokens.textFieldBorderColorFocus}: ${surfaceAccent};
            `,
            accent: css`
                ${sliderTokens.labelColor}: ${textPrimary};
