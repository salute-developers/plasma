    ...
    variations: {
        ...
        view: {
            default: css`
                ...
                ${comboboxTokens.targetBorderColor}: ${textTertiary};
                ${comboboxTokens.targetBorderColorHover}: ${textTertiaryHover};
                ${comboboxTokens.targetBorderColorActive}: ${textTertiaryActive};
                ${comboboxTokens.targetBorderColorOpen}: ${textAccent};
