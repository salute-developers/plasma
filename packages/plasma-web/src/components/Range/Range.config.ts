    ...
    variations: {
        view: {
            default: css`
                ...
                ${tokens.borderColor}: ${surfaceTransparentTertiary};
                ${tokens.borderColorError}: ${surfaceNegative};
                ${tokens.borderColorSuccess}: ${surfacePositive};
                ...
                ${tokens.textFieldBorderColorErrorHover}: ${surfaceNegativeHover};
                ${tokens.textFieldBorderColorErrorFocus}: ${surfaceAccent};
                ${tokens.textFieldBorderColorSuccess}: ${surfacePositive};
                ${tokens.textFieldBorderColorSuccessHover}: ${surfacePositiveHover};
        ...
        readOnly: {
            true: css`
                ...
                ${tokens.borderColorReadOnly}: ${surfaceTransparentPrimary};
