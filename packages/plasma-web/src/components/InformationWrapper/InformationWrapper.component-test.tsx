...
import { InformationWrapper as InformationWrapperWEB } from '.';
...
describe('plasma-web: InformationWrapper', () => {
    const InformationWrapper = getComponent('InformationWrapper') as FC<ComponentProps<typeof InformationWrapperWEB>>;
