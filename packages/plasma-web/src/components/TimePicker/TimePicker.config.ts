    ...
    variations: {
        view: {
            default: css`
                ...
                ${tokens.borderColorFocus}: ${surfaceAccent};

                ${tokens.textFieldBorderColorSuccess}: ${surfacePositive};
                ${tokens.textFieldBorderColorSuccessHover}: ${surfacePositive};
                ${tokens.textFieldBorderColorSuccessFocus}: ${surfaceAccent};

                ${tokens.textFieldBorderColorError}: ${surfaceNegative};
                ${tokens.textFieldBorderColorErrorHover}: ${surfaceNegative};
                ${tokens.textFieldBorderColorErrorFocus}: ${surfaceAccent};

                ${tokens.background}: ${surfaceClear};
                ${tokens.backgroundError}: ${surfaceClear};
                ${tokens.backgroundSuccess}: ${surfaceClear};
                ...
                ${tokens.textFieldBackgroundErrorColor}: ${surfaceClear};
                ${tokens.textFieldBackgroundErrorColorFocus}: ${surfaceClear};
                ${tokens.textFieldBackgroundSuccessColor}: ${surfaceClear};
