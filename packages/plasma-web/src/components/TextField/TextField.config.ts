...
export const config = {
    ...
    variations: {
        ...
        hintView: {
            default: css`
                ${tokens.tooltipBackgroundColor}: var(--surface-solid-card);
                ${tokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${tokens.tooltipColor}: var(--text-primary);
            `,
            onDark: css`
                ${tokens.tooltipBackgroundColor}: var(--on-dark-surface-solid-card);
                ${tokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${tokens.tooltipColor}: var(--on-dark-text-primary);
            `,
            onLight: css`
                ${tokens.tooltipBackgroundColor}: var(--on-light-surface-solid-card);
                ${tokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${tokens.tooltipColor}: var(--on-light-text-primary);
            `,
            inverse: css`
                ${tokens.tooltipBackgroundColor}: var(--inverse-surface-solid-card);
                ${tokens.tooltipBoxShadow}: var(--shadow-down-hard-m);
                ${tokens.tooltipColor}: var(--inverse-text-primary);
            `,
        },
        hintSize: {
            m: css`
