    ...
    variations: {
        size: {
            xs: css`
                ...
                ${textAreaTokens.labelInnerFontFamily}: var(--plasma-typo-body-xxs-font-family, 'SB Sans Text','SBSansText',sans-serif);
                ${textAreaTokens.labelInnerFontSize}: var(--plasma-typo-body-xxs-font-size, 0.625rem);
                ${textAreaTokens.labelInnerFontStyle}: var(--plasma-typo-body-xxs-font-style, normal);
                ${textAreaTokens.labelInnerFontWeight}: var(--plasma-typo-body-xxs-font-weight, 400);
                ${textAreaTokens.labelInnerLetterSpacing}: var(--plasma-typo-body-xxs-letter-spacing, -0.02em);
                ${textAreaTokens.labelInnerLineHeight}: var(--plasma-typo-body-xxs-line-height, 0.75rem);
                ${textAreaTokens.labelInnerTop}: 0rem;
                ${textAreaTokens.labelInnerMarginBottom}: 0rem;
                ${textAreaTokens.inputFontFamily}: var(--plasma-typo-caption-font-family, var(--plasma-typo-body-xs-font-family));
                ${textAreaTokens.inputFontSize}: var(--plasma-typo-caption-font-size, var(--plasma-typo-body-xs-font-size));
                ${textAreaTokens.inputFontStyle}: var(--plasma-typo-caption-font-style, var(--plasma-typo-body-xs-font-style));
                ${textAreaTokens.inputFontWeight}: var(--plasma-typo-caption-font-weight, var(--plasma-typo-body-xs-font-weight));
                ${textAreaTokens.inputLetterSpacing}: var(--plasma-typo-caption-letter-spacing, var(--plasma-typo-body-xs-letter-spacing));
                ${textAreaTokens.inputLineHeight}: var(--plasma-typo-caption-line-height, var(--plasma-typo-body-xs-line-height));
                ${textAreaTokens.helpersFontFamily}: var(--plasma-typo-caption-font-family, var(--plasma-typo-body-xs-font-family));
                ${textAreaTokens.helpersFontSize}: var(--plasma-typo-caption-font-size, var(--plasma-typo-body-xs-font-size));
                ${textAreaTokens.helpersFontStyle}: var(--plasma-typo-caption-font-style, var(--plasma-typo-body-xs-font-style));
                ${textAreaTokens.helpersFontWeight}: var(--plasma-typo-caption-font-weight, var(--plasma-typo-body-xs-font-weight));
                ${textAreaTokens.helpersLetterSpacing}: var(--plasma-typo-caption-letter-spacing, var(--plasma-typo-body-xs-letter-spacing));
                ${textAreaTokens.helpersLineHeight}: var(--plasma-typo-caption-line-height, var(--plasma-typo-body-xs-line-height));
            ...
            s: css`
                ...
                ${textAreaTokens.clearLabelMarginBottom}: 0.25rem;
                ${textAreaTokens.labelInnerFontFamily}: var(--plasma-typo-caption-font-family, var(--plasma-typo-body-xs-font-family));
                ${textAreaTokens.labelInnerFontSize}: var(--plasma-typo-caption-font-size, var(--plasma-typo-body-xs-font-size));
                ${textAreaTokens.labelInnerFontStyle}: var(--plasma-typo-caption-font-style, var(--plasma-typo-body-xs-font-style));
                ${textAreaTokens.labelInnerFontWeight}: var(--plasma-typo-caption-font-weight, var(--plasma-typo-body-xs-font-weight));
                ${textAreaTokens.labelInnerLetterSpacing}: var(--plasma-typo-caption-letter-spacing, var(--plasma-typo-body-xs-letter-spacing));
                ${textAreaTokens.labelInnerLineHeight}: var(--plasma-typo-caption-line-height, var(--plasma-typo-body-xs-line-height));
                ${textAreaTokens.labelInnerTop}: 0.375rem;
                ${textAreaTokens.labelInnerMarginBottom}: 0.125rem;
                ${textAreaTokens.inputFontFamily}: var(--plasma-typo-footnote1-font-family, var(--plasma-typo-body-s-font-family));
                ${textAreaTokens.inputFontSize}: var(--plasma-typo-footnote1-font-size, var(--plasma-typo-body-s-font-size));
                ${textAreaTokens.inputFontStyle}: var(--plasma-typo-footnote1-font-style, var(--plasma-typo-body-s-font-style));
                ${textAreaTokens.inputFontWeight}: var(--plasma-typo-footnote1-font-weight, var(--plasma-typo-body-s-font-weight));
                ${textAreaTokens.inputLetterSpacing}: var(--plasma-typo-footnote1-letter-spacing, var(--plasma-typo-body-s-letter-spacing));
                ${textAreaTokens.inputLineHeight}: var(--plasma-typo-footnote1-line-height, var(--plasma-typo-body-s-line-height));
                ${textAreaTokens.helpersFontFamily}: var(--plasma-typo-caption-font-family, var(--plasma-typo-body-xs-font-family));
                ${textAreaTokens.helpersFontSize}: var(--plasma-typo-caption-font-size, var(--plasma-typo-body-xs-font-size));
                ${textAreaTokens.helpersFontStyle}: var(--plasma-typo-caption-font-style, var(--plasma-typo-body-xs-font-style));
                ${textAreaTokens.helpersFontWeight}: var(--plasma-typo-caption-font-weight, var(--plasma-typo-body-xs-font-weight));
            ...
            m: css`
                ...
                ${textAreaTokens.labelInnerTop}: 0.375rem;
                ${textAreaTokens.labelInnerMarginBottom}: 0.125rem;
                ${textAreaTokens.inputFontFamily}: var(--plasma-typo-body1-font-family, var(--plasma-typo-body-m-font-family));
                ${textAreaTokens.inputFontSize}: var(--plasma-typo-body1-font-size, var(--plasma-typo-body-m-font-size));
                ${textAreaTokens.inputFontStyle}: var(--plasma-typo-body1-font-style, var(--plasma-typo-body-m-font-style));
                ${textAreaTokens.inputFontWeight}: var(--plasma-typo-body1-font-weight, var(--plasma-typo-body-m-font-weight));
                ${textAreaTokens.inputLetterSpacing}: var(--plasma-typo-body1-letter-spacing, var(--plasma-typo-body-m-letter-spacing));
                ${textAreaTokens.inputLineHeight}: var(--plasma-typo-body1-line-height, var(--plasma-typo-body-m-line-height));
                ${textAreaTokens.helpersFontFamily}: var(--plasma-typo-caption-font-family, var(--plasma-typo-body-xs-font-family));
                ${textAreaTokens.helpersFontSize}: var(--plasma-typo-caption-font-size, var(--plasma-typo-body-xs-font-size));
                ${textAreaTokens.helpersFontStyle}: var(--plasma-typo-caption-font-style, var(--plasma-typo-body-xs-font-style));
                ${textAreaTokens.helpersFontWeight}: var(--plasma-typo-caption-font-weight, var(--plasma-typo-body-xs-font-weight));
            ...
            l: css`
                ...
                ${textAreaTokens.labelInnerMarginBottom}: 0.125rem;
                ${textAreaTokens.inputFontFamily}: var(--plasma-typo-body-l-font-family, 'SB Sans Text','SBSansText',sans-serif);
                ${textAreaTokens.inputFontSize}: var(--plasma-typo-body-l-font-size, 1.125rem);
                ${textAreaTokens.inputFontStyle}: var(--plasma-typo-body-l-font-style, normal);
                ${textAreaTokens.inputFontWeight}: var(--plasma-typo-body-l-font-weight, 400);
                ${textAreaTokens.inputLetterSpacing}: var(--plasma-typo-body-l-letter-spacing, -0.02em);
                ${textAreaTokens.inputLineHeight}: var(--plasma-typo-body-l-line-height, 1.375rem);
                ${textAreaTokens.helpersFontFamily}: var(--plasma-typo-caption-font-family, var(--plasma-typo-body-xs-font-family));
                ${textAreaTokens.helpersFontSize}: var(--plasma-typo-caption-font-size, var(--plasma-typo-body-xs-font-size));
                ${textAreaTokens.helpersFontStyle}: var(--plasma-typo-caption-font-style, var(--plasma-typo-body-xs-font-style));
                ${textAreaTokens.helpersFontWeight}: var(--plasma-typo-caption-font-weight, var(--plasma-typo-body-xs-font-weight));
