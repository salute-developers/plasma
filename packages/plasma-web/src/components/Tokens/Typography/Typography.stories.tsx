...
import { plasma_web__dark, plasma_web__light } from '@salutejs/plasma-themes';
import {
    InSpacingDecorator,
...
import type { Breakpoint, TypographyProperties, TypographyWeight } from '@salutejs/plasma-sb-utils';
