import { css, inputGroupTokens as tokens } from '@salutejs/plasma-new-hope/styled-components';
...
export const config = {
    ...
    variations: {
        size: {
            l: css`
                ${tokens.inputDefaultRadius}: 0.875rem;
                ${tokens.inputSegmentedRadius}: 0.375rem;
                ${tokens.inputSideRadius}: 0.875rem;
            ...
            `,
            m: css`
                ${tokens.inputDefaultRadius}: 0.75rem;
                ${tokens.inputSegmentedRadius}: 0.25rem;
                ${tokens.inputSideRadius}: 0.75rem;
            ...
            s: css`
                ${tokens.inputSegmentedRadius}: 0.25rem;
                ${tokens.inputSideRadius}: 0.625rem;
                ${tokens.inputDefaultRadius}: 0.625rem;
            ...
            `,
            xs: css`
                ${tokens.inputSegmentedRadius}: 0.125rem;
                ${tokens.inputDefaultRadius}: 0.5rem;
                ${tokens.inputSideRadius}: 0.5rem;
        ...
        orientation: {
            horizontal: css`
                ${tokens.inputGroupOrientation}: row;
            `,
            vertical: css`
                ${tokens.inputGroupOrientation}: column;
            `,
        },
        gap: {
            none: css`
                ${tokens.inputGroupItemsGap}: 0;
                ${tokens.inputGroupWebMarginLeft}: -0.063rem;
                ${tokens.inputGroupWebClipPath}: inset(0 0.063rem 0 0);
                ${tokens.inputGroupWebMarginTop}: -0.063rem;
                ${tokens.inputGroupWebVerticalClipPath}: inset(0.063rem 0 0 0);
            `,
            dense: css`
                ${tokens.inputGroupItemsGap}: 0.125rem;
            `,
            wide: css`
                ${tokens.inputGroupItemsGap}: 0.5rem;
            `,
        },
        shape: {
            segmented: css``,
