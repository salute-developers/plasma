...
import { plasma_homeds__light, plasma_homeds__dark } from '@salutejs/plasma-themes/es/themes';
...
const themes: Record<string, GroupedNumberTokens> = {
    'plasma-homeds:light': getGroupedCornerRadiusTokens(plasma_homeds__light[0]),
    'plasma-homeds:dark': getGroupedCornerRadiusTokens(plasma_homeds__dark[0]),
};
