...
/* stylelint-enable */
export const PLASMA_HOMEDS_LIGHT_THEME = 'plasma-homeds:light';
export const PLASMA_HOMEDS_DARK_THEME = 'plasma-homeds:dark';
export const DEFAULT_MODE = 'default';
export const ON_DARK_MODE = 'onDark';
export const ON_LIGHT_MODE = 'onLight';

const themes = {
    [PLASMA_HOMEDS_LIGHT_THEME]: createGlobalStyle(plasma_homeds__light),
    [PLASMA_HOMEDS_DARK_THEME]: createGlobalStyle(plasma_homeds__dark),
};
