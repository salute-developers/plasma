...
export const configH6 = {
    ...
    variations: {
        size: {
            h6: css`
                ${typographyTokens.typoFontFamily}: ${h6.fontFamily};
                ${typographyTokens.typoFontSize}: ${h6.fontSize};
                ${typographyTokens.typoFontStyle}: ${h6.fontStyle};
                ${typographyTokens.typoFontWeight}: ${h6.fontWeight};
                ${typographyTokens.typoFontWeightBold}: ${h6Bold.fontWeight};
                ${typographyTokens.typoFontWeightMedium}: ${h6Medium.fontWeight};
                ${typographyTokens.typoFontLetterSpacing}: ${h6.letterSpacing};
                ${typographyTokens.typoFontLineHeight}: ${h6.lineHeight};
            `,
        },
    },
};
