# Библиотека компонентов SDDS INSURANCE
...
$ npm install --save @salutejs/sdds-insurance @salutejs/plasma-typo @salutejs/sdds-themes
```
...
import { sdds_insurance__light } from '@salutejs/sdds-themes';

const ThemeStyle = createGlobalStyle(sdds_insurance__light);
...
const themeStyle = css(sdds_insurance__light);
...
Для корректной работы server side rendering приложение нужно обернуть `SSRProvider` (доступен в sdds-insurance);
...
```jsx
// App.tsx
import { Button } from '@salutejs/sdds-insurance';
import { textAccent } from '@salutejs/plasma-tokens/brands/sdds-insurance';
...
```jsx
// App.tsx
import { Button } from '@salutejs/sdds-insurance/emotion';
import { textAccent } from '@salutejs/plasma-tokens/brands/sdds-insurance';
