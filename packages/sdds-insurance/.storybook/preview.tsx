...
import { withTheme, SDDS_INSURANCE_LIGHT_THEME, SDDS_INSURANCE_DARK_THEME } from './decoratorThemes';
...
const preview: Preview = {
    ...
    globalTypes: {
        theme: {
            ...
            defaultValue: SDDS_INSURANCE_LIGHT_THEME,
            toolbar: {
                title: 'Theme',
                items: [SDDS_INSURANCE_LIGHT_THEME, SDDS_INSURANCE_DARK_THEME],
            },
        },
        typoVersion: {
