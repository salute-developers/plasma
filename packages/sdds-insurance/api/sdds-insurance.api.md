## API Report File for "@salutejs/sdds-insurance"
...
export const Autocomplete: FunctionComponent<
    PropsType<{
        ...
        Omit<
            TextFieldPropsBase,
            'required' | 'requiredPlacement' | 'optional' | 'chips' | 'onChangeChips' | 'enumerationType'
        > &
...
// @public (undocumented)
export const Combobox: <T extends ItemOption>(
    props: Omit<ComboboxProps<T>, 'view' | 'size' | 'disabled' | 'readOnly' | 'labelPlacement'> &
        Pick<
            PropsType<{
                view: {
                    default: PolymorphicClassName;
                ...
                (
                    | ({
                      ...
                      } & Omit<ButtonHTMLAttributes<HTMLInputElement>, 'onChange' | 'value'> &
                          RefAttributes<HTMLInputElement>)
                    | ({
                          items: ItemOption[];
                          placement?:
            ...
            'view' | 'size' | 'disabled' | 'readOnly' | 'labelPlacement'
        > & {
...
export const Select: React_2.ForwardRefExoticComponent<
    Omit<SelectProps, 'view' | 'size' | 'chipView'> &
        Pick<
            PropsType<{
                size: {
                    xs: PolymorphicClassName;
                ...
                (
                    | ({
                          ...
                          onItemSelect?:
                              | ((e: MergedDropdownNode, event: React_2.SyntheticEvent<Element, Event>) => void)
                              | undefined;
                          ...
                          isTargetAmount?: boolean | undefined;
                          renderTarget?:
                              | ((item: MergedDropdownNode | MergedDropdownNode[]) => React_2.ReactNode)
                              | undefined;
                          placement?:
                          ...
                          chipView?: string | undefined;
                              ...
                              React_2.ButtonHTMLAttributes<HTMLButtonElement>,
                              'onChange' | 'nonce' | 'onResize' | 'onResizeCapture' | 'value'
                          > &
...
export * from '@salutejs/sdds-themes/tokens/sdds_insurance';
