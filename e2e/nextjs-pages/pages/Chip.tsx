...
import { Chip } from '@salutejs/sdds-serv/styled-components';
...
const ChipPage: NextPage = () => (
    <main style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <h1>Chip — SSR check</h1>
        <Chip text="Чип" onClear={() => {}} />
        <Chip text="С иконкой" contentLeft={<ChipIcon width="1.5rem" height="1.5rem" />} onClear={() => {}} />
    </main>
);
